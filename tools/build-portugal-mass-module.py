...
(function registerPortugalMass(global) {
  ...
  global.countryMassData.PT = Object.freeze({
    ...
    ordinaryLanguage: 'PT', ordinary, officialOrderCorpus,
...
""" % (json.dumps(ordinary, ensure_ascii=False, separators=(",", ":")), json.dumps(source, ensure_ascii=False, separators=(",", ":")), json.dumps(full_corpus, ensure_ascii=False))
