...
V27.7에는 기존 기도문 끝맺음 플레이스홀더, 복음/독서 종료문 중복 제거, 중국어 매일미사 추출, 중국어 미사통상문 분절 수정도 포함합니다. 입당송·본기도·복음 환호송·예물기도·영성체송·영성체 후 기도는 독서 계열과 같은 선택 정렬 엔진을 사용합니다. 주요 고정 기도문은 한국어 구절 행에 맞췄고, 감사기도 4는 한국어 88개 절을 공통 슬롯으로 사용해 모든 지원 언어의 해당 의미 구간을 같은 행에 배치합니다.
