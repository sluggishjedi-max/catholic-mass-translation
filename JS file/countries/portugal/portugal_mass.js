...
(function registerPortugalMass(global) {
  ...
  const ordinary = Object.freeze([{
    ...
    "variants": {
      ...
      "C": {
        ...
        "lines": [{
          ...
          "text_pt": (
            "6.1. "
            + "Ao domingo, especialmente no Tempo Pascal, pode celebrar-se a bênção e"
          )
        }, {
          "sp_pt": "",
          ...
          "text_pt": (
            "6.2. "
            + "Depois da saudação inicial, o sacerdote, de pé, junto à sua sede, voltado para"
          )
        }, {
          "sp_pt": "",
          ...
          "text_pt": (
            "6.3. "
            + "Quando as circunstâncias locais ou os costumes populares aconselham que se"
          )
        }, {
          "sp_pt": "",
          ...
          "text_pt": (
            "6.4. "
            + "O sacerdote toma o hissope, asperge-se a si mesmo e, depois, os ministros,"
          )
        }, {
          "sp_pt": "",
          "text_pt": (
            "o clero e os fiéis. "
            + "Se parecer conveniente, pode passar através da igreja para a"
          )
        }, {
          "sp_pt": "",
          ...
          "sp_pt": "",
          "text_pt": (
            "Vi a água sair do lado direito do templo. "
            + "Aleluia."
          )
        }, {
          "sp_pt": "",
          ...
          "sp_pt": "",
          "text_pt": (
            "reunirei os povos e os reinos e derramarei sobre vós água pura. "
            + "Aleluia."
          )
        }, {
          "sp_pt": "",
          ...
          "sp_pt": "",
          "text_pt": (
            "onde o mundo se lava dos seus pecados e a vida se renova. "
            + "Aleluia."
          )
        }, {
          "sp_pt": "",
          "text_pt": (
            "6.5. "
            + "Então, o sacerdote volta para a sua sede. "
            + "Terminado o cântico, volta-se para"
          )
        }, {
          ...
          "text_pt": (
            "R. "
            + "Purificai e abençoai a vossa Igreja."
          )
        }, {
          "rubric_pt": "Ou:"
        }, {
          ...
          "text_pt": (
            "e os fiéis. "
            + "Se parecer conveniente, pode passar através da igreja para a aspersão"
          )
        }, {
          "sp_pt": "",
          "text_pt": "dos fiéis."
          ...
          "rubric_pt": (
            "Então, o sacerdote volta para a sua sede. "
            + "Terminado o cântico, volta-se para o"
          )
        }, {
          ...
          "text_pt": (
            "7. "
            + "Seguem-se as invocações Senhor, tende piedade de nós (Kýrie, eléison), a"
          )
        }, {
          "sp_pt": "",
    ...
    "variants": {
      ...
      "B": {
        ...
        "lines": [{
          ...
          "text_pt": (
            "19. "
            + "Em vez do símbolo niceno-constantinopolitano, sobretudo no Tempo da"
          )
        }, {
          "sp_pt": "",
    ...
    "lines": [{
      ...
      "text_pt": (
        "23. "
        + "O sacerdote, junto do altar, toma a patena com o pão e, elevando-a com ambas"
      )
    }, {
      "sp_pt": "",
      ...
      "text_pt": (
        "24. "
        + "O diácono ou o sacerdote deita vinho e um pouco de água no cálice, dizendo"
      )
    }, {
      "sp_pt": "",
      "text_pt": "em silêncio:"
      ...
      "text_pt": (
        "25. "
        + "Em seguida, o sacerdote toma o cálice e, elevando-o com ambas as mãos um"
      )
    }, {
      "sp_pt": "",
      ...
      "text_pt": (
        "27. "
        + "Depois, usando-se o incenso, incensa as oblatas, a cruz e o altar. "
        + "A seguir, o"
      )
    }, {
      "sp_pt": "",
      ...
      "text_pt": (
        "29. "
        + "Depois, estando ao meio do altar e, voltado para o povo, abrindo e juntando"
      )
    }, {
      "sp_pt": "",
      "text_pt": "as mãos, diz:"
    ...
    "songs": {
      "cep_complete_prefaces": {
        ...
        "content": [{
          ...
          "text_pt": (
            "33 a. "
            + "Este prefácio diz-se desde o Domingo I do Advento até ao dia 16 de dezembro, nas Missas do Tempo e também nas outras Missas que não têm prefácio"
          )
        }, {
          "sp_pt": "",
          "text_pt": "próprio."
          ...
          "text_pt": (
            "34. "
            + "Este prefácio diz-se desde 17 a 24 de dezembro nas Missas do Tempo e"
          )
        }, {
          "sp_pt": "",
          ...
          "sp_pt": "",
          "text_pt": (
            "No Cânone romano diz-se o Em comunhão com toda a Igreja próprio, p. "
            + "643."
          )
        }, {
          "sp_pt": "",
          ...
          "sp_pt": "",
          "text_pt": (
            "No Cânone romano diz-se o Em comunhão com toda a Igreja próprio. "
            + "Nas Orações"
          )
        }, {
          "sp_pt": "",
          ...
          "text_pt": (
            "38. "
            + "Este prefácio diz-se nas Missas da solenidade da Epifania. "
            + "Nos dias que decorrem desde a Epifania até ao sábado que precede a festa do Batismo do Senhor"
          )
        }, {
          "sp_pt": "",
          ...
          "text_pt": (
            "39. "
            + "Este prefácio diz-se no Tempo da Quaresma, especialmente nos domingos"
          )
        }, {
          "sp_pt": "",
          ...
          "text_pt": (
            "41. "
            + "Este prefácio diz-se nas Missas dos dias feriais da Quaresma e nos dias de"
          )
        }, {
          "sp_pt": "",
          "text_pt": "jejum."
          ...
          "text_pt": (
            "42 b. "
            + "Este prefácio pode dizer-se na Missa da reconciliação e na Missa de caráter"
          )
        }, {
          "sp_pt": "",
          "text_pt": (
            "penitencial. "
            + "Diz-se também no Tempo da Quaresma."
          )
        }, {
          "sp_pt": "",
          "text_pt": (
          ...
          "text_pt": (
            "43. "
            + "Este prefácio diz-se durante a Semana V da Quaresma e nas Missas da Santa"
          )
        }, {
          "sp_pt": "",
          ...
          "sp_pt": "",
          "text_pt": (
            "No Cânone romano diz-se o Em comunhão com toda a Igreja e Aceitai benignamente próprios. "
            + "Nas Orações eucarísticas II e III faz-se também a comemoração"
          )
        }, {
          "sp_pt": "",
          "text_pt": (
            "própria. "
            + "Na Vigília Pascal diz-se: ao celebrarmos a noite santíssima."
          )
        }, {
          ...
          "text_pt": (
            "50. "
            + "Este prefácio diz-se no dia de Ascensão do Senhor. "
          ...
          "text_pt": (
            "51. "
            + "Este prefácio diz-se no dia de Ascensão. "
            + "Pode dizer-se também nos dias a"
          )
        }, {
          "sp_pt": "",
          ...
          "text_pt": (
            "próprio. "
            + "Nas Orações eucarísticas II e III faz-se também a comemoração própria."
          )
        }, {
          ...
          "text_pt": (
            "60. "
            + "Este prefácio diz-se na Missa da Ceia do Senhor; pode dizer-se também"
          )
        }, {
          "sp_pt": "",
          ...
          "text_pt": (
            "61. "
            + "Este prefácio diz-se na solenidade do Santíssimo Corpo e Sangue de Cristo"
          )
        }, {
          "sp_pt": "",
          ...
          "text_pt": (
            "61 a. "
            + "Este prefácio diz-se nas Missas rituais para o viático e pode dizer-se nas"
          )
        }, {
          "sp_pt": "",
          ...
          "text_pt": (
            "62. "
            + "Este prefácio diz-se nas Missas da Virgem santa Maria, especificando no"
          )
        }, {
          "sp_pt": "",
          ...
          "text_pt": (
            "63 a. "
            + "Este prefácio diz-se nas Missas da Virgem santa Maria."
          )
        }, {
          "sp_pt": "",
          "text_pt": (
          ...
          "text_pt": (
            "V. "
            + "Maria, imagem e mãe da Igreja: Santa Maria. "
            + "Mãe da Igreja,"
          )
        }, {
          "sp_pt": "",
          ...
          "text_pt": (
            "VI. "
            + "A glória da Assunção de Maria: 15 de agosto, p. "
            + "746."
          )
        }, {
          "sp_pt": "",
          "text_pt": (
            "VII. "
            + "O mistério de Maria e da Igreja: 8 de dezembro, p. "
            + "836."
          )
        }, {
          ...
          "text_pt": (
            "63 c. "
            + "Este prefácio diz-se nas Missas dos Anjos."
          )
        }, {
          "sp_pt": "",
          "text_pt": (
          ...
          "text_pt": (
            "63 c. "
            + "Este prefácio diz-se nas Missas de são José."
          )
        }, {
          "sp_pt": "",
          "text_pt": (
          ...
          "text_pt": (
            "64. "
            + "Este prefácio diz-se nas Missas dos Apóstolos, especialmente de são Pedro"
          )
        }, {
          "sp_pt": "",
          "text_pt": "e são Paulo."
          ...
          "text_pt": (
            "66. "
            + "Este prefácio diz-se nas Missas de Todos os Santos, dos santos padroeiros"
          )
        }, {
          "sp_pt": "",
          ...
          "text_pt": (
            "próprio. "
            + "Pode dizer-se também nas memórias dos santos."
          )
        }, {
          "sp_pt": "",
          "text_pt": (
          ...
          "text_pt": (
            "68. "
            + "Este prefácio diz-se nas solenidades e festas dos santos mártires. "
            + "Pode dizer-se"
          )
        }, {
          "sp_pt": "",
          ...
          "text_pt": (
            "70. "
            + "Este prefácio diz-se nas solenidades e festas dos santos pastores da Igreja."
          )
        }, {
          "sp_pt": "",
          ...
          "text_pt": (
            "religiosos. "
            + "Pode dizer-se também nas suas memórias."
          )
        }, {
          "sp_pt": "",
          "text_pt": (
          ...
          "text_pt": (
            "72. "
            + "Este prefácio diz-se nas Missas que não têm prefácio próprio, nem exigem"
          )
        }, {
          "sp_pt": "",
    ...
    "forms": {
      "1": [{
        ...
        "sp_pt": "",
        "text_pt": (
          "com toda a vossa família, V os apresentamos. "
          + "Nós V o-la oferecemos"
        )
      }, {
        "sp_pt": "",
        ...
        "sp_pt": "",
        "text_pt": (
          "Santo, concedendo-lhes o perdão de todos os pecados. "
          + "Dai a paz"
        )
      }, {
        "sp_pt": "",
        ...
        "text_pt": (
          "89. "
          + "Nas fórmulas que se seguem, as palavras do Senhor devem pronunciar-se"
        )
      }, {
        "sp_pt": "",
        ...
        "rubric_pt": (
          "Seguem-se os ritos da comunhão, p. "
          + "526."
        )
      }],
      "2": [{
        ...
        "text_pt": (
          "99. "
          + "Esta Oração eucarística tem um prefácio próprio, que faz parte da sua estrutura."
        )
      }, {
        "sp_pt": "",
        ...
        "text_pt": (
          ...
          + "Hoje, na hora em que Ele Se entregava ..."
        )
      }, {
        "sp_pt": "",
        "text_pt": "Vigília Pascal até ao Domingo II da Páscoa:"
      ...
      "3": [{
        ...
        "text_pt": (
          "mistérios. "
          + "Hoje, na noite em que Ele ia ser entregue, tomou o pão ..."
        )
      }, {
        "sp_pt": "",
        "text_pt": "Vigília Pascal até ao Domingo II da Páscoa:"
      ...
      "4": [{
        ...
        "text_pt": (
          "116. "
          + "O prefácio desta Oração eucarística não pode ser substituído por outro, em"
        )
      }, {
        "sp_pt": "",
    ...
    "lines": [{
      ...
      "text_pt": (
        "129. "
        + "Em seguida, toma a hóstia, parte-a sobre a patena e deita um fragmento"
      )
    }, {
      "sp_pt": "",
    ...
    "lines": [{
      ...
      "text_pt": (
        "132. "
        + "O sacerdote genuflete, toma a hóstia, levanta-a um pouco sobre a patena"
      )
    }, {
      "sp_pt": "",
    ...
    "lines": [{
      ...
      "text_pt": (
        "133. "
        + "V oltado para o altar, o sacerdote diz em silêncio:"
      )
    }, {
      "sp_pt": "",
      ...
      "text_pt": (
        "135. "
        + "Para a comunhão sob as duas espécies, segue-se o rito descrito em seu"
      )
    }, {
      "sp_pt": "",
      ...
      "text_pt": (
        "136. "
        + "Enquanto o sacerdote comunga o Corpo de Cristo, começa-se o cântico"
      )
    }, {
      "sp_pt": "",
      "text_pt": "da comunhão."
      ...
      "text_pt": (
        "137. "
        + "Terminada a distribuição da Comunhão, o sacerdote ou o diácono, ou o"
      )
    }, {
      "sp_pt": "",
      ...
      "text_pt": (
        ...
        + "Se convier, podem guardar-se uns momentos de silêncio sagrado, ou recitar um salmo ou um cântico de"
      )
    }, {
      "sp_pt": "",
      "text_pt": "louvor."
      ...
      "text_pt": (
        "139. "
        + "Em seguida, de pé, junto da sua cadeira ou do altar, o sacerdote, voltado"
      )
    }, {
      "sp_pt": "",
    ...
    "variants": {
      "A": {
        ...
        "lines": [{
          ...
          "text_pt": (
            "142. "
            + "Em certos dias e em ocasiões especiais, a fórmula de bênção tem textos"
          )
        }, {
          "sp_pt": "",
          "text_pt": (
            "próprios: bênção solene ou oração sobre o povo (cf. pp. "
            + "703-720)."
          )
        }]
      },
      "B": {
        ...
        "lines": [{
          ...
          "text_pt": (
            "143. "
            + "Na Missa pontifical, o celebrante toma a mitra e, abrindo os braços, diz:"
          )
        }, {
          "sp_pt": "",
          "text_pt": "O Senhor esteja convosco."
          ...
          "text_pt": (
            "145. "
            + "Em seguida, o sacerdote beija o altar em sinal de veneração, como no"
          )
        }, {
          "sp_pt": "",
          "text_pt": (
            "início. "
            + "Feita a inclinação profunda com os ministros, retira-se."
          )
        }, {
          "sp_pt": "",
          "text_pt": (
  ...
  const ordinarySource = Object.freeze({
    ...
    "url": "https://liturgia.pt/ordinario/ordinario.pdf",
    "pages": "PDF 2–127"
  });
  const officialOrderCorpus = Object.freeze({
    ...
    text_pt: (((((((((
      "Ritos iniciais<br>"
      + "1. "
      + "Reunido o povo, o sacerdote e os ministros encaminham-se para o altar enquanto se executa o cântico de entrada.<br>"
      + " Ao chegar ao altar, o sacerdote, feita uma inclinação profunda juntamente <br>"
      + "com os ministros, beija o altar e, conforme as circunstâncias, incensa a cruz e o <br>"
      + "altar. "
      + "Depois, dirige-se para a sua cadeira, juntamente com os ministros.<br>"
      + " Terminado o cântico de entrada, sacerdote e fiéis, todos de pé, fazem o sinal <br>"
      + "da cruz, enquanto o sacerdote, voltado para o povo, diz:<br>"
      + "Em nome do Pai e do Filho e do Espírito Santo.<br>"
      + "O povo responde: Amen.<br>"
      + "2. "
      + "Depois, o sacerdote, abrindo os braços, saúda o povo, dizendo:<br>"
      + "A graça de nosso Senhor Jesus Cristo,<br>"
      + "o amor do Pai e a comunhão do Espírito Santo<br>"
      + "estejam convosco.<br>"
      + " O povo responde: Bendito seja Deus, que nos reuniu no amor de Cristo. <br>"
    )
     + (
      "Ou: A graça e a paz de Deus, nosso Pai, <br>"
      + " e de Jesus Cristo, nosso Senhor, estejam convosco.<br>"
      + "O povo responde: Bendito seja Deus, que nos reuniu no amor de Cristo. <br>"
      + "Ou: A graça de nosso Senhor Jesus Cristo esteja convosco.<br>"
      + "O povo responde: Bendito seja Deus, que nos reuniu no amor de Cristo. <br>"
      + "Ou: A graça de nosso Senhor Jesus Cristo<br>"
      + " que por nós Se fez homem<br>"
      + "(ou: que por nós morreu e ressuscitou<br>"
      + "ou: que por nós intercede junto do Pai) esteja convosco.<br>"
      + "O povo responde: Bendito seja Deus, que nos reuniu no amor de Cristo.<br>"
      + "Ou: O Senhor esteja convosco.<br>"
      + "O povo responde: Ele está no meio de nós. <br>"
      + "O bispo, em vez de O Senhor esteja convosco, nesta primeira saudação diz:<br>"
      + "A paz esteja convosco.<br>"
      + "O povo responde: Bendito seja Deus, que nos reuniu no amor de Cristo.<br>"
      + "<br>"
      + "RITOS INICIAIS<br>"
      + "Ou: A paz, a caridade e a fé, <br>"
    ))
     + ((
      "da parte de Deus Pai e de Jesus Cristo, nosso Senhor,<br>"
      + "estejam convosco. <br>"
      + " O povo responde: Bendito seja Deus, que nos reuniu no amor de Cristo.<br>"
      + "Ou: A graça e a paz do Senhor que é, que era e que vem,<br>"
      + " estejam convosco. <br>"
      + " O povo responde: Bendito seja Deus, que nos reuniu no amor de Cristo.<br>"
      + "Ou: O Deus da esperança,<br>"
      + " que, pela ação do Espírito Santo,<br>"
      + " nos alegra com a sua paz,<br>"
      + " esteja convosco. <br>"
      + " O povo responde: Bendito seja Deus, que nos reuniu no amor de Cristo.<br>"
      + "Ou: Tempo do Advento:<br>"
      + " O Senhor, que vem salvar-nos, esteja convosco. <br>"
      + " O povo responde: Bendito seja Deus, que nos reuniu no amor de Cristo.<br>"
      + "Ou: Tempo do Natal:<br>"
      + " A paz e o amor de Deus Pai, <br>"
      + " que se manifestaram em Cristo, nascido para nossa salvação, <br>"
      + " estejam convosco. <br>"
    )
     + (
      " O povo responde: Bendito seja Deus, que nos reuniu no amor de Cristo.<br>"
      + "Ou: Tempo da Quaresma:<br>"
      + " A graça e o amor de Jesus Cristo, que nos chama à conversão,<br>"
      + " estejam convosco. <br>"
      + " O povo responde: Bendito seja Deus, que nos reuniu no amor de Cristo. <br>"
      + "Ou: Tempo da Páscoa:<br>"
      + " O Deus da vida, que ressuscitou Jesus Cristo,<br>"
      + " destruindo as cadeias da morte, esteja convosco.<br>"
      + " O povo responde: Bendito seja Deus, que nos reuniu no amor de Cristo.<br>"
      + "3. "
      + "O sacerdote, ou o diácono, ou um ministro idóneo, pode fazer aos fiéis uma <br>"
      + "brevíssima introdução à Missa do dia.<br>"
      + "<br>"
      + "Ato penitencial – A<br>"
      + "4. "
      + "Em seguida, o sacerdote convida os fiéis ao ato penitencial, dizendo:<br>"
      + "Irmãos:<br>"
      + "Para celebrarmos dignamente os santos mistérios,<br>"
    )))
     + (((
      "reconheçamos que somos pecadores.<br>"
      + "Ou, nos domingos:<br>"
      + "Na celebração da vitória de Cristo sobre o pecado e a morte,<br>"
      + "em que somos convidados a morrer para o pecado <br>"
      + "e a ressurgir para uma vida nova,<br>"
      + "invoquemos a misericórdia do Pai,<br>"
      + "porque somos pecadores.<br>"
      + "Guardam-se alguns momentos de silêncio.<br>"
      + "Seguidamente, o sacerdote introduz a confissão com estas palavras ou outras <br>"
      + "semelhantes:<br>"
      + "Confessemos os nossos pecados.<br>"
      + "Dizem todos juntos a fórmula de confissão geral:<br>"
      + "Confesso a Deus todo-poderoso <br>"
      + "e a vós, irmãos,<br>"
      + "que pequei muitas vezes,<br>"
      + "por pensamentos e palavras, <br>"
      + "atos e omissões,<br>"
      + "e, batendo no peito, dizem:<br>"
    )
     + (
      "por minha culpa, minha culpa, minha tão grande culpa.<br>"
      + "e continuam:<br>"
      + "E peço à Virgem Maria,<br>"
      + "aos anjos e santos,<br>"
      + "e a vós, irmãos, <br>"
      + "que rogueis por mim a Deus, nosso Senhor.<br>"
      + "Segue-se a absolvição do sacerdote:<br>"
      + "Deus todo-poderoso tenha compaixão de nós,<br>"
      + "perdoe os nossos pecados e nos conduza à vida eterna.<br>"
      + "O povo responde: Amen.<br>"
      + "Em seguida, diz-se o Senhor, tende piedade (Kýrie eléison).<br>"
      + "<br>"
      + "Ato penitencial – B<br>"
      + "5. "
      + "O sacerdote convida os fiéis ao ato penitencial, dizendo:<br>"
      + "Irmãos, para celebrarmos dignamente os santos mistérios, <br>"
      + "reconheçamos que somos pecadores.<br>"
      + "Ou: De coração humilde e contrito<br>"
    ))
     + ((
      " pela consciência dos nossos pecados,<br>"
      + " voltemo-nos para Deus, que é santo.<br>"
      + "Guardam-se alguns momentos de silêncio. <br>"
      + "Seguidamente, o sacerdote diz:<br>"
      + "Tende compaixão de nós, Senhor. <br>"
      + "O povo responde: Porque somos pecadores.<br>"
      + "O sacerdote continua:<br>"
      + "Manifestai, Senhor, a vossa misericórdia.<br>"
      + "O povo responde: E dai-nos a vossa salvação.<br>"
      + "Segue-se a absolvição do sacerdote:<br>"
      + "Deus todo-poderoso tenha compaixão de nós, <br>"
      + "perdoe os nossos pecados e nos conduza à vida eterna.<br>"
      + "O povo responde: Amen.<br>"
      + "Em seguida, diz-se o Senhor, tende piedade (Kýrie eléison).<br>"
      + "Ato penitencial – C<br>"
      + "6. "
      + "O sacerdote convida os fiéis ao ato penitencial, dizendo:<br>"
      + "Irmãos:<br>"
    )
     + (
      "Para celebrarmos dignamente os santos mistérios, <br>"
      + "reconheçamos que somos pecadores.<br>"
      + "Ou: Jesus Cristo, o justo, intercede por nós <br>"
      + " e reconcilia-nos com o Pai.<br>"
      + " Abramos o nosso espírito ao arrependimento<br>"
      + " para celebrarmos dignamente os santos mistérios. <br>"
      + "Guardam-se alguns momentos de silêncio. <br>"
      + "RITOS INICIAIS<br>"
      + "<br>"
      + "Seguidamente, o sacerdote, ou um ministro idóneo, diz ou canta as seguintes <br>"
      + "invocações ou outras semelhantes:<br>"
      + "Senhor, que fostes enviado pelo Pai a salvar os corações atribulados:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison.<br>"
      + "O povo responde:<br>"
      + "Senhor, misericórdia ou Senhor, tende piedade de nós ou Kýrie, eléison.<br>"
      + "O sacerdote continua:<br>"
      + "Cristo, que viestes chamar os pecadores:<br>"
    ))))
     + ((((
      "Cristo, misericórdia <br>"
      + "ou Cristo, tende piedade de nós ou Christe, eléison.<br>"
      + "O povo responde:<br>"
      + "Cristo, misericórdia ou Cristo, tende piedade de nós ou Christe, eléison.<br>"
      + "De novo, o sacerdote diz:<br>"
      + "Senhor, que estais à direita do Pai a interceder por nós:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison.<br>"
      + "O povo responde:<br>"
      + "Senhor, misericórdia ou Senhor, tende piedade de nós ou Kýrie, eléison. <br>"
      ...
      + "perdoe os nossos pecados e nos conduza à vida eterna. <br>"
      + "O povo responde: Amen. <br>"
      + "Em seguida, omitido o Senhor, tende piedade (Kýrie), diz-se o hino Glória, quando <br>"
      + "está prescrito para a Missa.<br>"
      + "<br>"
      + "Invocações alternativas<br>"
    )
     + (
      "1.<br>"
      + "Senhor, que sois o caminho que nos conduz ao Pai:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Cristo, que sois a verdade que ilumina os povos:<br>"
      + "Cristo, misericórdia <br>"
      + "ou Cristo, tende piedade de nós ou Christe, eléison. "
      + "R.<br>"
      + "Senhor, que sois a vida que renova o mundo: <br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "2.<br>"
      + "Senhor, que viestes procurar quem estava perdido:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
    ))
     + ((
      "Cristo, que viestes dar a vida em resgate de todos:<br>"
      + "Cristo, misericórdia <br>"
      + "ou Cristo, tende piedade de nós ou Christe, eléison. "
      + "R.<br>"
      + "Senhor, que congregais na unidade os filhos de Deus:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "3.<br>"
      + "Senhor, que sois o defensor dos pobres:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Cristo, que sois a fortaleza dos fracos:<br>"
      + "Cristo, misericórdia <br>"
      + "ou Cristo, tende piedade de nós ou Christe, eléison. "
      + "R.<br>"
      + "Senhor, que sois a esperança dos pecadores:<br>"
    )
     + (
      "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      ...
      + "Tempo do Advento<br>"
      + "1.<br>"
      + "Senhor, que viestes ao mundo para nos salvar:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Cristo, que nos visitais continuamente com a graça do vosso Espírito:<br>"
      + "Cristo, misericórdia <br>"
      + "ou Cristo, tende piedade de nós ou Christe, eléison. "
      + "R.<br>"
      + "Senhor, que vireis um dia para julgar as nossas obras:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
    )))
     + (((
      "R.<br>"
      + "2.<br>"
      + "Senhor, que vindes visitar vosso povo na paz:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Cristo, que vindes salvar o que estava perdido:<br>"
      + "Cristo, misericórdia <br>"
      + "ou Cristo, tende piedade de nós ou Christe, eléison. "
      + "R.<br>"
      + "Senhor, que vindes criar um mundo novo:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Tempo do Natal<br>"
      + "1.<br>"
      + "Senhor, Filho de Deus, que, nascendo da Virgem Maria, <br>"
      + " vos fizestes nosso irmão,<br>"
    )
     + (
      "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Cristo, Filho do homem, que conheceis e compreendeis a nossa fraqueza,<br>"
      + "Cristo, misericórdia <br>"
      + "ou Cristo, tende piedade de nós ou Christe, eléison. "
      + "R.<br>"
      + "Senhor, Filho primogénito do Pai, que fazeis de nós uma família,<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "<br>"
      + "2.<br>"
      + "Senhor, rei da paz:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Cristo, luz nas trevas:<br>"
    ))
     + ((
      "Cristo, misericórdia <br>"
      + "ou Cristo, tende piedade de nós ou Christe, eléison. "
      + "R.<br>"
      + "Senhor, imagem do homem novo:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Tempo da Quaresma<br>"
      + "1.<br>"
      + "Senhor, que, na cruz, perdoastes ao ladrão arrependido:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Cristo, que nos mandastes perdoar <br>"
      + " antes de nos aproximarmos do vosso altar: <br>"
      + "Cristo, misericórdia <br>"
      + "ou Cristo, tende piedade de nós ou Christe, eléison. "
      + "R.<br>"
    )
     + (
      "Senhor, que confiastes à vossa Igreja o ministério da reconciliação:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "2.<br>"
      + "Senhor, que, na água e no Espírito, nos regenerastes à vossa imagem: <br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Cristo, que enviais o vosso Espírito para criar em nós um coração novo:<br>"
      + "Cristo, misericórdia <br>"
      + "ou Cristo, tende piedade de nós ou Christe, eléison. "
      + "R.<br>"
      + "Senhor, que nos fazeis participantes do vosso Corpo e do vosso Sangue:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "RITOS INICIAIS<br>"
     ...
     + (((((
      "<br>"
      + "3.<br>"
      + "Senhor, que fazeis passar da morte para a vida<br>"
      + " os que ouvem a vossa palavra:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Cristo, que quisestes ser levantado da terra para nos atrair a V ós:<br>"
      + "Cristo, misericórdia <br>"
      + "ou Cristo, tende piedade de nós ou Christe, eléison. "
      + "R.<br>"
      + "Senhor, que subistes à cruz por nós, <br>"
      + " para sermos elevados à glória da ressurreição:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Tempo da Páscoa<br>"
     ...
     + (
      ...
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Cristo, nossa Páscoa:<br>"
      + "Cristo, misericórdia <br>"
      + "ou Cristo, tende piedade de nós ou Christe, eléison. "
      + "R.<br>"
      + "Senhor, nossa vida:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "2.<br>"
      + "Senhor, que sois o eterno sacerdote da nova Aliança:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
    ))
     + ((
      "Cristo, que nos edificais como pedras vivas no templo santo de Deus:<br>"
      + "Cristo, misericórdia <br>"
      + "ou Cristo, tende piedade de nós ou Christe, eléison. "
      + "R.<br>"
      + "Senhor, que nos tornais concidadãos dos santos no reino dos céus:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "<br>"
      + "Ascensão<br>"
      + "Senhor, que subistes ao céu como Rei do universo e Senhor dos séculos:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Cristo, que, na vossa Ascensão, levastes cativo o cativeiro:<br>"
      + "Cristo, misericórdia <br>"
      + "ou Cristo, tende piedade de nós ou Christe, eléison. "
      + "R.<br>"
    )
     + (
      "Senhor, que, voltando à casa do Pai, nos abristes o céu: <br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Pentecostes<br>"
      + "Senhor, que, pelo Espírito Santo, estais sempre presente no mundo:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Cristo, que dais o Espírito Santo para o perdão dos pecados: <br>"
      + "Cristo, misericórdia <br>"
      + "ou Cristo, tende piedade de nós ou Christe, eléison. "
      + "R.<br>"
      + "Senhor, que enviais o Espírito Santo para criar um mundo novo:<br>"
      + "Senhor, misericórdia <br>"
      + "ou Senhor, tende piedade de nós ou Kýrie, eléison. "
      + "R.<br>"
      + "Em seguida, omitido o Senhor, tende piedade (Kýrie eléison), diz-se o hino Glória, <br>"
    )))
     + (((
      "quando está prescrito para a Missa.<br>"
      + "Aspersão dominical da água benta<br>"
      + "6.1. "
      + "Ao domingo, especialmente no Tempo Pascal, pode celebrar-se a bênção e <br>"
      + "a aspersão da água benta em memória do Batismo, em todas as Missas, inclusive <br>"
      + "naquelas que se antecipam para o sábado de tarde, em todas as igrejas.<br>"
      + " Este rito substitui o habitual ato penitencial.<br>"
      + "RITOS INICIAIS<br>"
      + "<br>"
      + "A<br>"
      + "6.2. "
      + "Depois da saudação inicial, o sacerdote, de pé, junto à sua sede, voltado para <br>"
      + "o povo, tendo diante de si um recipiente com água para benzer, exorta o povo à <br>"
      + "oração com estas ou outras palavras semelhantes:<br>"
      + "Oremos, irmãos caríssimos, a Deus nosso Senhor, <br>"
      + "suplicando-Lhe que Se digne abençoar esta água, <br>"
      + "que vai ser aspergida sobre nós para memória do nosso <br>"
      + "Batismo, <br>"
    )
     + (
      "e nos renove interiormente, <br>"
      + "a fim de permanecermos fiéis ao Espírito que recebemos.<br>"
      + "Depois de breve oração em silêncio, o sacerdote diz, de mãos juntas:<br>"
      + "Deus todo-poderoso e eterno, <br>"
      + "que, por meio da água, fonte de vida e elemento de purificação,<br>"
      + "quisestes também que fossem lavadas as nossas almas <br>"
      + "e recebessem o dom da vida eterna, <br>"
      + "dignai-Vos abençoar + esta água, <br>"
      + "para que seja sinal da vossa proteção, neste dia a Vós consagrado. <br>"
      + "Por meio desta água, Senhor, renovai em nós a fonte da graça <br>"
      + "e livrai-nos de todo o mal da alma e do corpo, <br>"
      + "para estarmos na vossa presença de coração puro<br>"
      + "e recebermos dignamente os frutos da redenção. <br>"
     ...
     + ((
      "fonte e origem de toda a vida do corpo e da alma, <br>"
      + "abençoai + esta água, que vamos aspergir sobre nós,<br>"
      + "para implorar o perdão dos nossos pecados <br>"
      + "e obter a graça da vossa proteção <br>"
      + "contra todos os males e insídias do inimigo. <br>"
      + "Concedei-nos, Senhor, pela vossa misericórdia, <br>"
      + "que brotem sempre, para nós, as fontes vivas da salvação, <br>"
      + "para que, livres de todos os perigos do corpo e da alma, <br>"
      + "cheguemos à vossa presença de coração puro. <br>"
      + "Por Cristo nosso Senhor.<br>"
      + "R. "
      + "Amen.<br>"
      + "<br>"
      + "Ou, no Tempo Pascal:<br>"
      + "Deus todo-poderoso e eterno, <br>"
      + "escutai benignamente as orações do vosso povo. <br>"
      + "Ao celebrarmos a obra admirável da nossa criação <br>"
      + "e a maravilha ainda maior da nossa redenção, <br>"
    )
     + (
      "dignai-Vos abençoar + esta água.<br>"
      + "Vós a criastes para dar fecundidade à terra <br>"
      + "e frescura e pureza aos nossos corpos. <br>"
      + "Vós a fizestes instrumento de misericórdia, <br>"
      + "libertando da escravidão o vosso povo <br>"
      + "e matando a sua sede no deserto. <br>"
      + "Por meio dos Profetas, <br>"
      + "Vós a proclamastes sinal da nova aliança,<br>"
      + "que quisestes estabelecer com os homens.<br>"
      + "Finalmente, nas águas do Jordão, santificadas por Cristo, <br>"
      + "inaugurastes o sacramento da regeneração espiritual, <br>"
      + "que renova a nossa natureza humana, <br>"
      + "libertando-a da corrupção do pecado.<br>"
      + "Esta água, Senhor, nos faça reviver o Batismo que recebemos <br>"
      + "e nos leve a participar na alegria dos nossos irmãos,<br>"
      + "batizados na Páscoa de nosso Senhor Jesus Cristo. <br>"
      + "Ele que vive e reina pelos séculos dos séculos.<br>"
      + "R. "
    ))))
     + ((((
      "Amen.<br>"
      + "6.3. "
      + "Quando as circunstâncias locais ou os costumes populares aconselham que se <br>"
      + "conserve o rito de misturar sal na água benta, o sacerdote abençoa o sal, dizendo:<br>"
      + "Deus todo-poderoso e eterno, abençoai + este sal, <br>"
      + "Vós que ordenastes ao profeta Eliseu que o misturasse na água<br>"
      + "para remediar a sua esterilidade.<br>"
      + "Fazei que, mediante a aspersão purificadora do sal e da água, <br>"
      + "sejamos livres do poder do inimigo <br>"
      + "e sempre protegidos pela presença do Espírito Santo. <br>"
      + "Por Cristo nosso Senhor.<br>"
      + "R. "
      + "Amen.<br>"
      + "Então, o sacerdote mistura o sal na água.<br>"
      + "RITOS INICIAIS<br>"
      + "<br>"
      + "6.4. "
      + "O sacerdote toma o hissope, asperge-se a si mesmo e, depois, os ministros, <br>"
    )
     + (
      "o clero e os fiéis. "
      + "Se parecer conveniente, pode passar através da igreja para a <br>"
      + "aspersão dos fiéis.<br>"
      + " Entretanto, canta-se um dos seguintes cânticos ou outro apropriado.<br>"
      + "Fora do Tempo Pascal<br>"
      + "ANTÍFONA 1 Sl 50, 9<br>"
      + "Aspergi-me, Senhor, com o hissope e ficarei puro, <br>"
      + "lavai-me e ficarei mais branco do que a neve.<br>"
      + "ANTÍFONA 2 Ez 36, 25-26<br>"
      + "Derramarei sobre vós água pura e ficareis limpos de toda a iniquidade; <br>"
      + "Eu vos darei um coração novo, diz o Senhor.<br>"
      + "HINO Cf. "
      + "1Pd 1, 3-5<br>"
      + "Bendito seja Deus, Pai de nosso Senhor Jesus Cristo, <br>"
      + "que, na sua grande misericórdia, <br>"
      + "pela ressurreição de Jesus Cristo de entre os mortos, <br>"
      + "nos fez renascer para uma esperança viva, <br>"
      + "para uma herança incorruptível, <br>"
    ))
     + ((
      "que nos está reservada no céu, <br>"
      + "para a salvação que se vai revelar na plenitude dos tempos.<br>"
      + "No Tempo Pascal<br>"
      + "ANTÍFONA 1 Cf. "
      + "Ez 47, 1-2.9<br>"
      + "Vi a água sair do lado direito do templo. "
      ...
      + "ANTÍFONA 2 Cf. "
      + "Sf 3, 8; Ez 36, 25<br>"
      + "No dia da minha ressurreição, diz o Senhor, Aleluia, <br>"
      + "reunirei os povos e os reinos e derramarei sobre vós água pura. "
      + "Aleluia.<br>"
      + "ANTÍFONA 3 Cf. "
      + "Dn 3, 77.79<br>"
      + "Fontes e tudo o que se move nas águas, bendizei o Senhor. <br>"
    )
     + (
      "Aleluia. <br>"
      + "ANTÍFONA 4 1Pd 2, 9<br>"
      + "Vós sois povo eleito, sacerdócio real, nação santa, <br>"
      + "para anunciar os louvores de Deus, <br>"
      + "que vos chamou das trevas para a sua luz admirável. "
      + "Aleluia.<br>"
      + "<br>"
      + "ANTÍFONA 5<br>"
      + "Do vosso coração, Senhor Jesus Cristo, brotou uma fonte de água viva, <br>"
      + "onde o mundo se lava dos seus pecados e a vida se renova. "
      + "Aleluia.<br>"
      + "6.5. "
      + "Então, o sacerdote volta para a sua sede. "
      + "Terminado o cântico, volta-se para <br>"
      + "o povo e, de pé, com as mãos juntas, diz:<br>"
      + "Deus todo-poderoso nos purifique do pecado <br>"
      + "e, pela celebração da Eucaristia, <br>"
      + "nos torne dignos de participar na mesa do seu reino,<br>"
    )))
     + (((
      ...
      + "quando está prescrito para a Missa.<br>"
      + "B<br>"
      + "O sacerdote exorta o povo à oração, dizendo estas palavras ou outras semelhantes:<br>"
      + "Invoquemos, irmãos caríssimos, a Deus Pai, <br>"
      + "para que este rito de aspersão reavive em nós a graça do Batismo,<br>"
      + "por meio do qual participamos na morte redentora de Cristo,<br>"
      + "a fim de ressuscitar com Ele para a vida nova.<br>"
      + "Depois de breve oração em silêncio, diz:<br>"
      + "Deus criador, que, na água e no Espírito,<br>"
      + "destes forma e imagem ao homem e ao universo:<br>"
      + " R. "
      + "Purificai e abençoai a vossa Igreja.<br>"
      + " Ou: Glória a V ós, Senhor.<br>"
      + "Cristo, que, do vosso lado aberto na cruz,<br>"
    )
     + (
      "fizestes brotar os sacramentos da salvação:<br>"
      + " R. "
      + "Purificai e abençoai a vossa Igreja.<br>"
      + " Ou: Glória a V ós, Senhor.<br>"
      + "Espírito Santo, que, da fonte batismal da Igreja, <br>"
      + "nos fizestes renascer como novas criaturas:<br>"
      + " R. "
      + "Purificai e abençoai a vossa Igreja.<br>"
      + " Ou: Glória a V ós, Senhor.<br>"
      + "RITOS INICIAIS<br>"
      + "<br>"
      + "Depois, de mãos juntas, o sacerdote diz:<br>"
      + "Deus de infinita santidade,<br>"
      + "que reunis a vossa Igreja, esposa e corpo do Senhor, <br>"
      + "no dia memorial da ressurreição,<br>"
      + "abençoai o vosso povo e reavivai em nós, por meio desta água,<br>"
      + "a memória da Páscoa e a graça do Batismo. <br>"
      + "Por Cristo nosso Senhor.<br>"
    ))
     + ((
      "R. "
      + "Amen.<br>"
      + "Ou, especialmente, no Tempo Pascal:<br>"
      + "Deus, Pai santo, que, do Cordeiro imolado na cruz, <br>"
      + "fizestes brotar as fontes da água viva:<br>"
      + "R. "
      + "Purificai e abençoai o vosso povo. "
      + "Ou Glória a V ós, Senhor.<br>"
      + "Cristo, que renovais a juventude da Igreja <br>"
      + "no Batismo da água e na palavra da vida:<br>"
      + "R. "
      + "Purificai e abençoai o vosso povo. "
      + "Ou Glória a V ós, Senhor.<br>"
      + "Espírito Santo, que, das águas do Batismo,<br>"
      + "nos fazeis surgir como primícias da nova humanidade:<br>"
      + "R. "
      + "Purificai e abençoai o vosso povo. "
      + "Ou Glória a V ós, Senhor.<br>"
    )
     + (
      ...
      + "que, nos sinais sagrados da nossa fé,<br>"
      + "renovais os prodígios da criação e da redenção, <br>"
      + "abençoai + esta água<br>"
      + "e dai a todos os que renasceram no Batismo<br>"
      + "a graça de serem anunciadores e testemunhas da Páscoa, <br>"
      + "que se renova na vossa Igreja.<br>"
      + "Por Cristo nosso Senhor.<br>"
      + "R. "
      + "Amen.<br>"
      + "O sacerdote toma o hissope, asperge-se a si mesmo e, depois, os ministros, o clero <br>"
      + "e os fiéis. "
      + "Se parecer conveniente, pode passar através da igreja para a aspersão <br>"
      + "dos fiéis.<br>"
      + "Entretanto, canta-se um cântico apropriado, como acima se indica no n. "
      + "6.4.<br>"
      + "<br>"
     ...
     + ((((((
      "Então, o sacerdote volta para a sua sede. "
      + "Terminado o cântico, volta-se para o <br>"
      + "povo e, de pé, com as mãos juntas, diz:<br>"
      + "Deus todo-poderoso nos purifique do pecado <br>"
      + "e, pela celebração da Eucaristia, <br>"
      + "nos torne dignos de participar na mesa do seu reino,<br>"
      + "pelos séculos dos séculos.<br>"
      ...
      + "quando está prescrito para a Missa.<br>"
      + "7. "
      + "Seguem-se as invocações Senhor, tende piedade de nós (Kýrie, eléison), a <br>"
      + "não ser que tenha sido usado o rito do Ato Penitencial – C ou o rito da Aspersão <br>"
      + "Dominical da Água Benta.<br>"
      + "V. "
      + "Senhor, tende piedade de nós. "
    )
     + (
     ...
     + (
      ...
      + "<br>"
      + "8. "
      + "Em seguida, segundo as rubricas, canta-se ou recita-se o hino:<br>"
     ...
     + (
      "Terminado o hino, o sacerdote, de mãos juntas, diz:<br>"
      + "<br>"
      + "Oremos.<br>"
      + "E todos, juntamente com o sacerdote, oram em silêncio durante alguns momentos.<br>"
      + "Depois, o sacerdote, de braços abertos, diz a oração coleta.<br>"
      + "Se a oração se dirige ao Pai, a conclusão é da seguinte forma:<br>"
      + "Por nosso Senhor Jesus Cristo, vosso Filho, que é Deus <br>"
      + "e convosco vive e reina, na unidade do Espírito Santo,<br>"
      + "por todos os séculos dos séculos.<br>"
      + "Se a oração se dirige ao Pai, com menção do Filho na parte final:<br>"
      + "Ele que é Deus e convosco vive e reina, na unidade do Espírito <br>"
      + "Santo,<br>"
      + "por todos os séculos dos séculos.<br>"
      + "Se a oração se dirige ao Filho:<br>"
      + "Vós que sois Deus e viveis e reinais com o Pai,<br>"
      + "na unidade do Espírito Santo, por todos os séculos dos séculos.<br>"
      + "No fim, o povo aclama: Amen.<br>"
     ...
     + ((
      ...
      + "Em seguida, o <br>"
      + "leitor vai ao ambão e lê a primeira leitura, que todos escutam sentados.<br>"
      + "No fim da leitura, o leitor aclama:<br>"
      + "Palavra do Senhor.<br>"
      + "Todos respondem: Graças a Deus.<br>"
      + "11. "
      + "O salmista ou cantor canta ou recita o salmo, ao qual o povo responde com <br>"
      + "o refrão.<br>"
      + "12. "
      + "A seguir, se há uma segunda leitura antes do Evangelho, o leitor lê-a no <br>"
      + "ambão, como se disse acima.<br>"
      + "No fim da leitura, o leitor aclama:<br>"
      + "Palavra do Senhor.<br>"
      + "Todos respondem: Graças a Deus.<br>"
      + "LITURGIA DA PALAVRA<br>"
     ...
     + (
      "13. "
      + "Segue-se o Aleluia ou outro cântico, requerido pelas rubricas, conforme o <br>"
      + "tempo litúrgico.<br>"
      + "14. "
      + "Entretanto, o sacerdote impõe incenso, sendo usado, no turíbulo.<br>"
      + " Em seguida, o diácono que tiver de proclamar o Evangelho, profundamente <br>"
      + "inclinado diante do sacerdote, pede a bênção em voz baixa, dizendo:<br>"
      + "A vossa bênção. <br>"
      + "O sacerdote, em voz baixa, diz:<br>"
      + "O Senhor esteja no teu coração e nos teus lábios,<br>"
      + "para anunciares dignamente o seu Evangelho:<br>"
      + "Em nome do Pai e do Filho + e do Espírito Santo.<br>"
      + "O diácono benze-se e responde: Amen.<br>"
      + "Se não houver diácono, o sacerdote, inclinado diante do altar, diz em silêncio:<br>"
      + "Deus todo-poderoso, purificai o meu coração e os meus lábios, <br>"
      + "para que eu anuncie dignamente o vosso santo Evangelho.<br>"
      + "15. "
      + "A seguir, o diácono ou o sacerdote, dirige-se para o ambão, acompanhado <br>"
    ))))
     + ((((
      "dos acólitos que podem levar o incenso e os círios, e diz:<br>"
      + "O Senhor esteja convosco.<br>"
      + "O povo responde: Ele está no meio de nós.<br>"
      + "O diácono ou o sacerdote diz:<br>"
      + "Evangelho de nosso Senhor Jesus Cristo, segundo são N. <br>"
      + "Ao mesmo tempo faz o sinal da cruz sobre o livro e, depois, sobre si mesmo na <br>"
      + "fronte, na boca e no peito, e o mesmo fazem todos os demais.<br>"
      + "O povo aclama: Glória a V ós, Senhor.<br>"
      + "A seguir, quando se usar o incenso, o diácono ou o sacerdote incensa o livro e <br>"
      + "proclama o Evangelho.<br>"
      + "16. "
      + "Terminado o Evangelho, o diácono ou o sacerdote aclama:<br>"
      + "Palavra da salvação. <br>"
      + "O povo responde: Glória a V ós, Senhor.<br>"
      + "Em seguida, beija o livro, dizendo em silêncio:<br>"
      + "Por este santo Evangelho, perdoai-nos, Senhor.<br>"
      + "17. "
      + "Depois, segue-se a homilia, que deve ser feita pelo sacerdote ou pelo diácono, <br>"
    )
     + (
      "todos os domingos e festas de preceito e recomendada nos outros dias.<br>"
      + "<br>"
      + "18. "
      + "Terminada a homilia, canta-se ou recita-se, quando é prescrito, o símbolo ou <br>"
      + "profissão de fé.<br>"
      ...
      + "Todos se inclinam às palavras: E encarnou ... e Se fez homem.<br>"
      + "E encarnou pelo Espírito Santo, no seio da Virgem Maria, <br>"
    ))
     + ((
      "e Se fez homem. <br>"
      ...
      + "Professo um só batismo para remissão dos pecados. <br>"
     ...
     + (
      ...
      + "Ad verba quæ sequuntur, usque ad factus est, omnes se inclinant:<br>"
     ...
     + (((
      ...
      + "et ascendit in caelum, sedet ad déxteram Patris. <br>"
      + "Et íterum ventúrus est cum glória, <br>"
      + "iudicáre vivos et mórtuos, cuius regni non erit finis. <br>"
      ...
      + "Confíteor unum baptísma in remissiónem peccatórum. <br>"
      + "Et exspécto resurrectiónem mortuórum, <br>"
      + "et vitam ventúri sæculi. "
      + "Amen.<br>"
      + "Ou:<br>"
      + "19. "
      + "Em vez do símbolo niceno-constantinopolitano, sobretudo no Tempo da <br>"
      + "Quaresma e no Tempo Pascal, pode dizer-se o símbolo batismal da Igreja Romana, <br>"
    )
     + (
      "chamado «Símbolo dos Apóstolos».<br>"
      + "Creio em Deus, <br>"
      + "Pai todo-poderoso, Criador do céu e da terra; <br>"
      + "e em Jesus Cristo, seu único Filho, nosso Senhor,<br>"
      + "Todos se inclinam às palavras: que foi concebido ... nasceu da Virgem Maria. <br>"
     ...
     + ((
      ...
      + "Oração universal<br>"
      + "20. "
      + "Segue-se a oração universal ou oração dos fiéis.<br>"
      + "Para alguns exemplos de formulários, veja-se o Apêndice, p. "
      + "1406-1420.<br>"
      + "Início<br>"
      + "O sacerdote convida os fiéis à oração com uma breve admonição inicial.<br>"
      + "Intenções<br>"
      + "As intenções são propostas por um diácono ou um leitor ou outra pessoa idónea.<br>"
      + "O povo exprime a sua participação ou com uma invocação ou rezando em silêncio.<br>"
      + "Normalmente, a ordem das intenções é a seguinte:<br>"
      + "a) pelas necessidades da Igreja;<br>"
      + "b) pelas autoridades civis e pela salvação do mundo;<br>"
      + "c) por aqueles que sofrem dificuldades;<br>"
    )
     + (
      "d) pela comunidade local.<br>"
      + "Conclusão<br>"
      + "O sacerdote termina com uma oração conclusiva.<br>"
      + "No fim, o povo aclama: Amen.<br>"
      + "LITURGIA DA PALAVRA<br>"
      + "<br>"
      ...
      + "Terminada a oração universal, inicia-se o cântico do ofertório. "
      + "Entretanto, os <br>"
      + "ministros colocam no altar o corporal, o sanguinho, o cálice, a pala e o missal.<br>"
      + "22. "
      + "Convém que os fiéis manifestem a sua participação, apresentando o pão e o <br>"
      + "vinho para a celebração da Eucaristia, e mesmo outros dons para as necessidades <br>"
      + "da Igreja e dos pobres, conforme os costumes locais.<br>"
      + "23. "
      + "O sacerdote, junto do altar, toma a patena com o pão e, elevando-a com ambas <br>"
      + "as mãos um pouco acima do altar, diz em voz baixa:<br>"
    )))))
     + (((((
      "Bendito sejais, Senhor, Deus do universo,<br>"
      + "pelo pão que recebemos da vossa bondade,<br>"
      + "fruto da terra e do trabalho do homem, <br>"
      + "que hoje Vos apresentamos <br>"
      + "e que para nós se vai tornar pão da vida. <br>"
      + "Em seguida, depõe a patena com o pão sobre o corporal.<br>"
      + "Se não houver cântico do ofertório, o sacerdote pode proferir estas palavras em <br>"
      + "voz alta. <br>"
      + "No fim, o povo pode aclamar: Bendito seja Deus para sempre.<br>"
      + "24. "
      + "O diácono ou o sacerdote deita vinho e um pouco de água no cálice, dizendo <br>"
      + "em silêncio:<br>"
      + "Pelo mistério desta água e deste vinho,<br>"
      + "sejamos participantes da divindade<br>"
      + "d’Aquele que assumiu a nossa humanidade.<br>"
      + "25. "
      + "Em seguida, o sacerdote toma o cálice e, elevando-o com ambas as mãos um <br>"
      + "pouco acima do altar, diz em voz baixa:<br>"
    )
     + (
      "Bendito sejais, Senhor, Deus do universo, <br>"
      + "pelo vinho que recebemos da vossa bondade, <br>"
      + "fruto da videira e do trabalho do homem, <br>"
      + "que hoje Vos apresentamos <br>"
      + "e que para nós se vai tornar vinho da salvação.<br>"
      + "Em seguida, depõe o cálice sobre o corporal.<br>"
      + "<br>"
      + "Se não houver cântico do ofertório, o sacerdote pode proferir estas palavras em <br>"
      + "voz alta. <br>"
      + "No fim, o povo pode aclamar: Bendito seja Deus para sempre.<br>"
      + "26. "
      + "A seguir, o sacerdote inclina-se e diz em silêncio:<br>"
      + "De coração humilhado e contrito sejamos recebidos por V ós, Senhor. <br>"
      + "Assim o nosso sacrifício seja agradável a vossos olhos, Senhor nosso Deus.<br>"
      + "27. "
      + "Depois, usando-se o incenso, incensa as oblatas, a cruz e o altar. "
      + "A seguir, o <br>"
      + "diácono ou outro ministro incensa o sacerdote e o povo.<br>"
    ))
     + ((
      "28. "
      + "Em seguida, o sacerdote, estando ao lado do altar, lava as mãos, dizendo em <br>"
      + "silêncio:<br>"
      + "Lavai-me, Senhor, da minha iniquidade e purificai-me do meu pecado.<br>"
      + "29. "
      + "Depois, estando ao meio do altar e, voltado para o povo, abrindo e juntando <br>"
      + "as mãos, diz:<br>"
      + "Orai, irmãos, para que o meu e vosso sacrifício <br>"
      + "seja aceite por Deus Pai todo-poderoso.<br>"
      + " Ou: Irmãos, ao oferecermos o sacrifício de toda a Igreja,<br>"
      + " oremos a Deus Pai todo-poderoso.<br>"
      + " Ou: Orai, irmãos,<br>"
      + " para que as nossas alegrias e tristezas de cada dia, <br>"
      + " unidas ao sacrifício de Cristo, <br>"
      + " sejam aceites por Deus Pai todo-poderoso.<br>"
      + "O povo levanta-se e responde:<br>"
      + "Receba o Senhor por tuas mãos este sacrifício, <br>"
      + "para glória do seu nome, <br>"
    )
     + (
      "para nosso bem e de toda a santa Igreja.<br>"
      + "Ou: <br>"
      + "Oremos.<br>"
      + "Todos, juntamente com o sacerdote, oram em silêncio durante alguns momentos.<br>"
      + "LITURGIA EUCARÍSTICA<br>"
      + "<br>"
      + "30. "
      + "Em seguida, de braços abertos, o sacerdote diz a oração sobre as oblatas.<br>"
      + "Se a oração se dirige ao Pai, a conclusão é da seguinte forma:<br>"
      + "Por Cristo nosso Senhor.<br>"
      + "Se a oração se dirige ao Pai, com menção do Filho na parte final:<br>"
      + "Ele que vive e reina pelos séculos dos séculos.<br>"
      ...
      + "<br>"
      + "31. "
      + "Depois, o sacerdote começa a Oração eucarística.<br>"
    )))
     + (((
      "Abrindo os braços diz: <br>"
      + "O Senhor esteja convosco. <br>"
      + "O povo responde: Ele está no meio de nós.<br>"
      + "Elevando as mãos, o sacerdote continua:<br>"
      + "Corações ao alto. <br>"
      + "O povo responde: O nosso coração está em Deus.<br>"
      + "De braços abertos, o sacerdote acrescenta:<br>"
      + "Dêmos graças ao Senhor nosso Deus.<br>"
      + "O povo responde: É nosso dever, é nossa salvação.<br>"
      + "O sacerdote continua o prefácio de braços abertos.<br>"
      + "No fim junta as mãos e conclui o prefácio, cantando ou recitando em voz alta <br>"
      + "com o povo:<br>"
     ...
     + (
      ...
      + "Hosánna in excélsis.<br>"
      + "32. "
      + "Em todas as Missas, o sacerdote celebrante pode cantar, sobretudo as partes <br>"
      + "principais da Oração eucarística.<br>"
      + " Na Oração eucarística I, ou Cânone romano, podem omitir-se as partes que <br>"
      + "aparecem entre parêntesis.<br>"
      + "<br>"
      + "PREFÁCIO I DO ADVENTO<br>"
      + "As duas vindas de Cristo<br>"
      + "33. "
      + "Este prefácio diz-se desde o Domingo I do Advento até ao dia 16 de dezembro, <br>"
      + "nas Missas do Tempo e também nas outras Missas que não têm prefácio próprio.<br>"
      + "V. "
    ))
     + ((
      "O Senhor esteja convosco. "
      ...
      + "Corações ao alto. "
      + "R. "
      + "O nosso coração está em Deus.<br>"
      + "V. "
      + "Dêmos graças ao Senhor nosso Deus.<br>"
      + "R. "
      + "É nosso dever, é nossa salvação.<br>"
      + "Senhor, Pai santo, Deus eterno e omnipotente, <br>"
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Ele veio a primeira vez, <br>"
      + "na humildade da natureza humana, <br>"
      + "realizar o eterno desígnio do vosso amor <br>"
    )
     + (
      "e abrir-nos o caminho da salvação; <br>"
      + "de novo há de vir, no esplendor da sua glória, <br>"
      + "para nos dar em plenitude os bens prometidos,<br>"
      + "que, entretanto, vigilantes na fé, ousamos esperar.<br>"
      + "Por isso, com os anjos e os arcanjos,<br>"
      + "os tronos e as dominações <br>"
      + "e todos os coros celestes,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo,<br>"
      + "Senhor Deus do universo.<br>"
      + "O céu e a terra proclamam a vossa glória.<br>"
      + "Hossana nas alturas.<br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO I-A DO ADVENTO<br>"
      + "Cristo, Senhor e juiz da história<br>"
    ))))
     + ((((
      "33 a. "
      + "Este prefácio diz-se desde o Domingo I do Advento até ao dia 16 de dezembro, nas Missas do Tempo e também nas outras Missas que não têm prefácio <br>"
      + "próprio.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      ...
      + "R. "
      + "É nosso dever, é nossa salvação.<br>"
      + "Pai santo, Deus eterno e omnipotente, <br>"
      + "princípio e fim de todas as coisas, <br>"
      + "é verdadeiramente nosso dever dar-Vos graças <br>"
    )
     + (
      "e cantar-Vos um hino de bênção e de louvor.<br>"
      + "Vós nos escondestes o dia e a hora <br>"
      + "em que Jesus Cristo, vosso Filho, Senhor e juiz da história, <br>"
      + "aparecerá sobre as nuvens do céu, <br>"
      + "revestido de poder e majestade.<br>"
      + "Nesse dia tremendo e glorioso, <br>"
      + "passará o mundo presente <br>"
      + "e aparecerão os novos céus e a nova terra.<br>"
      + "Agora Ele vem ao nosso encontro, <br>"
      + "em cada homem e em cada tempo, <br>"
      + "para que O recebamos na fé e na caridade <br>"
      + "e dêmos testemunho da gloriosa esperança do seu reino.<br>"
      + "Por isso, na esperança da sua vinda,<br>"
      + "com os anjos e os santos e todos os coros celestes, <br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo.<br>"
      + "<br>"
     ...
     + ((
      "PREFÁCIO II DO ADVENTO<br>"
      + "A dupla expetativa de Cristo<br>"
      + "34. "
      + "Este prefácio diz-se desde 17 a 24 de dezembro nas Missas do Tempo e <br>"
      + "também nas outras Missas que não têm prefácio próprio.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
     ...
     + (
      ...
      + "dar-Vos graças, sempre e em toda a parte, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Foi Ele que os Profetas anunciaram, <br>"
      + "a Virgem Mãe esperou com inefável amor, <br>"
      + "João Batista proclamou estar para vir <br>"
      + "e mostrou já presente no meio dos homens. <br>"
      + "É Ele que nos dá a graça de nos prepararmos com alegria <br>"
      + "para o mistério do seu nascimento, <br>"
      + "a fim de nos encontrar vigilantes na oração <br>"
      + "e celebrando os seus louvores.<br>"
      + "Por isso, com os anjos e os arcanjos,<br>"
      + "os tronos e as dominações<br>"
      + "e todos os coros celestes,<br>"
      + "proclamamos a vossa glória, <br>"
     ...
     + (
      ...
      + "Pai santo, Deus eterno e omnipotente, <br>"
      + "é verdadeiramente nosso dever dar-Vos graças, <br>"
      + "sempre e em toda a parte.<br>"
      + "Nós Vos louvamos, nós Vos bendizemos, <br>"
      + "nós Vos glorificamos pelo admirável mistério da Virgem Mãe: <br>"
      + "Do antigo adversário veio a ruína, <br>"
      + "do seio virginal da Filha de Sião <br>"
      + "germinou Aquele que nos alimenta com o pão dos anjos <br>"
      + "e, para todo o género humano, brotou a salvação e a paz. <br>"
      + "A graça, que em Eva nos foi tirada, <br>"
      + "foi-nos restituída em Maria. <br>"
      + "Nela, Mãe de todos os homens, <br>"
      + "a maternidade, resgatada do pecado e da morte, <br>"
      + "recebe o dom da vida nova: <br>"
    ))
     + ((
      "onde abundou a culpa, superabundou a misericórdia <br>"
      + "por Cristo, nosso Salvador.<br>"
      + "Por isso, na esperança da sua vinda,<br>"
      + "com os anjos e os santos, <br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo.<br>"
      + "<br>"
      + "PREFÁCIO I DO NATAL DO SENHOR<br>"
      + "Cristo luz<br>"
      + "35. "
      + "Este prefácio diz-se nas Missas do Natal e sua oitava, nas Missas durante a <br>"
      + "oitava, ainda que tenham prefácio próprio, exceto nas Missas com prefácio próprio dos divinos mistérios ou das Pessoas divinas, e nos dias feriais do Tempo do <br>"
      + "Natal.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
     ...
     + (
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Pelo mistério do Verbo Encarnado, <br>"
      + "nova luz da vossa glória brilhou sobre nós, <br>"
      + "para que, contemplando a Deus visível aos nossos olhos, <br>"
      + "sejamos arrebatados no amor do que é invisível.<br>"
      + "Por isso, com os anjos e os arcanjos,<br>"
      + "os tronos e as dominações <br>"
      + "e todos os coros celestes,<br>"
    )))))))
     + (((((((
      ...
      + "No Cânone romano diz-se o Em comunhão com toda a Igreja próprio, p. "
      + "643. <br>"
      + "Nas Orações eucarísticas II e III faz-se também a comemoração própria do Natal. <br>"
      + "Nas Missas da vigília e da Noite do Natal do Senhor, diz-se: ao celebrarmos a <br>"
      + "noite santíssima; nas outras Missas, até à oitava do Natal, inclusive, diz-se: ao <br>"
      + "celebrarmos o dia santíssimo.<br>"
      + "<br>"
      + "PREFÁCIO II DO NATAL DO SENHOR<br>"
      + "A restauração do universo na Encarnação<br>"
    )
     + (
      "36. "
      + "Este prefácio diz-se nas Missas do Natal e sua oitava, nas Missas durante a <br>"
     ...
     + ((
      "dar-Vos graças, sempre e em toda a parte, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "No mistério do seu nascimento, <br>"
      + "Aquele que, por sua natureza, era invisível,<br>"
      + "tornou-Se visível aos nossos olhos. <br>"
      + "Gerado desde toda a eternidade, <br>"
      + "começou a existir no tempo<br>"
      + "para renovar em Si a natureza decaída, <br>"
      + "restaurar o universo e reconduzir ao reino dos céus<br>"
      + "o homem perdido pelo pecado.<br>"
      + "Por isso, com todos os anjos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) com alegria:<br>"
      + "Santo, Santo, Santo.<br>"
      + "No Cânone romano diz-se o Em comunhão com toda a Igreja próprio. "
      + "Nas Orações <br>"
      + "eucarísticas II e III faz-se também a comemoração própria do Natal. "
     ...
     + (
      "da vigília e da noite do Natal do Senhor, diz-se: ao celebrarmos a noite santíssima; nas outras Missas, até à oitava do Natal, inclusive, diz-se: ao celebrarmos o <br>"
      + "dia santíssimo.<br>"
      + "<br>"
      + "PREFÁCIO III DO NATAL DO SENHOR<br>"
      + "A admirável permuta realizada na Encarnação do V erbo<br>"
      + "37. "
      + "Este prefácio diz-se nas Missas do Natal e sua oitava, nas Missas durante a <br>"
      + "oitava, ainda que tenham prefácio próprio, exceto nas Missas com prefácio próprio dos divinos mistérios ou das Pessoas divinas, e nos dias feriais do Tempo do <br>"
      + "Natal.<br>"
     ...
     + (((
      ...
      + "dar-Vos graças, sempre e em toda a parte, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Por Ele resplandece hoje, para os homens,<br>"
      + "a admirável permuta da encarnação redentora: <br>"
      + "a nossa fragilidade humana é assumida pelo Verbo, <br>"
      + "o homem mortal é elevado à dignidade imortal <br>"
      + "e, unido a Vós em comunhão admirável, <br>"
      + "torna-se participante da vida eterna.<br>"
      + "Por isso, com todos os coros dos anjos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) com alegria:<br>"
      + "Santo, Santo, Santo,<br>"
      + "Senhor Deus do universo.<br>"
     ...
     + (
      ...
      + "dia santíssimo.<br>"
      + "<br>"
      + "PREFÁCIO DA EPIFANIA DO SENHOR<br>"
      + "Cristo, luz de todos os povos<br>"
      + "38. "
      + "Este prefácio diz-se nas Missas da solenidade da Epifania. "
      + "Nos dias que decorrem desde a Epifania até ao sábado que precede a festa do Batismo do Senhor <br>"
      + "pode dizer-se este prefácio ou um dos prefácios do Natal.<br>"
      + "V. "
    ))
     + ((
      "O Senhor esteja convosco. "
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Hoje, em Cristo, luz do mundo, <br>"
      + "revelastes a todos os povos o mistério da nossa salvação <br>"
      + "e, manifestando-O na nossa natureza mortal, <br>"
      + "nos renovastes com o esplendor da sua imortalidade.<br>"
    )
     + (
      "Por isso, com os anjos e os arcanjos,<br>"
      + "os tronos e as dominações <br>"
      ...
      + "No Cânone romano diz-se o Em comunhão com toda a Igreja próprio. "
      + "Nas Orações <br>"
      + "eucarísticas II e III faz-se também a comemoração própria.<br>"
      + "<br>"
      + "PREFÁCIO I DA QUARESMA<br>"
      + "Significado espiritual da Quaresma<br>"
      + "39. "
    ))))
     + ((((
      "Este prefácio diz-se no Tempo da Quaresma, especialmente nos domingos <br>"
      + "que não têm outro prefácio mais próprio.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
     ...
     + (
      "Todos os anos concedeis aos vossos fiéis <br>"
      + "a graça de se prepararem, <br>"
      + "na alegria do coração purificado, <br>"
      + "para celebrar as festas pascais, <br>"
      + "a fim de que, pela oração mais intensa, <br>"
      + "pela caridade mais diligente, <br>"
      + "participando nos mistérios da renovação cristã, <br>"
      + "alcancem a plenitude da filiação divina.<br>"
      + "Por isso, com os anjos e os arcanjos, <br>"
      + "os tronos e as dominações<br>"
      + "e todos os coros celestes,<br>"
      + "proclamamos a vossa glória, <br>"
     ...
     + ((
      "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO II DA QUARESMA<br>"
      + "A penitência espiritual<br>"
      + "40. "
      + "Este prefácio diz-se no Tempo da Quaresma, especialmente nos domingos <br>"
      + "que não têm prefácio mais próprio.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
     ...
     + (
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Para renovar, na santidade, os vossos filhos, <br>"
      + "concedeis este tempo de salvação, <br>"
      + "a fim de que, libertando-se do fermento do pecado, <br>"
      + "se convertam a Vós de todo o coração <br>"
      + "e vivam de tal modo as realidades temporais <br>"
      + "que procurem sempre os bens eternos.<br>"
      + "Por isso, com os anjos e os santos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo,<br>"
      + "Senhor Deus do universo.<br>"
     ...
     + (((
      "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO III DA QUARESMA<br>"
      + "Os frutos da abstinência<br>"
      + "41. "
      + "Este prefácio diz-se nas Missas dos dias feriais da Quaresma e nos dias de <br>"
      + "jejum.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
     ...
     + (
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Vós nos ensinais, pela abstinência quaresmal, <br>"
      + "a manifestar-Vos a nossa gratidão, <br>"
      + "a dominar os excessos da nossa inclinação para o mal <br>"
      + "e a dar alimento aos que têm fome, <br>"
      + "imitando a vossa divina bondade.<br>"
      + "Por isso, com todos os coros dos anjos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo,<br>"
     ...
     + ((
      "<br>"
      + "PREFÁCIO IV DA QUARESMA<br>"
      + "Os frutos do jejum<br>"
      + "42. "
      + "Este prefácio diz-se nas Missas dos dias feriais da Quaresma e nos dias de <br>"
      + "jejum.<br>"
      + "V. "
     ...
     + (
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Pelo jejum corporal<br>"
      + "reprimis os vícios e elevais o espírito, <br>"
      + "infundis a fortaleza e dais a recompensa, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Por Ele, os anjos louvam a vossa majestade, <br>"
      + "as dominações Vos adoram, <br>"
      + "as potestades Vos reverenciam; <br>"
      + "os céus, os espíritos celestes <br>"
      + "e os serafins Vos aclamam, <br>"
      + "unidos em eterna exultação.<br>"
      + "Permiti que nos associemos às suas vozes,<br>"
      + "proclamando (cantando) humildemente o vosso louvor:<br>"
      + "Santo, Santo, Santo,<br>"
      + "Senhor Deus do universo.<br>"
      + "O céu e a terra proclamam a vossa glória.<br>"
    )))))
     + (((((
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO V DA QUARESMA<br>"
      + "O caminho do êxodo no deserto quaresmal<br>"
      + "42 a. "
      + "Este prefácio diz-se no Tempo da Quaresma, especialmente nos domingos <br>"
      + "que não têm prefácio mais próprio.<br>"
      + "V. "
     ...
     + (
      ...
      + "R. "
      + "É nosso dever, é nossa salvação.<br>"
      + "Senhor, Pai santo, rico de misericórdia, <br>"
      + "é verdadeiramente nossa salvação bendizer o vosso nome, <br>"
      + "no nosso itinerário para a luz pascal, <br>"
      + "seguindo os passos de Cristo, <br>"
      + "mestre e exemplo da humanidade, <br>"
      + "reconciliada no vosso amor.<br>"
      + "Vós abris à Igreja o caminho de um novo êxodo, <br>"
      + "através do deserto quaresmal, <br>"
      + "para que, aos pés da montanha santa, <br>"
      + "de coração contrito e humilhado, <br>"
      + "tome consciência da sua vocação como povo da aliança, <br>"
      + "reunido para cantar o vosso louvor,<br>"
      + "escutar a vossa palavra <br>"
      + "e viver a experiência admirável dos vossos prodígios.<br>"
    ))
     + ((
      "Por isso, com os anjos e os arcanjos <br>"
      + "e todos os coros celestes, <br>"
      ...
      + "Santo, Santo, Santo.<br>"
      + "<br>"
      + "PREFÁCIO VI DA QUARESMA<br>"
      + "O sacramento da reconciliação no Espírito<br>"
      + "42 b. "
      + "Este prefácio pode dizer-se na Missa da reconciliação e na Missa de caráter <br>"
      + "penitencial. "
      + "Diz-se também no Tempo da Quaresma.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
     ...
     + (
      ...
      + "R. "
      + "É nosso dever, é nossa salvação.<br>"
      + "Senhor, Pai santo, Deus omnipotente e misericordioso, <br>"
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "louvar-Vos e dar-Vos graças por todos os benefícios<br>"
      + "e, especialmente, pela graça do perdão.<br>"
      + "Ao homem, náufrago do pecado e da morte, <br>"
      + "pelo sacramento da reconciliação, <br>"
      + "abristes em Cristo, morto e ressuscitado,<br>"
      + "o porto da misericórdia e da paz. <br>"
      + "Pelo poder do vosso Espírito, <br>"
      + "estabelecestes para a Igreja, <br>"
      + "santa e também pecadora, <br>"
      + "uma segunda tábua de salvação depois do Batismo <br>"
    )))
     + (((
      "e continuamente a renovais <br>"
      + "para a reunir no banquete do vosso amor.<br>"
      + "Por isso, com os anjos e os santos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo.<br>"
      + "<br>"
      + "PREFÁCIO I DA PAIXÃO DO SENHOR<br>"
      + "O poder da Cruz<br>"
      + "43. "
      + "Este prefácio diz-se durante a Semana V da Quaresma e nas Missas da Santa <br>"
      + "Cruz e da Paixão do Senhor.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
     ...
     + (
      ...
      + "é verdadeiramente nosso dever, é nossa salvação<br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Pela paixão redentora do vosso Filho,<br>"
      + "abristes aos homens o caminho da fé,<br>"
      + "para proclamarem a glória do vosso nome.<br>"
      + "No admirável poder da cruz<br>"
      + "resplandece o julgamento do mundo<br>"
      + "e a vitória do Crucificado.<br>"
      + "Por isso, com os anjos e todos os santos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) com alegria:<br>"
    ))
     + ((
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO II DA PAIXÃO DO SENHOR<br>"
      + "A vitória da Paixão<br>"
      + "44. "
      + "Este prefácio diz-se na segunda, terça e quarta-feira da Semana Santa.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
     ...
     + (
      ...
      + "dar-Vos graças, sempre e em toda a parte, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Aproximam-se os dias solenes <br>"
      + "da paixão salvadora e da ressurreição gloriosa, <br>"
      + "em que é vencida a iniquidade da antiga serpente <br>"
      + "e se renova o mistério da nossa redenção.<br>"
      + "Por isso, a multidão dos anjos<br>"
      + "adora a vossa majestade<br>"
      + "e exulta eternamente na vossa presença.<br>"
      + "Permiti que nos associemos às suas vozes,<br>"
      + "dizendo (cantando) com alegria:<br>"
    ))))
     + ((((
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO PASCAL I<br>"
      + "O mistério pascal<br>"
      + "45. "
      + "Este prefácio diz-se no Tempo Pascal. <br>"
      + "Na Missa da Vigília Pascal diz-se: nesta noite; <br>"
      + "no dia da Páscoa e sua oitava diz-se: neste dia; <br>"
      + "depois da oitava diz-se: neste tempo.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
     ...
     + (
      ...
      + "Senhor, Pai santo, Deus eterno e omnipotente, <br>"
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "que sempre Vos louvemos, <br>"
      + "mas com maior solenidade (nesta noite – neste dia – neste tempo), <br>"
      + "em que Cristo, nossa Páscoa, foi imolado.<br>"
      + "Ele é o Cordeiro de Deus que tirou o pecado do mundo: <br>"
      + "morrendo destruiu a morte <br>"
      + "e ressuscitando restaurou a vida.<br>"
      + "Por isso, na plenitude da alegria pascal,<br>"
      + "exultam os homens por toda a terra<br>"
    ))
     + ((
      "e, com os anjos e todos os coros celestes,<br>"
      + "proclamam a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo,<br>"
      + "Senhor Deus do universo.<br>"
      + "O céu e a terra proclamam a vossa glória.<br>"
      ...
      + "Hossana nas alturas. <br>"
      + "No Cânone romano diz-se o Em comunhão com toda a Igreja e Aceitai benignamente próprios. "
      + "Nas Orações eucarísticas II e III faz-se também a comemoração <br>"
      + "própria. "
      + "Na Vigília Pascal diz-se: ao celebrarmos a noite santíssima.<br>"
      + "<br>"
      + "PREFÁCIO PASCAL II<br>"
      + "A vida nova em Cristo<br>"
      + "46. "
      + "Este prefácio diz-se no Tempo Pascal.<br>"
    )
     + (
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "que sempre Vos louvemos, <br>"
      + "mas com maior solenidade neste tempo, <br>"
      + "em que Cristo, nossa Páscoa, foi imolado.<br>"
      + "Por Ele nascem os filhos da luz para a vida eterna <br>"
    )))
     + (((
      "e abrem-se para os fiéis as portas do reino dos céus,<br>"
      + "porque a nossa morte foi redimida pela sua morte <br>"
      + "e na sua ressurreição ressurgiu a vida do género humano.<br>"
      + "Por isso, na plenitude da alegria pascal,<br>"
      + "exultam os homens por toda a terra<br>"
      + "e, com os anjos e todos os coros celestes,<br>"
      + "proclamam a vossa glória, <br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO PASCAL III<br>"
      + "Cristo vivo e intercessor perpétuo em nosso favor<br>"
      + "47. "
    )
     + (
      "Este prefácio diz-se no Tempo Pascal.<br>"
     ...
     + ((
      "Ele Se oferece continuamente por nós <br>"
      + "e nos defende com a sua intercessão. <br>"
      + "Foi imolado sobre a cruz, <br>"
      + "mas não morrerá jamais; <br>"
      + "foi morto, mas agora vive para sempre.<br>"
      + "Por isso, na plenitude da alegria pascal,<br>"
      + "exultam os homens por toda a terra<br>"
      + "e, com os anjos e todos os coros celestes,<br>"
      + "proclamam a vossa glória, <br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO PASCAL IV<br>"
    )
     + (
      "A renovação do universo pelo mistério pascal<br>"
      + "48. "
      + "Este prefácio diz-se no Tempo Pascal.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
     ...
     + ((((((
      "mas com maior solenidade neste tempo, <br>"
      + "em que Cristo, nossa Páscoa, foi imolado.<br>"
      + "Porque, vencendo a antiga corrupção do pecado, <br>"
      + "renovou o universo decaído <br>"
      + "e restaurou o género humano na sua integridade original.<br>"
      + "Por isso, na plenitude da alegria pascal,<br>"
      + "exultam os homens por toda a terra<br>"
      + "e, com os anjos e todos os coros celestes,<br>"
      + "proclamam a vossa glória, <br>"
     ...
     + (
      "PREFÁCIO PASCAL V<br>"
      + "Cristo, sacerdote e vítima<br>"
      + "49. "
      + "Este prefácio diz-se no Tempo Pascal.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
     ...
     + ((
      ...
      + "mas com maior solenidade neste tempo, <br>"
      + "em que Cristo, nossa Páscoa, foi imolado.<br>"
      + "Pela oblação do seu Corpo na cruz,<br>"
      + "levou à plenitude os sacrifícios antigos <br>"
      + "e, entregando-Se a Vós pela nossa salvação, <br>"
      + "tornou-Se Ele mesmo o sacerdote, o altar e o cordeiro.<br>"
      + "Por isso, na plenitude da alegria pascal,<br>"
      + "exultam os homens por toda a terra<br>"
      + "e, com os anjos e todos os coros celestes,<br>"
      + "proclamam a vossa glória, <br>"
     ...
     + (
      "<br>"
      + "PREFÁCIO I DA ASCENSÃO DO SENHOR<br>"
      + "O mistério da Ascensão<br>"
      + "50. "
      + "Este prefácio diz-se no dia de Ascensão do Senhor. "
      + "Pode dizer-se também <br>"
      + "nos dias a seguir à Ascensão, até ao sábado antes de Pentecostes, nas Missas que <br>"
      + "não têm prefácio próprio.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
     ...
     + (((
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Porque o Senhor Jesus Cristo, Rei da glória, <br>"
      + "vencedor da morte e do pecado, <br>"
      + "subiu (hoje) ao mais alto dos céus, ante a admiração dos anjos, <br>"
      + "e foi constituído Mediador entre Deus e os homens, <br>"
      + "Juiz do mundo e Senhor dos senhores. <br>"
      + "Ele não abandonou a nossa condição humana, <br>"
      + "mas, subindo aos céus, como nossa cabeça e primogénito, <br>"
      + "deu-nos a esperança de irmos um dia ao seu encontro, <br>"
      + "como membros do seu Corpo, <br>"
      + "para nos unir à sua glória imortal.<br>"
      + "Por isso, na plenitude da alegria pascal,<br>"
      + "exultam os homens por toda a terra<br>"
      + "e, com os anjos e todos os coros celestes,<br>"
    )
     + (
      ...
      + "Santo, Santo, Santo.<br>"
      + "<br>"
      + "PREFÁCIO II DA ASCENSÃO DO SENHOR<br>"
      + "O mistério da Ascensão<br>"
      + "51. "
      + "Este prefácio diz-se no dia de Ascensão. "
      + "Pode dizer-se também nos dias a <br>"
      + "seguir à Ascensão, até ao sábado antes de Pentecostes, nas Missas que não têm <br>"
      + "prefácio próprio.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
     ...
     + ((
      ...
      + "dar-Vos graças, sempre e em toda a parte, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Depois da sua ressurreição, <br>"
      + "apareceu a todos os discípulos<br>"
      + "e, à vista deles, subiu aos céus, <br>"
      + "para nos tornar participantes da sua divindade.<br>"
      + "Por isso, na plenitude da alegria pascal,<br>"
      + "exultam os homens por toda a terra<br>"
      + "e, com os anjos e todos os coros celestes,<br>"
      + "proclamam a vossa glória, <br>"
     ...
     + (
      ...
      + "Bendito O que vem em nome do Senhor.<br>"
      + "Hossana nas alturas. <br>"
      + "No dia da Ascensão, no Cânone romano diz-se o Em comunhão com toda a Igreja <br>"
      + "próprio. "
      + "Nas Orações eucarísticas II e III faz-se também a comemoração própria.<br>"
      + "<br>"
      + "PREFÁCIO I DOMINICAL DO TEMPO COMUM<br>"
      + "O mistério pascal e o povo de Deus<br>"
      + "52. "
      + "Este prefácio diz-se nos domingos do Tempo Comum.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
     ...
     + ((((
      ...
      + "dar-Vos graças, sempre e em toda a parte, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Pelo seu mistério pascal, <br>"
      + "Ele realizou a obra admirável <br>"
      + "de nos chamar do pecado e da morte <br>"
      + "à glória de geração escolhida, sacerdócio real, <br>"
      + "nação santa, povo resgatado, <br>"
      + "a fim de que, libertos do poder das trevas <br>"
    )
     + (
      "para a claridade da vossa luz, <br>"
      + "anunciemos por toda a parte as vossas maravilhas.<br>"
      + "Por isso, com os anjos e os arcanjos, <br>"
      + "os tronos e as dominações <br>"
      + "e todos os coros celestes,<br>"
      + "proclamamos a vossa glória, <br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO II DOMINICAL DO TEMPO COMUM<br>"
      + "O mistério da salvação<br>"
      + "53. "
      + "Este prefácio diz-se nos domingos do Tempo Comum.<br>"
    ))
     + ((
      ...
      + "dar-Vos graças, sempre e em toda a parte, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Compadecido dos errados caminhos dos homens, <br>"
      + "dignou-Se nascer da Virgem Maria; <br>"
    )
     + (
      "com a sua morte na cruz, <br>"
      + "livrou-nos da morte eterna; <br>"
      + "com a sua ressurreição, <br>"
      + "deu-nos a vida imortal.<br>"
      + "Por isso, com os anjos e os arcanjos, <br>"
      + "os tronos e as dominações <br>"
      + "e todos os coros celestes,<br>"
      + "proclamamos a vossa glória, <br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO III DOMINICAL DO TEMPO COMUM<br>"
      + "A salvação do homem por um homem<br>"
    )))
     + (((
      "54. "
      + "Este prefácio diz-se nos domingos do Tempo Comum.<br>"
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Para manifestar o esplendor da vossa glória, <br>"
    )
     + (
      "viestes em auxílio da fragilidade humana,<br>"
      + "com o poder da vossa divindade; <br>"
      + "da nossa condição mortal <br>"
      + "tirastes o remédio para vencer a morte <br>"
      + "e, da nossa ruína,<br>"
      + "abristes o caminho da salvação, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Por Ele, a multidão dos anjos<br>"
      + "adora a vossa majestade<br>"
      + "e exulta eternamente na vossa presença.<br>"
      + "Permiti que nos associemos às suas vozes,<br>"
      + "dizendo (cantando) com alegria:<br>"
     ...
     + ((
      "<br>"
      + "PREFÁCIO IV DOMINICAL DO TEMPO COMUM<br>"
     ...
     + (
      ...
      + "dar-Vos graças, sempre e em toda a parte, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Com o seu nascimento, Ele renovou a antiga condição humana;<br>"
      + "com a sua morte destruiu os nossos pecados; <br>"
      + "com a sua ressurreição conduziu-nos à vida eterna<br>"
      + "e, na sua ascensão, abriu-nos as portas do céu.<br>"
      + "Por isso, com os anjos e os santos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo,<br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO V DOMINICAL DO TEMPO COMUM<br>"
    )))))
     + (((((
      "A criação<br>"
      + "56. "
     ...
     + (
      "Vós criastes os elementos do mundo, <br>"
      + "estabelecendo o curso dos tempos e as estações do ano; <br>"
      + "formastes o homem à vossa imagem e semelhança <br>"
      + "e lhe confiastes as maravilhas do universo, <br>"
      + "para que, em vosso nome, domine sobre todas as criaturas <br>"
      + "e Vos glorifique sem cessar, pela grandeza das vossas obras,<br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Por Ele, com todos os anjos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) com alegria:<br>"
      + "Santo, Santo, Santo,<br>"
      + "Senhor Deus do universo.<br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO VI DOMINICAL DO TEMPO COMUM<br>"
    ))
     + ((
      "O penhor da Páscoa eterna<br>"
      + "57. "
      + "Este prefácio diz-se nos domingos do Tempo Comum. <br>"
      + "V. "
      + "O Senhor esteja convosco. "
     ...
     + (
      "Em Vós vivemos, nos movemos e existimos. <br>"
      + "Durante a nossa vida terrena, <br>"
      + "sentimos cada dia os efeitos da vossa bondade <br>"
      + "e possuímos desde já o penhor da vida futura; <br>"
      + "tendo recebido as primícias do Espírito, <br>"
      + "pelo qual ressuscitastes Jesus Cristo de entre os mortos, <br>"
      + "vivemos na esperança da Páscoa eterna. <br>"
      + "Por isso, com todos os anjos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) com alegria: <br>"
      + "Santo, Santo, Santo,<br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO VII DOMINICAL DO TEMPO COMUM<br>"
    )))
     + (((
      "A salvação pela obediência de Cristo<br>"
      + "58. "
      + "Este prefácio diz-se nos domingos do Tempo Comum.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
     ...
     + (
      "Na vossa infinita misericórdia, <br>"
      + "de tal modo amastes o mundo <br>"
      + "que nos enviastes o Redentor,<br>"
      + "em tudo semelhante a nós, menos no pecado, <br>"
      + "para poderdes amar em nós <br>"
      + "o que amáveis em vosso Filho: <br>"
      + "pela sua obediência, Ele restaurou os vossos dons,<br>"
      + "que por desobediência tínhamos perdido.<br>"
      + "Por isso, com os anjos e todos os santos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) com alegria:<br>"
      + "Santo, Santo, Santo,<br>"
     ...
     + ((
      "PREFÁCIO VIII DOMINICAL DO TEMPO COMUM<br>"
      + "A Igreja reunida na comunhão da Trindade<br>"
      + "59. "
      + "Este prefácio diz-se nos domingos do Tempo Comum.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
     ...
     + (
      "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Pelo sangue do vosso Filho e pela força do Espírito, <br>"
      + "quisestes reconduzir à unidade do vosso povo <br>"
      + "os filhos dispersos pelo pecado, <br>"
      + "para que a Igreja, <br>"
      + "reunida na comunhão da Trindade, <br>"
      + "apareça no mundo <br>"
      + "como corpo de Cristo <br>"
      + "e templo do Espírito Santo, <br>"
      + "para louvor da vossa infinita sabedoria.<br>"
      + "Por isso, com todos os coros dos anjos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) com alegria:<br>"
      + "Santo, Santo, Santo,<br>"
     ...
     + ((((
      "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO IX DOMINICAL DO TEMPO COMUM<br>"
      + "A ação do Espírito na Igreja<br>"
      + "59 a. "
      + "Este prefácio diz-se nos domingos do Tempo Comum.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
     ...
     + (
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Com admirável providência <br>"
      + "ordenais a evolução dos tempos <br>"
      + "e, com o poder do Espírito Santo, <br>"
      + "conduzis a vossa Igreja, <br>"
      + "para que, sempre fiel ao vosso amor, <br>"
      + "nunca deixe de invocar-Vos nas suas tribulações,<br>"
      + "nem de Vos dar graças nas suas alegrias,<br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Por Ele, com todos os coros dos anjos, <br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) com alegria:<br>"
      + "Santo, Santo, Santo,<br>"
      + "Senhor Deus do universo.<br>"
     ...
     + ((
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO X DOMINICAL DO TEMPO COMUM<br>"
      + "O dia do Senhor<br>"
      + "59 b. "
      + "Este prefácio diz-se nos domingos do Tempo Comum.<br>"
      + "V. "
     ...
     + (
      "É nosso dever, é nossa salvação.<br>"
      + "Senhor, Pai santo, fonte da verdade e da vida, <br>"
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "bendizer-Vos e dar-Vos graças, <br>"
      + "porque, neste dia de festa, <br>"
      + "nos congregastes na vossa casa.<br>"
      + "Hoje, a vossa família, <br>"
      + "reunida para escutar a palavra da salvação <br>"
      + "e participar no pão da vida, <br>"
      + "celebra o memorial do Senhor ressuscitado, <br>"
      + "na esperança do domingo que não tem ocaso, <br>"
      + "quando toda a humanidade entrar no vosso descanso. <br>"
      + "Então veremos o vosso rosto <br>"
      + "e louvaremos sem fim a vossa misericórdia.<br>"
      + "Nesta feliz esperança, <br>"
      + "com os anjos e os santos, <br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
    )))
     + (((
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO I DA SANTÍSSIMA EUCARISTIA<br>"
      + "O sacrifício e o sacramento de Cristo<br>"
      + "60. "
      + "Este prefácio diz-se na Missa da Ceia do Senhor; pode dizer-se também <br>"
      + "na solenidade do Santíssimo Corpo e Sangue de Cristo e nas Missas votivas da <br>"
     ...
     + (
      ...
      + "dar-Vos graças, sempre e em toda a parte,<br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Verdadeiro e eterno sacerdote,<br>"
      + "oferecendo-Se como vítima de salvação,<br>"
      + "instituiu o sacrifício da nova e eterna aliança<br>"
      + "e mandou que o celebrássemos em sua memória.<br>"
      + "O seu Corpo, por nós imolado,<br>"
      + "é alimento que nos fortalece<br>"
      + "e o seu Sangue, por nós derramado,<br>"
    ))
     + ((
      "é bebida que nos purifica.<br>"
      + "Por isso, com os anjos e os arcanjos, <br>"
      + "os tronos e as dominações <br>"
      + "e todos os coros celestes,<br>"
      + "proclamamos a vossa glória, <br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO II DA SANTÍSSIMA EUCARISTIA<br>"
      + "Os frutos da Santíssima Eucaristia<br>"
      + "61. "
      + "Este prefácio diz-se na solenidade do Santíssimo Corpo e Sangue de Cristo <br>"
      + "e nas Missas votivas da Santíssima Eucaristia.<br>"
    )
     + (
      "V. "
      + "O Senhor esteja convosco. "
      ...
      + "dar-Vos graças, sempre e em toda a parte, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Reunido com os apóstolos na Última Ceia,<br>"
      + "para perpetuar a sua paixão salvadora, <br>"
    ))))))))
     + ((((((((
      "entregou-Se a Si mesmo <br>"
      + "como cordeiro imaculado e sacrifício perfeito. <br>"
      + "Neste sagrado mistério, alimentais e santificais os fiéis, <br>"
      + "para que os homens do mundo inteiro <br>"
      + "sejam iluminados pela mesma fé <br>"
      + "e unidos pela mesma caridade. <br>"
      + "Assim nos reunimos à mesa deste admirável sacramento, <br>"
      + "para que a abundância da vossa graça <br>"
      + "nos faça participantes da vida celeste.<br>"
      + "Por isso, todas as criaturas, no céu e na terra,<br>"
      + "Vos adoram, cantando um cântico novo.<br>"
      + "E também nós, com todos os coros dos anjos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo.<br>"
      + "<br>"
      + "PREFÁCIO III DA SANTÍSSIMA EUCARISTIA<br>"
    )
     + (
      "A Eucaristia, viático para a Páscoa eterna<br>"
      + "61 a. "
      + "Este prefácio diz-se nas Missas rituais para o viático e pode dizer-se nas <br>"
      + "Missas votivas da Santíssima Eucaristia.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
      ...
      + "R. "
      + "É nosso dever, é nossa salvação.<br>"
      + "Senhor, Pai santo, Deus de misericórdia e de paz. <br>"
      + "É verdadeiramente nosso dever, é nossa salvação <br>"
    ))
     + ((
      "dar-Vos graças e bendizer o vosso nome.<br>"
      + "Vós quisestes que o vosso Filho, Jesus Cristo, <br>"
      + "obediente até à morte na cruz,<br>"
      + "nos abrisse o caminho para Vós, <br>"
      + "plenitude de toda a esperança humana. <br>"
      + "Na Eucaristia, testamento do seu amor, <br>"
      + "Ele faz-Se comida e bebida espiritual<br>"
      + "para a nossa viagem a caminho da Páscoa eterna.<br>"
      + "Com este penhor da ressurreição final,<br>"
      + "esperamos participar na mesa gloriosa do vosso reino <br>"
      + "e, com os anjos e os santos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) com alegria: <br>"
      + "Santo, Santo, Santo,<br>"
      + "Senhor Deus do universo.<br>"
     ...
     + (
      "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO I DA VIRGEM SANTA MARIA<br>"
      + "A Maternidade da Virgem santa Maria<br>"
      + "62. "
      + "Este prefácio diz-se nas Missas da Virgem santa Maria, especificando no <br>"
      + "lugar próprio o nome da celebração do dia, como se indica nas respetivas Missas.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
     ...
     + (((
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte, <br>"
      + "e louvar-Vos, bendizer-Vos e glorificar-Vos <br>"
      + "na memória (festa – solenidade) da Virgem santa Maria.<br>"
      + "Pelo poder do Espírito Santo,<br>"
      + "Ela concebeu o vosso Filho unigénito <br>"
      + "e, sem perder a glória da sua virgindade, <br>"
      + "deu ao mundo a luz eterna, nosso Senhor Jesus Cristo.<br>"
      + "Por Ele, os anjos louvam a vossa majestade, <br>"
      + "as dominações Vos adoram, <br>"
      + "as potestades Vos reverenciam; <br>"
      + "os céus, os espíritos celestes e os serafins Vos aclamam, <br>"
      + "unidos em eterna exultação.<br>"
      + "Permiti que nos associemos às suas vozes,<br>"
      + "proclamando (cantando) humildemente o vosso louvor:<br>"
      + "Santo, Santo, Santo.<br>"
     ...
     + (
      "<br>"
      + "PREFÁCIO II DA VIRGEM SANTA MARIA<br>"
      + "A Igreja louva a Deus com as palavras de Maria<br>"
      + "63. "
      + "Este prefácio diz-se nas Missas da Virgem santa Maria, especificando no <br>"
      + "lugar próprio o nome da celebração do dia, como se indica nas respetivas Missas.<br>"
      + "V. "
     ...
     + ((
      "Senhor, Pai santo, Deus eterno e omnipotente, <br>"
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "celebrar o vosso poder admirável na perfeição dos santos<br>"
      + "e exaltar a vossa bondade <br>"
      + "na memória (festa – solenidade) da Virgem santa Maria, <br>"
      + "inspirando-nos no seu cântico de louvor.<br>"
      + "Vós fizestes maravilhas a favor de todos os povos <br>"
      + "e manifestastes, de geração em geração, a vossa misericórdia,<br>"
      + "quando olhastes para a humildade da vossa serva <br>"
      + "e, por Ela, nos destes o Salvador do mundo, <br>"
      + "vosso Filho, nosso Senhor Jesus Cristo.<br>"
      + "Por Ele, a multidão dos anjos adora a vossa majestade<br>"
      + "e exulta eternamente na vossa presença.<br>"
      + "Permiti que nos associemos às suas vozes,<br>"
      + "dizendo (cantando) com alegria:<br>"
      + "Santo, Santo, Santo,<br>"
     ...
     + (
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO III DA VIRGEM SANTA MARIA<br>"
      + "Maria, sinal de consolação e de esperança<br>"
      + "63 a. "
      + "Este prefácio diz-se nas Missas da Virgem santa Maria.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
     ...
     + ((((
      ...
      + "Senhor, Pai santo, Deus eterno e omnipotente, <br>"
      + "é verdadeiramente nosso dever dar-Vos graças, <br>"
      + "é nossa salvação glorificar-Vos. <br>"
      + "Nós Vos louvamos e bendizemos, <br>"
      + "por Jesus Cristo, vosso Filho, <br>"
      + "na memória (festa) da Virgem santa Maria.<br>"
      + "Humilde serva, acolheu a vossa palavra <br>"
      + "e guardou-a no seu coração; <br>"
      + "admiravelmente unida ao mistério da redenção, <br>"
      + "perseverou com os apóstolos em oração, <br>"
      + "esperando a vinda do Espírito Santo; <br>"
      + "agora, resplandece no caminho da nossa vida,<br>"
      + "como sinal de consolação e de firme esperança.<br>"
      + "Por isso, com os anjos e os santos, <br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
    )
     + (
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO IV DA VIRGEM SANTA MARIA<br>"
      + "Maria, imagem da nova humanidade<br>"
      + "63 b. "
      + "Este prefácio diz-se nas Missas da Virgem santa Maria.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
     ...
     + ((
      ...
      + "R. "
      + "É nosso dever, é nossa salvação.<br>"
      + "Senhor, Pai santo, fonte de vida e de alegria, <br>"
      + "é verdadeiramente nosso dever dar-Vos graças <br>"
      + "na memória (festa – solenidade) da Virgem santa Maria.<br>"
      + "Vós revelastes, na plenitude dos tempos,<br>"
      + "o mistério escondido desde os tempos antigos, <br>"
      + "para que se renove, no mundo inteiro, a vida e a esperança. <br>"
      + "Em Cristo, novo Adão, <br>"
      + "e, em Maria, nova Eva,<br>"
      + "manifestastes finalmente a vossa Igreja, <br>"
      + "primícias da humanidade redimida. <br>"
      + "Por este dom admirável, <br>"
      + "toda a criação, pelo poder do Espírito Santo, <br>"
      + "volta de novo ao caminho original para a Páscoa eterna.<br>"
    )
     + (
      "Por isso, com os anjos e os santos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo.<br>"
      + "OUTROS PREFÁCIOS DA VIRGEM SANTA MARIA<br>"
      + "V. "
      + "Maria, imagem e mãe da Igreja: Santa Maria. "
      + "Mãe da Igreja, <br>"
      + "p. "
      ...
      + "836.<br>"
      + "<br>"
      + "PREFÁCIO DOS ANJOS<br>"
    )))
     + (((
      "A glória de Deus resplandece nos anjos<br>"
      + "63 c. "
      + "Este prefácio diz-se nas Missas dos Anjos.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
     ...
     + (
      "por nosso Senhor Jesus Cristo. <br>"
      + "Proclamamos a vossa imensa glória, <br>"
      + "que resplandece nos anjos e nos arcanjos, <br>"
      + "e, honrando estes mensageiros celestes, <br>"
      + "exaltamos a vossa infinita bondade, <br>"
      + "porque a veneração que eles merecem<br>"
      + "é sinal da vossa incomparável grandeza <br>"
      + "sobre todas as criaturas. <br>"
      + "Por isso, com a multidão dos anjos,<br>"
      + "que celebram a vossa divina majestade,<br>"
      + "nós Vos adoramos e bendizemos com alegria, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo,<br>"
      + "Senhor Deus do universo.<br>"
      + "O céu e a terra proclamam a vossa glória.<br>"
     ...
     + ((
      "<br>"
      + "PREFÁCIO DE SÃO JOSÉ<br>"
      + "ESPOSO DA VIRGEM SANTA MARIA<br>"
      + "A missão de são José<br>"
      + "63 c. "
      + "Este prefácio diz-se nas Missas de são José.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
     ...
     + (
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte, <br>"
      + "e exaltar, bendizer e proclamar a vossa bondade, <br>"
      + "na solenidade (festa – memória) do bem-aventurado são José.<br>"
      + "Homem justo, <br>"
      + "foi por Vós escolhido para Esposo da Virgem Mãe de Deus; <br>"
      + "servo fiel e prudente, foi constituído chefe da vossa família, <br>"
      + "para guardar com paterna solicitude o vosso Filho unigénito, <br>"
      + "concebido pelo poder do Espírito Santo, <br>"
      + "nosso Senhor Jesus Cristo.<br>"
      + "Por Ele, os anjos louvam a vossa majestade, <br>"
      + "as dominações Vos adoram, as potestades Vos reverenciam; <br>"
      + "os céus, os espíritos celestes e os serafins Vos aclamam, <br>"
      + "unidos em eterna exultação.<br>"
      + "Permiti que nos associemos às suas vozes,<br>"
      + "proclamando (cantando) humildemente o vosso louvor:<br>"
     ...
     + (((((
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO I DOS APÓSTOLOS<br>"
      + "Os apóstolos, pastores do povo de Deus<br>"
      + "64. "
      + "Este prefácio diz-se nas Missas dos Apóstolos, especialmente de são Pedro <br>"
      + "e são Paulo.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
     ...
     + (
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Porque Vós, Pastor eterno, <br>"
      + "não abandonais o vosso rebanho, <br>"
      + "mas sempre o guardais e protegeis, <br>"
      + "por meio dos santos apóstolos, <br>"
      + "para que seja conduzido, através dos tempos, <br>"
      + "pelos mesmos chefes que pusestes à sua frente, <br>"
      + "como representantes do vosso Filho, Jesus Cristo.<br>"
      + "Por Ele, com os anjos e os arcanjos, <br>"
      + "os tronos e as dominações <br>"
    ))
     + ((
      "e todos os coros celestes,<br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO II DOS APÓSTOLOS<br>"
      + "O fundamento apostólico e o testemunho<br>"
      + "65. "
      + "Este prefácio diz-se nas Missas dos Apóstolos e dos Evangelistas.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
     ...
     + (
      ...
      + "dar-Vos graças, sempre e em toda a parte, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Vós fundastes a Igreja <br>"
      + "sobre o alicerce dos apóstolos, <br>"
      + "para que seja, na terra, através dos tempos, <br>"
      + "o sinal vivo da vossa santidade <br>"
      + "e anuncie a todos os povos <br>"
      + "o Evangelho do reino dos céus.<br>"
    )))
     + (((
      "Por isso, agora e para sempre, <br>"
      + "com todos os coros dos anjos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo,<br>"
      + "Senhor Deus do universo.<br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO I DOS SANTOS<br>"
      + "A glória dos santos<br>"
      + "66. "
      + "Este prefácio diz-se nas Missas de Todos os Santos, dos santos padroeiros <br>"
      + "e titulares das igrejas e nas solenidades e festas dos santos que não têm prefácio <br>"
      + "próprio. "
      + "Pode dizer-se também nas memórias dos santos.<br>"
    )
     + (
      "V. "
      + "O Senhor esteja convosco. "
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Vós sois glorificado na assembleia dos santos <br>"
      + "e, ao coroar os seus méritos, <br>"
      + "coroais os vossos próprios dons. <br>"
    ))
     + ((
      "Na sua vida, dais-nos um exemplo; <br>"
      + "na comunhão com eles uma família <br>"
      + "e, na sua intercessão um auxílio, <br>"
      + "para que, confirmados por tão grandes testemunhas, <br>"
      + "possamos vencer o bom combate da fé <br>"
      + "e receber, com eles, a eterna coroa de glória, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Por Ele, com os anjos, <br>"
      + "os arcanjos e todos os santos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo,<br>"
      + "Senhor Deus do universo.<br>"
     ...
     + (
      "PREFÁCIO II DOS SANTOS<br>"
      + "A ação dos santos<br>"
      + "67. "
      + "Este prefácio diz-se nas Missas de Todos os Santos, dos santos padroeiros e <br>"
      + "titulares das igrejas, bem como nas solenidades e festas dos santos que não têm <br>"
      + "prefácio próprio. "
      + "Pode dizer-se também nas memórias dos santos.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
     ...
     + ((((
      ...
      + "dar-Vos graças, sempre e em toda a parte, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Pelo testemunho admirável dos santos, <br>"
      + "aumentais e fortaleceis sempre a vossa Igreja <br>"
      + "e nos dais provas evidentes do vosso amor. <br>"
      + "O exemplo dos santos nos estimula <br>"
      + "e a sua intercessão nos ajuda <br>"
      + "a celebrar os mistérios da salvação.<br>"
      + "Por isso, com os anjos e todos os santos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) com alegria:<br>"
      + "Santo, Santo, Santo,<br>"
     ...
     + (
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO I DOS SANTOS MÁRTIRES<br>"
      + "O sinal e o exemplo do martírio<br>"
      + "68. "
      + "Este prefácio diz-se nas solenidades e festas dos santos mártires. "
      + "Pode dizer-se <br>"
      + "também nas suas memórias.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
     ...
     + ((
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "À imitação de Cristo, vosso Filho, <br>"
      + "o sangue do(a) glorioso(a) mártir são (santo/a) N., <br>"
      + "derramado pela confissão do vosso nome, <br>"
      + "manifesta as maravilhas do vosso poder. <br>"
      + "No seu martírio, Senhor, <br>"
      + "tirais força da fraqueza <br>"
      + "e fazeis da fragilidade humana<br>"
      + "o testemunho da vossa grandeza, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Por Ele, com os coros celestes,<br>"
      + "proclamamos, na terra, a vossa glória, <br>"
      + "dizendo (cantando) numa só voz.<br>"
    )
     + (
      "Santo, Santo, Santo,<br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO II DOS SANTOS MÁRTIRES<br>"
      + "As maravilhas de Deus na vitória dos mártires<br>"
      + "69. "
      + "Este prefácio diz-se nas solenidades e festas dos santos mártires. "
      + "Pode dizer-se <br>"
      + "também nas suas memórias.<br>"
     ...
     + (((
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte. <br>"
      + "Vós sois glorificado no louvor dos vossos santos<br>"
      + "e tudo o que veneramos no seu glorioso martírio <br>"
      + "é obra do vosso poder admirável:<br>"
      + "de Vós procede o ardor da sua fé,<br>"
      + "a firmeza da sua perseverança<br>"
      + "e o triunfo no seu combate,<br>"
      + "por nosso Senhor Jesus Cristo. <br>"
      + "Por Ele, todas as criaturas, no céu e na terra,<br>"
    )
     + (
      "Vos adoram, cantando um cântico novo.<br>"
      + "E também nós, com todos os coros dos anjos,<br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO DOS SANTOS PASTORES DA IGREJA<br>"
      + "A presença dos santos pastores na Igreja<br>"
      + "70. "
      + "Este prefácio diz-se nas solenidades e festas dos santos pastores da Igreja. <br>"
      + "Pode dizer-se também nas suas memórias.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
    ))
     + ((
      ...
      + "dar-Vos graças, sempre e em toda a parte, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Ao celebrar hoje a memória ( festa) de são N., <br>"
      + "a vossa Igreja exulta de alegria, <br>"
      + "porque a fortaleceis com o exemplo da sua vida,<br>"
      + "a instruís com a sua palavra<br>"
    )
     + (
      "e a protegeis com a sua intercessão.<br>"
      + "Por isso, com os anjos e os santos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo,<br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO DAS SANTAS VIRGENS<br>"
      + "E DOS SANTOS RELIGIOSOS<br>"
      + "O sinal da vida consagrada a Deus<br>"
      + "71. "
      + "Este prefácio diz-se nas solenidades e festas das santas virgens e dos santos <br>"
      + "religiosos. "
      + "Pode dizer-se também nas suas memórias.<br>"
    ))))))
     + ((((((
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Ao recordar os santos <br>"
      + "que, por amor do reino dos céus, <br>"
    )
     + (
      "se consagraram a Cristo, vosso Filho, <br>"
      + "celebramos a vossa admirável providência. <br>"
      + "Neles restituís ao homem a santidade original <br>"
      + "e nos fazeis saborear, na terra, <br>"
      + "os dons que reservastes para a vida futura.<br>"
      + "Por isso, com os anjos e os santos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo,<br>"
      ...
      + "<br>"
      + "PREFÁCIO COMUM I<br>"
      + "A instauração do universo em Cristo<br>"
      + "72. "
    ))
     + ((
      "Este prefácio diz-se nas Missas que não têm prefácio próprio, nem exigem <br>"
      + "o prefácio do Tempo.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
      + "Ele está no meio de nós.<br>"
     ...
     + (
      "N’Ele quisestes instaurar todas as coisas <br>"
      + "e a todos destes a graça de participar da sua plenitude. <br>"
      + "Sendo Ele de condição divina, <br>"
      + "aniquilou-Se a Si próprio <br>"
      + "e, pelo sangue derramado na cruz, <br>"
      + "deu a paz a todo o universo. <br>"
      + "Por isso foi exaltado sobre todas as criaturas <br>"
      + "e tornou-Se, para todos os que Lhe obedecem, <br>"
      + "fonte de salvação eterna.<br>"
      + "Por Ele, com os anjos e os arcanjos, <br>"
      + "os tronos e as dominações <br>"
      + "e todos os coros celestes,<br>"
      + "proclamamos a vossa glória, <br>"
     ...
     + (((
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO COMUM II<br>"
      + "A salvação por Cristo<br>"
      + "73. "
      + "Este prefácio diz-se nas Missas que não têm prefácio próprio, nem exigem <br>"
      + "o prefácio do Tempo.<br>"
      + "V. "
     ...
     + (
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Por amor criastes o homem<br>"
      + "e, embora justamente condenado, <br>"
      + "em vossa misericórdia, o salvastes, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Por Ele, os anjos louvam a vossa majestade, <br>"
      + "as dominações Vos adoram, <br>"
      + "as potestades Vos reverenciam; <br>"
     ...
     + ((
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO COMUM III<br>"
      + "Louvor a Deus pela criação e renovação do homem<br>"
      + "74. "
      + "Este prefácio diz-se nas Missas que não têm prefácio próprio, nem exigem <br>"
      + "o prefácio do Tempo.<br>"
      + "V. "
     ...
     + (
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Pelo vosso Filho muito amado, <br>"
      + "criastes o género humano<br>"
      + "e por vossa bondade o renovastes.<br>"
      + "Por isso, Vos servem todas as criaturas,<br>"
      + "Vos louvam todos os redimidos<br>"
      + "e Vos aclamam os anjos e todos os santos.<br>"
      + "Com eles, também nós proclamamos a vossa glória,<br>"
      + "dizendo (cantando) com alegria:<br>"
      + "Santo, Santo, Santo,<br>"
      + "Senhor Deus do universo.<br>"
    ))))
     + ((((
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO COMUM IV<br>"
      + "O louvor é um dom de Deus<br>"
      + "75. "
      + "Este prefácio diz-se nas Missas que não têm prefácio próprio, nem exigem <br>"
      + "o prefácio do Tempo.<br>"
      + "V. "
     ...
     + (
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Vós não precisais dos nossos louvores <br>"
      + "e poder glorificar-Vos é dom da vossa bondade; <br>"
      + "porque os nossos hinos de bênção, <br>"
      + "nada aumentando à vossa infinita grandeza, <br>"
      + "alcançam-nos a graça da salvação,<br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Por Ele, com todos os coros dos anjos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) com alegria:<br>"
     ...
     + ((
      ...
      + "<br>"
      + "PREFÁCIO COMUM V<br>"
      + "Proclamação do mistério de Cristo<br>"
      + "76. "
      + "Este prefácio diz-se nas Missas que não têm prefácio próprio, nem exigem <br>"
      + "o prefácio do Tempo.<br>"
      + "V. "
     ...
     + (
      ...
      + "dar-Vos graças, sempre e em toda a parte,<br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Unidos na caridade, <br>"
      + "celebramos a sua morte;<br>"
      + "com fé viva,<br>"
      + "proclamamos a sua ressurreição;<br>"
      + "com ardente esperança,<br>"
      + "aguardamos a sua vinda gloriosa.<br>"
      + "Por isso, com os anjos e os santos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo,<br>"
     ...
     + (((
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO COMUM VI<br>"
      + "O mistério da salvação em Cristo<br>"
      + "77. "
      + "Este prefácio diz-se nas Missas que não têm prefácio próprio, nem exigem <br>"
      + "o prefácio do Tempo.<br>"
      + "V. "
     ...
     + (
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte<br>"
      + "por Jesus Cristo, vosso amado Filho. <br>"
      + "Ele é a vossa palavra, por quem tudo criastes.<br>"
      + "Enviado por Vós, como Salvador e Redentor,<br>"
      + "fez-Se homem pelo poder do Espírito Santo <br>"
      + "e nasceu da Virgem Maria.<br>"
      + "Para cumprir a vossa vontade <br>"
      + "e adquirir para Vós um povo santo,<br>"
      + "estendeu os braços e morreu na cruz;<br>"
      + "e, destruindo assim a morte,<br>"
      + "manifestou a vitória da ressurreição.<br>"
    ))
     + ((
      "Por isso, com os anjos e todos os santos,<br>"
      + "proclamamos a vossa glória, <br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO COMUM VII<br>"
      + "Cristo, hóspede e peregrino no meio de nós<br>"
      + "77 a. "
      + "Este prefácio diz-se nas Missas que não têm prefácio próprio, nem exigem <br>"
      + "o prefácio do Tempo.<br>"
      + "V. "
     ...
     + (
      ...
      + "R. "
      + "É nosso dever, é nossa salvação.<br>"
      + "Senhor, Pai santo, Deus da aliança e da paz, <br>"
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "Vós chamastes e fizestes sair Abraão da sua terra <br>"
      + "para o constituir pai de todas as nações. <br>"
      + "Suscitastes Moisés para libertar o vosso povo <br>"
      + "e conduzi-lo à terra prometida. <br>"
      + "Na plenitude dos tempos, enviastes o vosso Filho, <br>"
      + "hóspede e peregrino no meio de nós, <br>"
    )))))
     + (((((
      "para nos redimir do pecado e da morte, <br>"
      + "e destes ao mundo o vosso Espírito, <br>"
      + "para fazer de todas as nações um só povo,<br>"
      + "que caminha para o vosso reino <br>"
      + "na liberdade dos filhos de Deus, <br>"
      + "segundo o mandamento novo do amor.<br>"
      + "Por isso, com os anjos e os santos, <br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo,<br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO COMUM VIII<br>"
      + "Cristo, o bom samaritano<br>"
    )
     + (
      "77 b. "
      + "Este prefácio diz-se nas Missas que não têm prefácio próprio, nem exigem <br>"
      ...
      + "Senhor, Pai santo, Deus eterno e omnipotente,<br>"
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "louvar-Vos e dar-Vos graças, <br>"
    ))
     + ((
      "em todos os momentos da nossa vida, <br>"
      + "na saúde e na doença, no sofrimento e na alegria, <br>"
      + "por Cristo, vosso servo e nosso Redentor.<br>"
      + "Na sua vida mortal, Ele passou fazendo o bem <br>"
      + "e socorrendo todos os que eram prisioneiros do mal.<br>"
      + "Ainda hoje, como bom samaritano, <br>"
      + "vem ao encontro de todos os homens, <br>"
      + "atribulados no corpo ou no espírito, <br>"
      + "e derrama sobre as suas feridas <br>"
      + "o óleo da consolação e o vinho da esperança. <br>"
      + "Por este dom da vossa graça, <br>"
      + "também a noite da dor se abre à luz pascal<br>"
      + "do vosso Filho crucificado e ressuscitado.<br>"
      + "Por isso, com os anjos e os santos, <br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo,<br>"
     ...
     + (
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO COMUM IX<br>"
      + "A glória de Deus é o homem vivo<br>"
      + "77 c. "
      + "Este prefácio diz-se nas Missas que não têm prefácio próprio, nem exigem <br>"
      + "o prefácio do Tempo.<br>"
      + "V. "
     ...
     + (((
      ...
      + "louvar-Vos e dar-Vos graças, <br>"
      + "sempre e em toda a parte.<br>"
      + "Vós sois o único Deus vivo e verdadeiro <br>"
      + "e estais presente em todo o universo;<br>"
      + "mas foi sobretudo no homem, <br>"
      + "criado à vossa imagem, <br>"
      + "que imprimistes o sinal da vossa glória. <br>"
      + "Vós o chamais a colaborar, <br>"
      + "com o trabalho de cada dia, <br>"
      + "no projeto da criação,<br>"
      + "e lhe dais o vosso Espírito, <br>"
      + "para que, em Cristo, homem novo, <br>"
    )
     + (
      "se torne construtor da justiça e da paz.<br>"
      + "Por isso, com os anjos e os santos, <br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) com alegria:<br>"
      + "Santo, Santo, Santo,<br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO I DOS DEFUNTOS<br>"
      + "A esperança da ressurreição em Cristo<br>"
      + "78. "
      + "Este prefácio diz-se nas Missas de defuntos.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
    ))
     + ((
      ...
      + "dar-Vos graças, sempre e em toda a parte, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "N’Ele brilhou para nós a esperança da feliz ressurreição<br>"
      + "e, se a certeza da morte nos entristece,<br>"
      + "conforta-nos a promessa da imortalidade.<br>"
      + "Para os que creem em Vós, Senhor,<br>"
      + "a vida não acaba, apenas se transforma<br>"
    )
     + (
      "e, desfeita a morada deste exílio terrestre, <br>"
      + "adquirimos no céu uma habitação eterna.<br>"
      + "Por isso, com os anjos e os arcanjos, <br>"
      + "os tronos e as dominações <br>"
      + "e todos os coros celestes,<br>"
      + "proclamamos a vossa glória, <br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO II DOS DEFUNTOS<br>"
      + "Cristo morreu pela nossa vida<br>"
      + "79. "
      + "Este prefácio diz-se nas Missas de defuntos.<br>"
    ))))
     + ((((
      ...
      + "dar-Vos graças, sempre e em toda a parte, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Tomando sobre Si a nossa morte, <br>"
      + "Ele livrou-nos da morte eterna; <br>"
    )
     + (
      "oferecendo por nós a sua vida, <br>"
      + "abriu-nos as portas da vida imortal.<br>"
      + "Por isso, com todos os coros dos anjos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) com alegria:<br>"
      + "Santo, Santo, Santo,<br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO III DOS DEFUNTOS<br>"
      + "Cristo, salvação e vida<br>"
      + "80. "
      + "Este prefácio diz-se nas Missas de defuntos.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
     ...
     + ((
      ...
      + "dar-Vos graças, sempre e em toda a parte, <br>"
      + "por nosso Senhor Jesus Cristo.<br>"
      + "Ele é a salvação do mundo, <br>"
      + "a vida dos homens <br>"
      + "e a ressurreição dos mortos.<br>"
      + "Por Ele, a multidão dos anjos<br>"
    )
     + (
      "adora a vossa majestade<br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO IV DOS DEFUNTOS<br>"
      + "Da vida terrena à glória celeste<br>"
      + "81. "
      + "Este prefácio diz-se nas Missas de defuntos.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
     ...
     + (((
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "A vossa vontade nos chama à vida<br>"
      + "e a vossa providência nos governa.<br>"
      + "Se, por vossa ordem, devido ao pecado, <br>"
      + "voltamos à terra de onde fomos tirados, <br>"
      + "pela morte redentora do vosso Filho,<br>"
      + "o vosso poder nos desperta,<br>"
    )
     + (
      "para tomar parte na ressurreição gloriosa.<br>"
      + "Por isso, com os anjos e os santos,<br>"
      + "proclamamos a vossa glória, <br>"
      + "dizendo (cantando) numa só voz:<br>"
      + "Santo, Santo, Santo,<br>"
      ...
      + "Hossana nas alturas.<br>"
      + "<br>"
      + "PREFÁCIO V DOS DEFUNTOS<br>"
      + "A nossa ressurreição pela vitória de Cristo<br>"
      + "82. "
      + "Este prefácio diz-se nas Missas de defuntos.<br>"
      + "V. "
      + "O Senhor esteja convosco. "
     ...
     + ((
      ...
      + "é verdadeiramente nosso dever, é nossa salvação <br>"
      + "dar-Vos graças, sempre e em toda a parte.<br>"
      + "A morte é a nossa herança comum,<br>"
      + "mas, pelo dom maravilhoso da vossa bondade, <br>"
      + "Cristo, com a sua vitória, nos redime da morte <br>"
      + "e nos chama a tomar parte na sua vida gloriosa.<br>"
      + "Por isso, com os coros celestes,<br>"
      + "proclamamos, na terra, a vossa glória, <br>"
    )
     + (
      "dizendo (cantando) numa só voz:<br>"
      ...
      + "Na Oração eucarística I, ou Cânone romano, podem omitir-se as partes que <br>"
      + "aparecem entre parêntesis.<br>"
      + "Celebrante principal:<br>"
      + "84. "
      + "O sacerdote, de braços abertos, diz:<br>"
      + "Pai de infinita misericórdia,<br>"
      + "humildemente Vos suplicamos, <br>"
      + "por Jesus Cristo, vosso Filho, nosso Senhor.<br>"
    )))))))
     + (((((((
      "Junta as mãos e diz:<br>"
      + "que Vos digneis aceitar<br>"
      + "Traça o sinal da cruz, uma só vez, simultaneamente sobre o pão e o cálice, dizendo:<br>"
      + "e abençoar + estes dons, <br>"
      + "esta oblação pura e santa.<br>"
      + "De braços abertos continua:<br>"
      + "Nós Vo-la oferecemos pela vossa Igreja santa e católica: <br>"
      + "dai-lhe a paz e congregai-a na unidade, <br>"
      + "defendei-a e governai-a em toda a terra,<br>"
      + "em comunhão com o vosso servo, o nosso papa N., <br>"
      + "o nosso bispo N.<br>"
      + "O bispo, quando celebra na sua diocese, diz:<br>"
      + "e comigo, vosso indigno servo,<br>"
      + "O bispo, quando celebra fora da sua diocese, diz:<br>"
      + "e com o meu irmão N. (os meus irmãos), bispo(s) desta Igreja,<br>"
      + "e comigo, vosso indigno servo,<br>"
      + "Pode fazer-se menção do bispo coadjutor ou dos bispos auxiliares:<br>"
    )
     + (
      "o nosso bispo coadjutor (ou auxiliar) N. <br>"
      + "Ou: os nossos bispos auxiliares,<br>"
      + "e todos os bispos que são fiéis à verdade <br>"
      + "e professam a fé católica e apostólica.<br>"
      + "<br>"
      + "85. "
      + "COMEMORAÇÃO DOS VIVOS<br>"
      + "Celebrante principal ou concelebrante [1]:<br>"
      + "Lembrai-Vos, Senhor,<br>"
      + "dos vossos servos e servas N. e N.<br>"
      + "Junta as mãos e ora alguns momentos por aqueles que quer recordar.<br>"
      + "Depois, de braços abertos, continua:<br>"
      + "e de todos os que estão aqui presentes, <br>"
      + "cuja fé e dedicação ao vosso serviço bem conheceis.<br>"
      + "Por eles nós Vos oferecemos<br>"
      + "e também eles Vos oferecem este sacrifício de louvor,<br>"
      + "por si e por todos os seus,<br>"
      + "pela redenção das suas almas,<br>"
    ))
     + ((
      "para a salvação e segurança que esperam,<br>"
      + "ó Deus eterno, vivo e verdadeiro.<br>"
      + "86. "
      + "COMEMORAÇÃO DOS SANTOS<br>"
      + "Celebrante principal ou concelebrante [2]:<br>"
      + "Em comunhão com toda a Igreja,<br>"
      + "Domingos:<br>"
      + "ao celebrarmos o primeiro dia da semana, em que nosso Senhor <br>"
      + "Jesus Cristo ressuscitou dos mortos, <br>"
      + "Natal do Senhor e sua oitava:<br>"
      + "ao celebrarmos o dia santíssimo (a noite santíssima), em que a <br>"
      + "Imaculada Virgem Maria deu à luz o Salvador do mundo, <br>"
      + "Epifania do Senhor:<br>"
      + "ao celebrarmos o dia santíssimo em que o vosso Filho unigénito, <br>"
      + "eterno convosco na glória, Se manifestou visivelmente na realidade da nossa carne,<br>"
      + "<br>"
      + "Quinta-Feira Santa:<br>"
      + "ao celebrarmos o dia santíssimo em que nosso Senhor Jesus Cristo <br>"
    )
     + (
      "Se entregou por nós, <br>"
      + "Vigília Pascal até ao Domingo II da Páscoa:<br>"
      + "ao celebrarmos o dia santíssimo (a noite santíssima) da ressur -<br>"
      + "reição de nosso Senhor Jesus Cristo segundo a carne, <br>"
      + "Ascensão do Senhor:<br>"
      + "ao celebrarmos o dia santíssimo em que nosso Senhor Jesus <br>"
      + "Cristo, vosso Filho unigénito, colocou à direita da vossa glória a <br>"
      + "nossa frágil natureza humana unida à sua divindade, <br>"
      + "Pentecostes:<br>"
      + "ao celebrarmos o dia santíssimo de Pentecostes, em que o Espírito <br>"
      + "Santo Se manifestou aos Apóstolos em numerosas línguas de fogo, <br>"
      + "veneramos a memória da gloriosa sempre Virgem Maria,<br>"
      + "Mãe do nosso Deus e Senhor, Jesus Cristo, <br>"
      + "e também a de são José, seu esposo,<br>"
      + "e a dos bem-aventurados apóstolos e mártires:<br>"
      + "Pedro e Paulo, André, <br>"
      + " (Tiago, João, <br>"
      + " Tomé, Tiago, Filipe,<br>"
    )))
     + (((
      " Bartolomeu, Mateus, <br>"
      + " Simão e Tadeu;<br>"
      + " Lino, Cleto, Clemente, Sixto, <br>"
      + " Cornélio, Cipriano, <br>"
      + " Lourenço, Crisógono, <br>"
      + " João e Paulo, <br>"
      + " Cosme e Damião)<br>"
      + "e de todos os santos.<br>"
      + "Por seus méritos e orações, <br>"
      + "concedei-nos, em tudo e sempre, <br>"
      + "auxílio e proteção. <br>"
      + "(Por Cristo nosso Senhor. "
      + "Amen.)<br>"
      + "<br>"
      + "87. "
      + "De braços abertos, continua:<br>"
      + "Celebrante principal:<br>"
      + "Aceitai benignamente, Senhor,<br>"
    )
     + (
      "a oblação que nós, vossos servos, <br>"
      + "com toda a vossa família, Vos apresentamos. <br>"
      + "Dai a paz aos nossos dias, <br>"
      + "livrai-nos da condenação eterna <br>"
      + "e contai-nos entre os vossos eleitos. <br>"
      + "Junta as mãos.<br>"
      + "(Por Cristo nosso Senhor. "
      + "Amen.)<br>"
      + "Vigília Pascal até ao Domingo II da Páscoa:<br>"
      + "Aceitai benignamente, Senhor, a oblação que nós, vossos servos, <br>"
      + "com toda a vossa família, V os apresentamos. "
      + "Nós V o-la oferecemos <br>"
      + "também por aqueles que fizestes renascer da água e do Espírito <br>"
      + "Santo, concedendo-lhes o perdão de todos os pecados. "
      + "Dai a paz <br>"
      + "aos nossos dias, livrai-nos da condenação eterna e contai-nos <br>"
      + "entre os vossos eleitos. "
      + "(Por Cristo nosso Senhor. "
    ))
     + ((
      "Amen.)<br>"
      + "88. "
      + "Estendendo as mãos sobre as oblatas, diz:<br>"
      + "Celebrante principal e concelebrantes:<br>"
      + "Santificai, Senhor, esta oblação<br>"
      + "com o poder da vossa bênção <br>"
      + "e recebei-a como sacrifício espiritual perfeito,<br>"
      + "de modo que se converta para nós<br>"
      + "no Corpo e Sangue de vosso amado Filho,<br>"
      + "nosso Senhor Jesus Cristo.<br>"
      + "Junta as mãos.<br>"
      + "89. "
      + "Nas fórmulas que se seguem, as palavras do Senhor devem pronunciar-se <br>"
      + "clara e distintamente, como o requer a natureza das mesmas palavras.<br>"
      + "<br>"
      + "Na véspera da sua paixão,<br>"
      + "Toma o pão e, sustentando-o um pouco elevado sobre o altar, continua:<br>"
      + "Ele tomou o pão em suas santas e adoráveis mãos <br>"
    )
     + (
      "Eleva os olhos.<br>"
      + "e, levantando os olhos ao céu <br>"
      + "para Vós, Deus, seu Pai todo-poderoso, <br>"
      + "dando graças Vos bendisse, <br>"
      + "partiu-o e deu-o aos seus discípulos, dizendo: <br>"
      + "Inclina-se um pouco.<br>"
      + "Tomai, todos, e comei:<br>"
      + "isto é o meu corpo,<br>"
      + "que será entregue por vós.<br>"
      + "Mostra ao povo a hóstia consagrada, coloca-a sobre a patena e genuflete em <br>"
      + "adoração.<br>"
      + "90. "
      + "Depois, continua:<br>"
      + "De igual modo, no fim da Ceia, <br>"
      + "Toma o cálice e, sustentando-o um pouco elevado sobre o altar, continua:<br>"
      + "tomou este sagrado cálice<br>"
      + "em suas santas e adoráveis mãos,<br>"
      + "dando graças Vos bendisse,<br>"
    ))))
     + ((((
      "e deu-o aos seus discípulos, dizendo:<br>"
      + "Inclina-se um pouco.<br>"
      + "Tomai, todos, e bebei:<br>"
      + "este é o cálice do meu sangue,<br>"
      + "o sangue da nova e eterna aliança,<br>"
      + "que será derramado por vós e por todos<br>"
      + "para remissão dos pecados.<br>"
      + "Fazei isto em memória de mim.<br>"
      + "Mostra ao povo o cálice, coloca-o sobre o corporal e genuflete em adoração.<br>"
      + "<br>"
      + "Celebrante principal:<br>"
      + "91. "
      + "Em seguida, diz:<br>"
      + "Mistério da fé!"
      + "<br>"
      + "O povo aclama, dizendo:<br>"
      + "Anunciamos, Senhor, a vossa morte, <br>"
      + "proclamamos a vossa ressurreição. <br>"
    )
     + (
      "Vinde, Senhor Jesus!"
      + "<br>"
      ...
      + "<br>"
      + "O povo aclama, dizendo:<br>"
      + "Quando comemos deste pão <br>"
      + "e bebemos deste cálice, <br>"
      + "anunciamos, Senhor, a vossa morte, <br>"
      + "esperando a vossa vinda gloriosa.<br>"
      + "Ou: Mistério da fé para a salvação do mundo! "
      + "<br>"
      + "O povo aclama, dizendo:<br>"
      + "Glória a V ós, que morrestes na cruz <br>"
      + "e agora viveis para sempre.<br>"
      + "Salvador do mundo, salvai-nos. <br>"
      + "Vinde, Senhor Jesus!"
      + "<br>"
      + "Celebrante principal e concelebrantes:<br>"
    ))
     + ((
      "92. "
      + "Em seguida, o sacerdote, de braços abertos, diz:<br>"
      + "Celebrando agora, Senhor, o memorial<br>"
      + "da bem-aventurada paixão de Jesus Cristo, <br>"
      + "vosso Filho, nosso Senhor, <br>"
      + "da sua ressurreição de entre os mortos <br>"
      + "e da sua gloriosa ascensão aos céus, <br>"
      + "nós, vossos servos, com o vosso povo santo, <br>"
      + "dos próprios bens que nos destes<br>"
      + "oferecemos à vossa divina majestade <br>"
      + "o sacrifício perfeito, santo e imaculado,<br>"
      + "o pão santo da vida eterna <br>"
      + "e o cálice da eterna salvação.<br>"
      + "<br>"
      + "93. "
      + "De braços abertos, continua: <br>"
      + "Olhai com benevolência e agrado para esta oferenda<br>"
      + "e dignai-Vos aceitá-la, <br>"
    )
     + (
      "como aceitastes os dons do justo Abel, vosso servo, <br>"
      + "o sacrifício de Abraão, nosso pai na fé, <br>"
      + "e a oblação pura e santa do sumo sacerdote Melquisedec.<br>"
      + "94. "
      + "Inclinado e de mãos juntas, continua:<br>"
      + "Humildemente Vos suplicamos, Deus todo-poderoso, <br>"
      + "que esta nossa oferenda <br>"
      + "seja apresentada pelo vosso santo anjo no altar celeste, <br>"
      + "diante da vossa divina majestade, <br>"
      + "para que todos nós, participando deste altar,<br>"
      + "pela comunhão do santíssimo Corpo e Sangue do vosso Filho, <br>"
      + "Ergue-se e, benzendo-se, continua:<br>"
      + "alcancemos a plenitude das bênçãos e graças do céu. <br>"
      + "Junta as mãos.<br>"
      + "(Por Cristo nosso Senhor. "
      + "Amen.)<br>"
      + "95. "
      + "COMEMORAÇÃO DOS DEFUNTOS<br>"
    )))
     + (((
      "Celebrante principal ou concelebrante [3]:<br>"
      + "De braços abertos diz:<br>"
      + "Lembrai-vos, Senhor, dos vossos servos e servas N. e N.,<br>"
      + "que partiram antes de nós, marcados com o sinal da fé,<br>"
      + "e agora dormem o sono da paz. <br>"
      + "Junta as mãos e ora uns momentos pelos defuntos que quer recordar.<br>"
      + "Depois, de braços abertos, continua:<br>"
      + "Concedei-lhes, Senhor,<br>"
      + "a eles e a todos os que descansam em Cristo,<br>"
      + "o lugar da consolação, da luz e da paz.<br>"
      + "Junta as mãos.<br>"
      + "(Por Cristo nosso Senhor. "
      + "Amen.)<br>"
      + "<br>"
      + "Celebrante principal ou concelebrante [4]:<br>"
      + "96. "
      + "Bate com a mão direita no peito, dizendo:<br>"
      + "E a nós, pecadores, vossos servos,<br>"
    )
     + (
      "que esperamos na vossa infinita misericórdia, <br>"
      + "De braços abertos continua:<br>"
      + "admiti-nos também na assembleia <br>"
      + "dos bem-aventurados apóstolos e mártires: <br>"
      + "João Batista, Estêvão, <br>"
      + "Matias, Barnabé <br>"
      + " (Inácio, Alexandre, Marcelino, Pedro, <br>"
      + " Felicidade, Perpétua, Águeda, Luzia, <br>"
      + " Inês, Cecília, Anastácia)<br>"
      + "e de todos os santos. <br>"
      + "Recebei-nos em sua companhia, <br>"
      + "não pelo valor dos nossos méritos,<br>"
      + "mas segundo a grandeza do vosso perdão.<br>"
      + "Junta as mãos.<br>"
      + "(Por Cristo nosso Senhor. "
      + "Amen.)<br>"
      + "Celebrante principal:<br>"
     ...
     + ((
      "E continua: <br>"
      + "Por nosso Senhor Jesus Cristo,<br>"
      + "criais todos os bens e lhes dais vida,<br>"
      + "os santificais, abençoais e distribuís por nós.<br>"
      + "Celebrante principal ou concelebrantes:<br>"
      + "98. "
      + "Toma o cálice e a patena com a hóstia e, elevando-os, diz: <br>"
      + "Por Cristo, com Cristo, em Cristo,<br>"
      + "a Vós, Deus Pai todo-poderoso,<br>"
      + "na unidade do Espírito Santo,<br>"
      + "toda a honra e toda a glória,<br>"
      + "por todos os séculos dos séculos.<br>"
      + "O povo aclama: Amen.<br>"
      + "Seguem-se os ritos da comunhão, p. "
      + "526.<br>"
      + "<br>"
      + "99. "
      + "Esta Oração eucarística tem um prefácio próprio, que faz parte da sua estrutura. <br>"
    )
     + (
      "Podem usar-se também outros prefácios, especialmente aqueles que apresentam <br>"
      + "em breve síntese o mistério da salvação.<br>"
      + "Celebrante principal:<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
     ...
     + (
      ...
      + "Celebrante principal:<br>"
      + "100. "
      + "O sacerdote, de braços abertos, continua:<br>"
      + "Vós, Senhor, sois verdadeiramente santo,<br>"
      + "sois a fonte de toda a santidade.<br>"
      + "Nos domingos e em outros dias solenes pode fazer-se a comemoração própria.<br>"
      + "Domingos:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos o primeiro dia da semana, em que nosso Senhor Jesus Cristo ressuscitou <br>"
      + "dos mortos, humildemente V os suplicamos: <br>"
      + "Natal do Senhor e sua oitava:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos <br>"
      + "o dia santíssimo (a noite santíssima) em que a Imaculada Virgem Maria deu <br>"
      + "à luz o Salvador do mundo, humildemente V os suplicamos: <br>"
      + "Epifania do Senhor:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos <br>"
      + "o dia santíssimo em que o vosso Filho unigénito, eterno convosco na glória, <br>"
    ))
     + ((
      "Se manifestou visivelmente na realidade da nossa carne, humildemente V os <br>"
      + "suplicamos:<br>"
      + "Quinta-Feira Santa:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos <br>"
      + "o dia santíssimo em que nosso Senhor Jesus Cristo Se entregou por nós, <br>"
      + "humildemente V os suplicamos: Santificai estes dons, derramando sobre eles <br>"
      + "o vosso Espírito, de modo que se convertam, para nós, no Corpo e + Sangue <br>"
      + "de nosso Senhor Jesus Cristo. "
      + "Hoje, na hora em que Ele Se entregava ...<br>"
      + "Vigília Pascal até ao Domingo II da Páscoa:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos o dia santíssimo (a noite santíssima) da ressurreição de nosso Senhor <br>"
      + "Jesus Cristo segundo a carne, humildemente V os suplicamos: <br>"
      + "Ascensão do Senhor:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos <br>"
      + "o dia santíssimo em que nosso Senhor Jesus Cristo, vosso Filho unigénito, <br>"
      + "colocou à direita da vossa glória a nossa frágil natureza humana unida à <br>"
      + "sua divindade, humildemente V os suplicamos:<br>"
      + "<br>"
    )
     + (
      "Pentecostes:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos <br>"
      + "o dia santíssimo de Pentecostes, em que o Espírito Santo Se manifestou aos <br>"
      + "Apóstolos em numerosas línguas de fogo, humildemente V os suplicamos: <br>"
      + "Apresentação do Senhor:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos o dia em que o vosso Filho unigénito foi apresentado no Templo, <br>"
      + "humildemente V os suplicamos: <br>"
      + "Anunciação do Senhor:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos o dia em que a Virgem santa Maria concebeu o vosso Filho unigénito <br>"
      + "pelo poder do Espírito Santo, humildemente V os suplicamos: <br>"
      + "Nascimento de são João Batista:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos o dia do nascimento de são João Batista, que preparou o caminho do <br>"
      + "Salvador do mundo, humildemente V os suplicamos: <br>"
      + "Assunção da Virgem santa Maria:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos o dia em que santa Maria Mãe de Deus foi elevada à glória do céu, <br>"
      + "humildemente V os suplicamos: <br>"
      + "Natividade da Virgem santa Maria:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos o dia do nascimento da Virgem santa Maria, escolhida desde toda a <br>"
    )))
     + (((
      "eternidade para ser a Mãe do Redentor, humildemente V os suplicamos:<br>"
      + "Dia de Todos os Santos:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos <br>"
      + "o dia consagrado à memória de todos os santos, que durante a vida imitaram <br>"
      + "a Cristo e na morte receberam d’Ele a coroa da glória, humildemente V os <br>"
      + "suplicamos: <br>"
      + "Imaculada Conceição da Virgem santa Maria:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos <br>"
      + "o dia em que a Virgem Maria, escolhida para ser a Mãe do Redentor, foi <br>"
      + "concebida sem mancha do pecado original, humildemente V os suplicamos:<br>"
      + "<br>"
      + "Celebrante principal e concelebrantes:<br>"
      + "101. "
      + "Junta as mãos e, estendendo-as sobre as oblatas, diz: <br>"
      + "Santificai estes dons,<br>"
      + "derramando sobre eles o vosso Espírito,<br>"
      + "Junta as mãos e traça um único sinal da cruz sobre o pão e sobre o cálice, dizendo:<br>"
      + "de modo que se convertam, para nós,<br>"
    )
     + (
      "no Corpo e + Sangue de nosso Senhor Jesus Cristo.<br>"
      + "Junta as mãos.<br>"
      + "102. "
      + "Nas fórmulas que se seguem, as palavras do Senhor devem pronunciar-se <br>"
      + "distintamente, como o requer a natureza das mesmas palavras.<br>"
      + "Na hora em que Ele Se entregava, <br>"
      + "para voluntariamente sofrer a morte,<br>"
      + "Toma o pão e, sustentando-o um pouco elevado sobre o altar, continua:<br>"
      + "tomou o pão e, dando graças, partiu-o<br>"
      + "e deu-o aos seus discípulos, dizendo:<br>"
      + "Inclina-se um pouco.<br>"
      + "Tomai , todos , e comei :<br>"
      + "isto é o meu corpo ,<br>"
     ...
     + ((
      "De igual modo, no fim da Ceia,<br>"
      + "Toma o cálice e, sustentando-o um pouco elevado sobre o altar, continua:<br>"
      + "tomou o cálice, de novo Vos deu graças<br>"
      + "e deu-o aos seus discípulos, dizendo: <br>"
      + "Inclina-se um pouco.<br>"
      + "Tomai , todos , e bebei :<br>"
      + "este é o cálice do meu sangue ,<br>"
     ...
     + ((((
      ...
      + "105. "
      + "Em seguida, o sacerdote, de braços abertos, diz:<br>"
      + "Celebrando agora, Senhor,<br>"
      + "o memorial da morte e ressurreição de vosso Filho,<br>"
      + "nós Vos oferecemos o pão da vida e o cálice da salvação <br>"
      + "e Vos damos graças, porque nos admitistes à vossa presença,<br>"
      + "para Vos servir nestes santos mistérios.<br>"
      + "Humildemente Vos suplicamos <br>"
      + "que, participando no Corpo e Sangue de Cristo, <br>"
      + "sejamos reunidos, pelo Espírito Santo, num só corpo.<br>"
      + "Celebrante principal ou concelebrante [1]:<br>"
      + "Lembrai-Vos, Senhor, da vossa Igreja,<br>"
      + "dispersa por toda a terra, <br>"
      + "e tornai-a perfeita na caridade,<br>"
    )
     + (
      "em comunhão com o nosso papa N.,<br>"
      + "o nosso bispo N. <br>"
      + "O bispo, quando celebra na sua diocese, diz:<br>"
      + "e comigo, vosso indigno servo,<br>"
      + "O bispo, quando celebra fora da sua diocese, diz:<br>"
      ...
      + "o nosso bispo coadjutor (ou auxiliar) N. <br>"
      + "Ou: os nossos bispos auxiliares,<br>"
      + "e todos os ministros sagrados.<br>"
      + "Podem acrescentar-se algumas intercessões próprias das Missas rituais.<br>"
      + "Nas Missas pelos defuntos pode acrescentar-se:<br>"
      + "Lembrai-V os do vosso servo N. (da vossa serva N.), <br>"
      + "a quem (hoje) chamastes para V ós:<br>"
      + "configurado (a) com Cristo na morte, <br>"
      + "com Cristo tome parte na ressurreição.<br>"
      + "<br>"
    ))
     + ((
      "Celebrante principal ou concelebrante [2]:<br>"
      + "Lembrai-Vos também dos (outros) nossos irmãos,<br>"
      + "que adormeceram na esperança da ressurreição, <br>"
      + "e de todos aqueles que na vossa misericórdia <br>"
      + "partiram deste mundo: <br>"
      + "admiti-os na luz da vossa presença.<br>"
      + "Tende misericórdia de nós, Senhor, <br>"
      + "e dai-nos a graça de participar na vida eterna, <br>"
      + "com a Virgem santa Maria, Mãe de Deus, são José, seu esposo,<br>"
      + "os bem-aventurados apóstolos,<br>"
      + "(são / santo N. santo do dia ou santo padroeiro) <br>"
      + "e todos os santos,<br>"
      + "que, desde o princípio do mundo, viveram na vossa amizade,<br>"
      + "para cantarmos os vossos louvores,<br>"
      + "Junta as mãos.<br>"
      + "por Jesus Cristo, vosso Filho.<br>"
      + "Celebrante principal ou concelebrantes:<br>"
      + "106. "
     ...
     + (
      ...
      + "<br>"
      + "107. "
      + "O Prefácio é escolhido conforme as rubricas.<br>"
      + "Celebrante principal:<br>"
      + "108. "
      + "O sacerdote, de braços abertos, diz:<br>"
      + "Vós, Senhor, sois verdadeiramente santo<br>"
      + "e todas as criaturas cantam os vossos louvores,<br>"
      + "porque dais a vida e santificais todas as coisas, <br>"
    )))
     + (((
      "por nosso Senhor Jesus Cristo, vosso Filho, <br>"
      + "com o poder do Espírito Santo, <br>"
      + "e não cessais de reunir para Vós um povo, <br>"
      + "que, de um extremo ao outro da terra, <br>"
      + "Vos ofereça uma oblação pura.<br>"
      + "Nos domingos e em outros dias solenes pode fazer-se a comemoração própria.<br>"
      + "Domingos:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos <br>"
      + "o primeiro dia da semana, em que nosso Senhor Jesus Cristo ressuscitou <br>"
      + "dos mortos, humildemente ...<br>"
      + "Natal do Senhor e sua oitava:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos <br>"
      + "o dia santíssimo (a noite santíssima) em que a Imaculada Virgem Maria deu <br>"
      + "à luz o Salvador do mundo, humildemente ...<br>"
      + "Epifania do Senhor:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos <br>"
      + "o dia santíssimo em que o vosso Filho unigénito, eterno convosco na glória, <br>"
      + "Se manifestou visivelmente na realidade da nossa carne, humildemente ...<br>"
    )
     + (
      "Quinta-Feira Santa:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos <br>"
      + "o dia santíssimo em que nosso Senhor Jesus Cristo Se entregou por nós, <br>"
      + "humildemente, V os suplicamos, Senhor: santificai, pelo Espírito Santo, estes <br>"
      + "dons que V os apresentamos, para que se convertam no Corpo e + Sangue <br>"
      + "de nosso Senhor Jesus Cristo, vosso Filho, que nos mandou celebrar estes <br>"
      + "mistérios. "
      + "Hoje, na noite em que Ele ia ser entregue, tomou o pão ...<br>"
      + "<br>"
      + "Vigília Pascal até ao Domingo II da Páscoa:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos o dia santíssimo (a noite santíssima) da ressurreição de nosso Senhor <br>"
      + "Jesus Cristo segundo a carne, humildemente ...<br>"
      + "Ascensão do Senhor:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos <br>"
      + "o dia santíssimo em que nosso Senhor Jesus Cristo, vosso Filho unigénito, <br>"
      + "colocou à direita da vossa glória a nossa frágil natureza humana unida à <br>"
      + "sua divindade, humildemente ...<br>"
      + "Pentecostes:<br>"
    ))
     + ((
      "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos <br>"
      + "o dia santíssimo de Pentecostes, em que o Espírito Santo Se manifestou aos <br>"
      + "Apóstolos em numerosas línguas de fogo, humildemente ...<br>"
      + "Dedicação de uma igreja:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos <br>"
      + "a dedicação deste templo, no dia em que o consagrastes e enchestes com a <br>"
      + "vossa presença, humildemente ...<br>"
      + "Apresentação do Senhor:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos o dia em que o vosso Filho unigénito foi apresentado no Templo, ...<br>"
      + "Anunciação do Senhor:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos o dia em que a Virgem santa Maria concebeu o vosso Filho unigénito <br>"
      + "pelo poder do Espírito Santo, humildemente ...<br>"
      + "Nascimento de são João Batista:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos o dia do nascimento de são João Batista, que preparou o caminho do <br>"
      + "Salvador do mundo, humildemente ...<br>"
      + "Assunção da Virgem santa Maria:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos o dia em que santa Maria Mãe de Deus foi elevada à glória do céu, ...<br>"
      + "Natividade da Virgem santa Maria:<br>"
    )
     + (
      "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos o dia do nascimento da Virgem santa Maria, escolhida desde toda a <br>"
      + "eternidade para ser a Mãe do Redentor, humildemente ...<br>"
      + "<br>"
      + "Dia de Todos os Santos:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos <br>"
      + "o dia consagrado à memória de todos os santos, que durante a vida imitaram <br>"
      + "a Cristo e na morte receberam d’Ele a coroa da glória, humildemente ...<br>"
      + "Imaculada Conceição da Virgem santa Maria:<br>"
      + "Reunidos na vossa presença, em comunhão com toda a Igreja, ao celebrarmos o dia em que a Virgem Maria, escolhida para ser a Mãe do Redentor, <br>"
      + "foi concebida sem mancha do pecado original, humildemente ...<br>"
      + "Celebrante principal e concelebrantes:<br>"
      + "109. "
      + "Junta as mãos e, estendendo-as sobre as oblatas, diz:<br>"
      + "Humildemente Vos suplicamos, Senhor:<br>"
      + "santificai, pelo Espírito Santo, <br>"
      + "estes dons que Vos apresentamos, <br>"
      + "Junta as mãos e traça o sinal da cruz sobre o pão e sobre o cálice, dizendo:<br>"
      + "para que se convertam no Corpo e + Sangue <br>"
    ))))))
     + ((((((
      "de nosso Senhor Jesus Cristo, vosso Filho, <br>"
      + "Junta as mãos.<br>"
      + "que nos mandou celebrar estes mistérios.<br>"
      + "<br>"
      + "110. "
      + "Nas fórmulas que se seguem, as palavras do Senhor devem pronunciar-se <br>"
      + "clara e distintamente, como o requer a natureza das mesmas palavras.<br>"
      + "Na noite em que Ele ia ser entregue,<br>"
      + "Toma o pão e, sustentando-o um pouco elevado sobre o altar, continua:<br>"
      + "tomou o pão, <br>"
      + "dando graças Vos bendisse, <br>"
      + "partiu-o e deu-o aos seus discípulos, dizendo: <br>"
     ...
     + (
      ...
      + "Em seguida, o sacerdote, de braços abertos, diz:<br>"
      + "Celebrando agora, Senhor, o memorial <br>"
      + "da paixão redentora do vosso Filho,<br>"
      + "da sua admirável ressurreição e ascensão aos céus, <br>"
      + "e esperando a sua vinda gloriosa, <br>"
      + "nós Vos oferecemos, em ação de graças,<br>"
      + "este sacrifício vivo e santo.<br>"
      + "Olhai benignamente para a oblação da vossa Igreja: <br>"
      + "vede nela a vítima que nos reconciliou convosco<br>"
      + "e fazei que, alimentando-nos do Corpo e Sangue do vosso Filho, <br>"
    )))
     + (((
      "cheios do seu Espírito Santo, <br>"
      + "sejamos em Cristo um só corpo e um só espírito.<br>"
      + "<br>"
      + "Celebrante principal ou concelebrante [1]:<br>"
      + "O Espírito Santo faça de nós uma oferenda permanente,<br>"
      + "a fim de alcançarmos a herança eterna, <br>"
      + "em companhia dos vossos eleitos, <br>"
      + "com a Virgem santa Maria, Mãe de Deus, são José, seu esposo,<br>"
      + "os bem-aventurados apóstolos e gloriosos mártires, <br>"
      + "(santo N. santo do dia ou santo padroeiro) <br>"
      + "e todos os santos, <br>"
      + "por cuja intercessão esperamos sempre o vosso auxílio.<br>"
      + "Celebrante principal ou concelebrante [2]:<br>"
      + "Por este sacrifício de reconciliação,<br>"
      + "dai, Senhor, a salvação e a paz ao mundo inteiro; <br>"
      + "confirmai a vossa Igreja na fé e na caridade, <br>"
      + "ao longo da sua peregrinação na terra, <br>"
      + "com o vosso servo, o nosso papa N., <br>"
    )
     + (
      "o nosso bispo N.<br>"
      + "O bispo, quando celebra na sua diocese, diz:<br>"
      ...
      + "o nosso bispo coadjutor (ou auxiliar) N. <br>"
      + "Ou: os nossos bispos auxiliares,<br>"
      + "e todos os bispos e ministros sagrados, <br>"
      + "e todo o povo por Vós redimido.<br>"
      + "Atendei benignamente às preces desta família, <br>"
      + "que Vos dignastes reunir na vossa presença.<br>"
      + "Em algumas celebrações podem fazer-se intercessões especiais.<br>"
      + "Reconduzi a Vós, Pai de misericórdia, <br>"
      + "todos os vossos filhos dispersos.<br>"
      + "<br>"
      + "Lembrai-Vos dos nossos irmãos defuntos<br>"
    ))
     + ((
      "e de todos os que morreram na vossa amizade. <br>"
      + "Acolhei-os com bondade no vosso reino, <br>"
      + "onde também nós esperamos ser recebidos, <br>"
      + "para vivermos com eles eternamente na vossa glória,<br>"
      + "por nosso Senhor Jesus Cristo. <br>"
      + "Junta as mãos:<br>"
      + "Por Ele concedeis ao mundo todos os bens.<br>"
      + "114. "
      + "Nas Missas pelos defuntos pode dizer-se:<br>"
      + "Lembrai-V os do vosso servo N. (da vossa serva N.),<br>"
      + "que (hoje) chamastes para V ós: <br>"
      + "configurado(a) com Cristo na morte, <br>"
      + "com Cristo tome parte na ressurreição, <br>"
      + "quando Ele vier ressuscitar os mortos<br>"
      + "e transformar o nosso corpo mortal à imagem do seu Corpo glorioso.<br>"
      + "Lembrai-V os também dos outros nossos irmãos defuntos<br>"
      + "e de todos os que morreram na vossa amizade.<br>"
      + "Acolhei-os com bondade no vosso reino, <br>"
    )
     + (
      "onde também nós esperamos ser recebidos,<br>"
      + "para vivermos com eles eternamente na vossa glória,<br>"
      + "quando enxugardes todas as lágrimas dos nossos olhos;<br>"
      + "e, vendo-V os tal como sois, Senhor nosso Deus,<br>"
      + "seremos para sempre semelhantes a V ós<br>"
      + "e cantaremos sem fim os vossos louvores, por nosso Senhor Jesus Cristo.<br>"
      + "Junta as mãos.<br>"
      + "Por Ele concedeis ao mundo todos os bens. <br>"
      + "Celebrante principal ou concelebrantes:<br>"
      + "115. "
     ...
     + ((((
      ...
      + "<br>"
      + "116. "
      + "O prefácio desta Oração eucarística não pode ser substituído por outro, em <br>"
      + "virtude da natureza desta Oração, que apresenta o sumário da história da salvação.<br>"
      + "Celebrante principal:<br>"
      + "V. "
      + "O Senhor esteja convosco. "
      + "R. "
     ...
     + (
      ...
      + "é verdadeiramente nosso dever dar-Vos graças,<br>"
      + "é nossa salvação glorificar-Vos,<br>"
      + "porque sois o único Deus vivo e verdadeiro.<br>"
      + "Vós existis desde sempre<br>"
      + "e permaneceis eternamente na luz inacessível.<br>"
      + "Deus de bondade e fonte da vida,<br>"
      + "criastes o universo <br>"
      + "para encher de bênçãos todas as criaturas<br>"
      + "e a muitas alegrar na claridade da vossa luz.<br>"
      + "Inumeráveis coros de anjos<br>"
      + "estão na vossa presença para Vos servir<br>"
      + "e, contemplando a glória do vosso rosto,<br>"
      + "dia e noite cantam os vossos louvores.<br>"
      + "Com eles, também nós<br>"
      + "e, pela nossa voz, a criação inteira,<br>"
      + "aclamamos o vosso nome,<br>"
      + "cantando com alegria:<br>"
    ))
     + ((
      "Santo, Santo, Santo,<br>"
      + "Senhor Deus do universo.<br>"
      ...
      + "117. "
      + "O sacerdote, de braços abertos, continua:<br>"
      + "Pai santo, nós Vos glorificamos,<br>"
      + "porque sois grande<br>"
      + "e tudo criastes com sabedoria e amor.<br>"
      + "Formastes o homem à vossa imagem<br>"
      + "e lhe confiastes o universo,<br>"
      + "para que, servindo-Vos unicamente a Vós, seu Criador,<br>"
      + "exercesse domínio sobre todas as criaturas.<br>"
      + "E quando, por desobediência, perdeu a vossa amizade,<br>"
    )
     + (
      "não o abandonastes ao poder da morte,<br>"
      + "mas, na vossa misericórdia, a todos socorrestes, <br>"
      + "para que todos aqueles que Vos procuram Vos encontrem. <br>"
      + "Repetidas vezes fizestes aliança com os homens <br>"
      + "e, pelos profetas, os formastes na esperança da salvação. <br>"
      + "Pai santo, de tal modo amastes o mundo, <br>"
      + "que, chegada a plenitude dos tempos, <br>"
      + "nos enviastes, como Salvador, o vosso Filho unigénito: <br>"
      + "feito homem pelo poder do Espírito Santo <br>"
      + "e nascido da Virgem Maria, <br>"
      + "viveu a nossa condição humana, <br>"
      + "em tudo igual a nós, exceto no pecado; <br>"
      + "anunciou a salvação aos pobres, <br>"
      + "a libertação aos oprimidos, <br>"
      + "a alegria aos que sofrem. <br>"
      + "Para cumprir o vosso plano salvador, <br>"
      + "voluntariamente Se entregou à morte<br>"
      + "e, com a sua ressurreição, <br>"
    )))
     + (((
      "destruiu a morte e restaurou a vida. <br>"
      + "E a fim de vivermos, não já para nós próprios,<br>"
      + "mas para Ele, que por nós morreu e ressuscitou,<br>"
      + "de Vós, Pai misericordioso, <br>"
      + "enviou aos que n’Ele creem o Espírito Santo, <br>"
      + "como primícias dos seus dons, <br>"
      + "para continuar a sua obra no mundo <br>"
      + "e consumar toda a santificação.<br>"
      + "<br>"
      + "Celebrante principal e concelebrantes:<br>"
      + "118. "
      + "Junta as mãos e, estendendo-as sobre as oblatas, diz:<br>"
      + "Nós Vos pedimos, Senhor, <br>"
      + "que o Espírito Santo santifique estes dons, <br>"
      + "Junta as mãos e traça o sinal da cruz sobre o pão e sobre o cálice, dizendo:<br>"
      + "para que se convertam <br>"
      + "no Corpo e + Sangue de nosso Senhor Jesus Cristo, <br>"
      + "Junta as mãos.<br>"
    )
     + (
      "ao celebrarmos este grande mistério, <br>"
      + "que Ele nos deixou como sinal de aliança eterna.<br>"
      + "119. "
      + "Nas fórmulas que se seguem, as palavras do Senhor devem pronunciar-se <br>"
      + "clara e distintamente, como o requer a natureza das mesmas palavras.<br>"
      + "Pai santo, quando chegou a hora <br>"
      + "em que Ele ia ser glorificado por Vós,<br>"
      + "tendo amado os seus que estavam no mundo, <br>"
      + "amou-os até ao fim. <br>"
      + "E, durante a Ceia,<br>"
      + "Toma o pão e, sustentando-o um pouco elevado sobre o altar, continua:<br>"
      + "tomou o pão, bendisse-Vos, <br>"
      + "partiu-o e deu-o aos seus discípulos, dizendo:<br>"
      + "Inclina-se um pouco.<br>"
      + "Tomai, todos, e comei:<br>"
      + "isto é o meu corpo,<br>"
     ...
     + ((
      ...
      + "De igual modo, <br>"
      + "Toma o cálice e, sustentando-o um pouco elevado sobre o altar, continua:<br>"
      + "tomou o cálice com vinho, deu-Vos graças<br>"
      + "e deu-o aos seus discípulos, dizendo:<br>"
      + "Inclina-se um pouco.<br>"
      + "Tomai, todos, e bebei:<br>"
      + "este é o cálice do meu sangue,<br>"
     ...
     + (((((
      ...
      + "122. "
      + "Em seguida, o sacerdote, de braços abertos, diz:<br>"
      + "Celebrando agora, Senhor, o memorial da nossa redenção,<br>"
      + "recordamos a morte de Cristo <br>"
      + "e a sua descida à mansão dos mortos;<br>"
      + "proclamamos a sua ressurreição e ascensão aos céus; <br>"
      + "e, esperando a sua vinda gloriosa, <br>"
      + "nós Vos oferecemos o seu Corpo e Sangue, <br>"
      + "o sacrifício do vosso agrado<br>"
      + "e de salvação para todo o mundo.<br>"
      + "Olhai, Senhor, para esta oblação, <br>"
    )
     + (
      "que preparastes para a vossa Igreja, <br>"
      + "e concedei, por vossa bondade, <br>"
      + "a quantos vamos participar do mesmo pão e do mesmo cálice, <br>"
      + "que, reunidos pelo Espírito Santo num só corpo, <br>"
      + "sejamos em Cristo uma oferenda viva,<br>"
      + "para louvor da vossa glória.<br>"
      + "Celebrante principal ou concelebrante [1]:<br>"
      + "Lembrai-Vos agora, Senhor,<br>"
      + "de todos aqueles por quem oferecemos este sacrifício:<br>"
      + "o vosso servo, o nosso papa N., <br>"
      + "o nosso bispo N. <br>"
      + "O bispo, quando celebra na sua diocese, diz:<br>"
      + "e eu, vosso indigno servo,<br>"
      + "O bispo, quando celebra fora da sua diocese, diz:<br>"
      + "o meu irmão N. (os meus irmãos), bispo(s) desta Igreja,<br>"
      + "e eu, vosso indigno servo,<br>"
      + "Pode fazer-se menção do bispo coadjutor ou dos bispos auxiliares:<br>"
      + "o nosso bispo coadjutor (ou auxiliar) N. <br>"
    ))
     + ((
      "Ou: os nossos bispos auxiliares,<br>"
      + "e todos os bispos, <br>"
      + "os ministros sagrados e os que Vos apresentam as suas ofertas, <br>"
      + "os membros desta assembleia, todo o vosso povo santo<br>"
      + "e todos aqueles que Vos procuram de coração sincero.<br>"
      + "<br>"
      + "Celebrante principal ou concelebrante [2]:<br>"
      + "Lembrai-Vos também<br>"
      + "dos nossos irmãos que adormeceram na paz de Cristo<br>"
      + "e de todos os defuntos cuja fé só Vós conhecestes.<br>"
      + "E a todos nós, vossos filhos, <br>"
      + "concedei, Pai de misericórdia, <br>"
      + "a graça de alcançarmos a herança do céu, <br>"
      + "com a Virgem santa Maria, Mãe de Deus, são José, seu esposo,<br>"
      + "os apóstolos e todos os santos, <br>"
      + "para que, no vosso reino,<br>"
      + "com a criação inteira liberta do pecado e da morte, <br>"
      + "cantemos eternamente a vossa glória, <br>"
    )
     + (
      "por nosso Senhor Jesus Cristo. <br>"
      + "Junta as mãos.<br>"
      ...
      + "por todos os séculos dos séculos.<br>"
      + "O povo aclama: Amen.<br>"
      + "Seguem-se os ritos da comunhão.<br>"
      + "<br>"
      + "Ritos da comunhão<br>"
      + "124. "
      + "Tendo colocado o cálice e a patena sobre o altar, o sacerdote, de mãos <br>"
      + "juntas, diz:<br>"
    )))
     + (((
      "Fiéis aos ensinamentos do Salvador, ousamos dizer: <br>"
      + "Ou: Num só coração e numa só alma, <br>"
      + " ousamos dizer como o Senhor nos ensinou:<br>"
      + "Ou: Porque nos chamamos e somos filhos de Deus,<br>"
      + " ousamos dizer com toda a confiança:<br>"
      + "Ou: Unidos a Cristo, pelo Espírito Santo, ousamos dizer:<br>"
      + "Ou: Em comunhão com toda a Igreja, ousamos dizer:<br>"
      + "Abre os braços e, juntamente com o povo, continua:<br>"
     ...
     + (
      ...
      + "fiat volúntas tua, sicut in caelo, et in terra. <br>"
      ...
      + "125. "
      + "De braços abertos, o sacerdote diz sozinho: <br>"
      + "Livrai-nos de todo o mal, Senhor, <br>"
      + "e dai ao mundo a paz em nossos dias,<br>"
      + "para que, ajudados pela vossa misericórdia, <br>"
      + "sejamos sempre livres do pecado e de toda a perturbação, <br>"
    ))
     + ((
      "enquanto esperamos a vinda gloriosa <br>"
      + "de Jesus Cristo nosso Salvador.<br>"
      + "Junta as mãos.<br>"
      + "O povo conclui a oração, aclamando:<br>"
      + "V osso é o reino e o poder <br>"
      + "e a glória para sempre.<br>"
      + "126. "
      + "Em seguida, o sacerdote, de braços abertos, diz em voz alta:<br>"
      + "Senhor Jesus Cristo, que dissestes aos vossos apóstolos: <br>"
      + "Deixo-vos a paz, dou-vos a minha paz:<br>"
      + "não olheis aos nossos pecados, mas à fé da vossa Igreja,<br>"
      + "e dai-lhe a união e a paz, segundo a vossa vontade, <br>"
      + "Junta as mãos.<br>"
      + "Vós que viveis e reinais pelos séculos dos séculos.<br>"
      + "O povo responde: Amen.<br>"
      + "127. "
      + "O sacerdote, voltado para o povo, estendendo e juntando as mãos, diz:<br>"
      + "A paz do Senhor esteja sempre convosco. <br>"
    )
     + (
      "O povo responde: O amor de Cristo nos uniu.<br>"
      + "<br>"
      + "128. "
      + "Em seguida, conforme as circunstâncias, o diácono ou o sacerdote acrescenta:<br>"
      + "Saudai-vos na paz de Cristo.<br>"
      + "Ou: Como filhos do Deus da paz, <br>"
      + " saudai-vos com um gesto de comunhão fraterna.<br>"
      + "Ou: Em Jesus, que fez de todos nós seus irmãos, <br>"
      + " saudai-vos com um gesto de reconciliação e de paz.<br>"
      + "Ou: No Espírito de Cristo ressuscitado, <br>"
      + " saudai-vos com um gesto de paz.<br>"
      + "Todos se saúdam, segundo os costumes locais, em sinal de mútua paz, comunhão <br>"
      + "e caridade. "
      + "O sacerdote saúda o diácono ou o ministro.<br>"
      + "129. "
      + "Em seguida, toma a hóstia, parte-a sobre a patena e deita um fragmento <br>"
      + "no cálice, dizendo em silêncio: <br>"
      + "Esta união do Corpo e Sangue de nosso Senhor Jesus Cristo, <br>"
    ))))
     + ((((
      "que vamos receber, nos sirva para a vida eterna.<br>"
      + "130. "
      + "Entretanto, canta-se ou recita-se:<br>"
      ...
      + " dai-nos a paz.<br>"
      + "Ou, com canto em latim:<br>"
      + "Agnus Dei, qui tollis peccáta mundi: miserére nobis. <br>"
      + "Agnus Dei, qui tollis peccáta mundi: miserére nobis. <br>"
      + "Agnus Dei, qui tollis peccáta mundi: dona nobis pacem.<br>"
      + "Estas invocações podem repetir-se várias vezes, se a fração do pão se prolongar. <br>"
      + "Contudo, na última vez, diz-se: dai-nos a paz.<br>"
      + "<br>"
      + "131. "
      + "Em seguida, o sacerdote, de mãos juntas, diz em silêncio: <br>"
    )
     + (
      "Senhor Jesus Cristo, Filho de Deus vivo, <br>"
      + "que, por vontade do Pai e com o poder do Espírito Santo, <br>"
      + "destes a vida ao mundo pela vossa morte, <br>"
      + "livrai-me de todos os meus pecados e de todo o mal, <br>"
      + "por este vosso santíssimo Corpo e Sangue; <br>"
      + "conservai-me sempre fiel aos vossos mandamentos <br>"
      + "e não permitais que eu me separe de V ós.<br>"
      + "Ou:<br>"
      + "A comunhão do vosso Corpo e Sangue, Senhor Jesus Cristo,<br>"
      + "não seja para meu julgamento e condenação, <br>"
      + "mas, pela vossa misericórdia, <br>"
      + "me sirva de proteção e remédio para a alma e para o corpo.<br>"
      + "132. "
      + "O sacerdote genuflete, toma a hóstia, levanta-a um pouco sobre a patena <br>"
      + "ou sobre o cálice e, voltado para o povo, diz em voz alta:<br>"
      + "Felizes os convidados para a Ceia do Senhor.<br>"
      + "Eis o Cordeiro de Deus, que tira o pecado do mundo.<br>"
      + "Ou: Felizes os convidados para o banquete do Reino dos céus. <br>"
    ))
     + ((
      " Eis o Cordeiro de Deus, que tira o pecado do mundo.<br>"
      + "Ou: Felizes os convidados para o banquete nupcial do Cordeiro.<br>"
      + " Eis o Cordeiro de Deus, que tira o pecado do mundo.<br>"
      + "Ou: Provai e vede como o Senhor é bom.<br>"
      + " Eis o Cordeiro de Deus, que tira o pecado do mundo.<br>"
      + "E, juntamente com o povo, acrescenta uma só vez:<br>"
      + "Senhor, eu não sou digno de que entreis em minha morada, <br>"
      + "mas dizei uma palavra e serei salvo.<br>"
      + "<br>"
      + "133. "
      + "V oltado para o altar, o sacerdote diz em silêncio:<br>"
      + "O Corpo de Cristo me guarde para a vida eterna.<br>"
      + "Comunga com reverência o Corpo de Cristo.<br>"
      + "Em seguida, toma o cálice e diz em silêncio:<br>"
      + "O Sangue de Cristo me guarde para a vida eterna.<br>"
      + "Comunga com reverência o Sangue de Cristo.<br>"
      + "134. "
      + "Depois, toma a patena ou a píxide, aproxima-se dos comungantes e, elevando um pouco a hóstia, mostra-a a cada um deles, dizendo:<br>"
    )
     + (
      "O Corpo de Cristo Ou: Corpus Christi. <br>"
      + "O comungante responde Amen e comunga.<br>"
      + "O diácono procede do mesmo modo, se tiver de distribuir a Comunhão.<br>"
      + "135. "
      + "Para a comunhão sob as duas espécies, segue-se o rito descrito em seu <br>"
      + "lugar próprio.<br>"
      + "136. "
      + "Enquanto o sacerdote comunga o Corpo de Cristo, começa-se o cântico <br>"
      + "da comunhão.<br>"
      + "137. "
      + "Terminada a distribuição da Comunhão, o sacerdote ou o diácono, ou o <br>"
      + "acólito instituído, purifica a patena sobre o cálice e o próprio cálice. <br>"
      + "Durante a purificação, o sacerdote diz em silêncio: <br>"
      + "O que em nossa boca recebemos, Senhor, <br>"
      + "seja por nós acolhido em coração puro, <br>"
      + "e estes dons da vida temporal <br>"
      + "se tornem remédio de vida eterna.<br>"
      + "138. "
    )))
     + (((
      "Então, o sacerdote pode voltar para a sua cadeira. "
      + "Se convier, podem guardar-se uns momentos de silêncio sagrado, ou recitar um salmo ou um cântico de <br>"
      + "louvor.<br>"
      + "139. "
      + "Em seguida, de pé, junto da sua cadeira ou do altar, o sacerdote, voltado <br>"
      + "para o povo, diz, de mãos juntas: <br>"
      + "Oremos.<br>"
      + "Todos, juntamente com o sacerdote, oram em silêncio durante alguns momentos, <br>"
      + "a não ser que já antes tenha havido silêncio.<br>"
      + "<br>"
      + "Em seguida, o sacerdote diz, de braços abertos, a oração depois da comunhão.<br>"
      + "Se a oração se dirige ao Pai, a conclusão é da seguinte forma:<br>"
      + "Por Cristo nosso Senhor.<br>"
      + "Se a oração se dirige ao Pai, com menção do Filho na parte final:<br>"
      + "Ele que vive e reina pelos séculos dos séculos.<br>"
     ...
     + (
      "<br>"
      + "Ritos de conclusão<br>"
      + "140. "
      + "Seguem-se, se os houver, breves avisos ao povo.<br>"
      + "141. "
      + "Em seguida, faz-se a despedida.<br>"
      + "O sacerdote, voltado para o povo, abrindo os braços, diz:<br>"
      + "O Senhor esteja convosco.<br>"
      + "O povo responde: Ele está no meio de nós.<br>"
      + "O sacerdote abençoa o povo, dizendo:<br>"
      + "Abençoe-vos Deus todo-poderoso, <br>"
      + "Pai, Filho e + Espírito Santo.<br>"
      + "O povo responde: Amen.<br>"
      + "142. "
      + "Em certos dias e em ocasiões especiais, a fórmula de bênção tem textos <br>"
      + "próprios: bênção solene ou oração sobre o povo (cf. pp. "
      + "703-720).<br>"
      + "143. "
    ))
     + ((
      "Na Missa pontifical, o celebrante toma a mitra e, abrindo os braços, diz:<br>"
      + "O Senhor esteja convosco.<br>"
      + "Todos respondem: Ele está no meio de nós.<br>"
      + "O celebrante diz:<br>"
      + "Bendito seja o nome do Senhor.<br>"
      + "Todos respondem: Agora e para sempre.<br>"
      + "O celebrante diz:<br>"
      + "O nosso auxílio vem do Senhor.<br>"
      + "Todos respondem: Que fez o céu e a terra.<br>"
      + "<br>"
      + "Então, o celebrante toma o báculo, se o usa, e diz:<br>"
      + "Abençoe-vos Deus todo-poderoso,<br>"
      + "e, fazendo por três vezes o sinal da cruz sobre o povo, continua:<br>"
      + "Pai, + Filho + e Espírito + Santo.<br>"
      + "Todos: Amen.<br>"
      + "144. "
      + "Em seguida, o diácono ou o próprio sacerdote, de mãos juntas e voltado <br>"
      + "para o povo, diz:<br>"
    )
     + (
      "Ide em paz e o Senhor vos acompanhe.<br>"
      + "O povo responde: Graças a Deus.<br>"
      + "Ou: Anunciai o Evangelho do Senhor. <br>"
      + " Ide em paz e o Senhor vos acompanhe.<br>"
      + "Ou: Glorificai a Deus com a vossa vida. <br>"
      + " Ide em paz e o Senhor vos acompanhe.<br>"
      + "Ou: A alegria do Senhor seja a vossa força. <br>"
      + " Ide em paz e o Senhor vos acompanhe.<br>"
      + "Ou, no Tempo Pascal: <br>"
      + "Levai a todos a alegria do Senhor ressuscitado. "
      + "Aleluia.<br>"
      + "Ide em paz e o Senhor vos acompanhe.<br>"
      + "145. "
      + "Em seguida, o sacerdote beija o altar em sinal de veneração, como no <br>"
      + "início. "
      + "Feita a inclinação profunda com os ministros, retira-se.<br>"
      + "146. "
      + "Se a Missa é seguida de outra ação litúrgica, omitem-se os ritos de despedida."
    )))))))))
  });
  ...
  global.countryMassData.PT = Object.freeze({
    schemaVersion: 2,
    jurisdiction: 'PT',
    jurisdictions: Object.freeze(['PT']),
    jurisdictionName: 'Portugal',
    conferenceCalendar: 'Conferência Episcopal Portuguesa',
    ordinaryLanguage: 'PT',
    ordinary,
    ordinaryStructure: 'paragraph-rubric-choices-v1',
    officialOrderCorpus,
    ordinaryEdition: 'Missal Romano, terceira edição para Portugal',
    ordinarySource,
    beta: true,
    dailyReadings: Object.freeze({
      provider: 'Secretariado Nacional de Liturgia de Portugal',
      calendar: 'Portugal',
      translation: 'Leccionário e Missal Romano para Portugal',
      parser: 'strict-portuguese-daily-mass',
      url: dailyUrl
    }),
    ...
    properSources: Object.freeze({
      ...
      dailyMass: 'https://www.liturgia.pt/liturgiadiaria/'
    }),
