...
(function registerGermanyMass(global) {
  ...
  const ordinary = Object.freeze([{
    ...
    "lines": [{
      ...
      "sp_de": "",
      "text_de": (
        "Ein kleines Fragment der Hostie senkt er in den Kelch. "
        + "Dabei spricht er leise:"
      )
    }, {
      "sp_de": "",
  ...
  const ordinarySource = Object.freeze({
    ...
    "url": "https://www.redemptoristen.com/fileadmin/_migrated/content_uploads/Eigenfeiern_Allgemeine_Messtexte.pdf",
    "pages": "PDF 2–41",
  ...
  const officialOrderCorpus = Object.freeze({
    ...
    text_de: (((((((
      "Eröffnung<br>"
      + "BEGRÜSSUNG<br>"
      + "P.: ✠ Im Namen des Vaters und des Sohnes<br>"
      + "und des Heiligen Geistes. "
      + "Amen.<br>"
      + "Der Herr sei mit euch.<br>"
      + "Oder: <br>"
      + "Die Gnade unseres Herrn Jesus Christus,<br>"
      + "die Liebe Gottes des Vaters<br>"
      + "und die Gemeinschaft des Heiligen Geistes<br>"
      + "sei mit euch.<br>"
      + "Oder:<br>"
      + "Gnade und Friede von Gott, unserem Vater,<br>"
     ...
     + (
      "Gnade und Friede<br>"
      + "in der heiligen Versammlung der Kirche Gottes<br>"
      + "sei mit euch.<br>"
      + "Oder:<br>"
      + "Der Herr der Herrlichkeit<br>"
      + "und Spender jeder Gnade<br>"
      + "sei mit euch.<br>"
      + "Oder:<br>"
      + "Die Gnade des Herrn Jesus,<br>"
      + "der für uns Mensch geworden ist<br>"
      + "(gelitten hat, gestorben ist …),<br>"
      + "sei mit euch.<br>"
      + "Oder:<br>"
      + "Die Gnade unseres Herrn Jesus Christus<br>"
      + "sei mit euch.<br>"
     ...
     + ((
      ...
      + "damit wir die heiligen Geheimnisse<br>"
      + "in rechter Weise feiern können,<br>"
      + "wollen wir bekennen, dass wir gesündigt haben.<br>"
      + "Oder:<br>"
      + "Bevor wir das Gedächtnis des Herrn begehen,<br>"
      + "wollen wir uns besinnen und bekennen,<br>"
      + "dass wir sündige Menschen sind.<br>"
      + "Oder eine andere, frei formulierte Einladung.<br>"
      + "P.: Wir sprechen das Schuldbekenntnis:<br>"
      ...
      + "– ich habe gesündigt<br>"
    )
     + (
      "in Gedanken, Worten und Werken –<br>"
      + "Alle schlagen an die Brust.<br>"
      ...
      + "Form B<br>"
      + "Brüder und Schwestern,<br>"
      + "bevor wir das Wort Gottes hören<br>"
      + "und das Opfer Christi feiern,<br>"
    )))
     + (((
      "wollen wir uns bereiten<br>"
      + "und Gott um Vergebung unserer Sünden bitten.<br>"
      + "Oder:<br>"
      + "Damit wir<br>"
      + "das Gedächtnis des Herrn recht begehen,<br>"
      + "prüfen wir uns selbst<br>"
      + "und bekennen unsere Schuld<br>"
      + "vor Gott und der Kirche.<br>"
      + "Oder eine andere, frei formulierte Einladung.<br>"
      + "P.: Erbarme dich, Herr, unser Gott, erbarme dich.<br>"
      + "A.: Denn wir haben vor dir gesündigt.<br>"
      + "P.: Erweise, Herr, uns deine Huld.<br>"
      + "A.: Und schenke uns dein Heil.<br>"
      + "P.: Nachlass, Vergebung und Verzeihung unserer Sünden<br>"
      + "gewähre uns der allmächtige und barmherzige Herr.<br>"
      + "A.: Amen.<br>"
    )
     + (
      "Die Formen A und B können durch ein Bußlied ersetzt werden.<br>"
      + "Form C<br>"
      + "Bei dieser Form können den Kyrie-Rufen frei formulierte Christus-Prädikationen vorausgeschickt werden. <br>"
      + "Die nachstehenden Anrufungen sind als Beispiele zu verstehen.<br>"
      + "Zu Beginn dieser Messfeier<br>"
      + "wollen wir uns besinnen<br>"
      + "und das Erbarmen des Herrn auf uns herab rufen.<br>"
      + "Oder eine andere, frei formulierte Einladung.<br>"
      + "V.: Herr Jesus Christus,<br>"
      + "du bist vom Vater gesandt zu heilen,<br>"
      + "was verwundet ist:<br>"
      + "<br>"
      + "V.: Kyrie, eleison.<br>"
      + "A.: Kyrie, eleison.<br>"
      + "Oder:<br>"
      + "V.: Herr, erbarme dich (unser).<br>"
      + "A.: Herr, erbarme dich (unser).<br>"
    ))
     + ((
      "V.: Du bist gekommen, die Sünder zu berufen:<br>"
      + "V.: Christe, eleison.<br>"
      + "A.: Christe, eleison.<br>"
      + "Oder:<br>"
      + "V.: Christus, erbarme dich (unser).<br>"
      + "A.: Christus, erbarme dich (unser).<br>"
      + "V.: Du bist zum Vater heimgekehrt,<br>"
      + "um für uns einzutreten:<br>"
      + "V.: Kyrie, eleison.<br>"
      + "A.: Kyrie, eleison.<br>"
      + "Oder:<br>"
      + "V.: Herr, erbarme dich (unser).<br>"
      + "A.: Herr, erbarme dich (unser).<br>"
      + "P.: Der Herr erbarme sich unser.<br>"
      + "Er nehme von uns Sünde und Schuld,<br>"
      + "damit wir mit reinem Herzen<br>"
      + "diese Feier begehen.<br>"
    )
     + (
      "A.: Amen.<br>"
      + "KYRIE<br>"
      + "Falls die Kyrierufe nicht schon vorausgegangen sind.<br>"
      + "V.: Kyrie, eleison.<br>"
      + "A.: Kyrie, eleison.<br>"
      + "V.: Christe, eleison.<br>"
      + "A.: Christe, eleison.<br>"
     ...
     + ((((
      "GLORIA<br>"
      + "An den Hochfesten und Festen und bei anderen festlichen Gottesdiensten.<br>"
      ...
      + "wir rühmen dich und danken dir,<br>"
     ...
     + (
      ...
      + "Nach einer kurzen Stille singt oder spricht der Priester das Tagesgebet.<br>"
      + "A.: Amen.<br>"
      + "Abschließende Formeln des Tagesgebetes<br>"
    ))
     + ((
      "Wenn das Tagesgebet an den Vater gerichtet ist:<br>"
      + "Darum bitten wir durch (ihn,) Jesus Christus,<br>"
      + "deinen Sohn, unseren Herrn und Gott,<br>"
      + "der in der Einheit des Heiligen Geistes<br>"
      + "mit dir lebt und herrscht in alle Ewigkeit.<br>"
      + "Wenn es an den Vater gerichtet ist, zum Schluss aber der Sohn genannt wird:<br>"
      + "Der in der Einheit des Heiligen Geistes<br>"
      + "mit dir lebt und herrscht in alle Ewigkeit.<br>"
      + "Wenn es an den Sohn gerichtet ist:<br>"
      + "Der du in der Einheit des Heiligen Geistes<br>"
      + "mit Gott dem Vater<br>"
      + "lebst und herrschest in alle Ewigkeit.<br>"
      + "<br>"
      + "Wortgottesdienst<br>"
      + "ERSTE UND ZWEITE LESUNG<br>"
      + "Der Lektor trägt die erste Lesung vor. "
    )
     + (
      "Wo nach der Lesung ein Ruf der Gemeinde üblich ist, fügt er an:<br>"
      + "Wort des lebendigen Gottes.<br>"
      + "A.: Dank sei Gott.<br>"
      + "Dann trägt der Kantor den Antwortpsalm vor. "
      + "Die Gemeinde übernimmt den Kehrvers. "
      + "Folgt eine zweite <br>"
      + "Lesung, so wird sie in der gleichen Weise abgeschlossen wie die erste Lesung. "
      + "Auf die zweite Lesung folgt <br>"
      + "das Halleluja bzw. der an dieser Stelle vorgesehene Ruf vor dem Evangelium.<br>"
      + "EVANGELIUM<br>"
      + "D. "
      + "(P.): Der Herr sei mit euch.<br>"
      + "A.: Und mit deinem Geiste.<br>"
      + "D. "
      + "(P.): ✠ Aus dem heiligen Evangelium nach N.<br>"
      + "Oder: Aus dem Evangelium Jesu Christi nach N.<br>"
      + "Oder: Aus dem Evangelium nach N.<br>"
    )))
     + (((
      "A.: Ehre sei dir, o Herr.<br>"
      + "Wo nach dem Evangelium ein Zuruf der Gemeinde üblich ist, fügt der Diakon (Priester) an:<br>"
      + "Evangelium unseres Herrn Jesus Christus.<br>"
      + "A.: Lob sei dir, Christus.<br>"
      + "HOMILIE<br>"
      + "CREDO<br>"
      + "An Hochfesten und bei anderen festlichen Gottesdiensten.<br>"
      + "(P.: Wir sprechen das Große Glaubensbekenntnis.)<br>"
     ...
     + (
      ...
      + "Zu den folgenden Worten (bis zu „Mensch geworden“) verbeugen sich alle.<br>"
     ...
     + (
      "und das Leben der kommenden Welt. "
      + "Amen.<br>"
      + "An Stelle des Großen Glaubensbekenntnisses kann das <br>"
      + "Apostolische Glaubensbekenntnis gebetet werden.<br>"
      + "(P.: Wir sprechen das Apostolische Glaubensbekenntnis.)<br>"
      + "A.: Ich glaube an Gott,<br>"
      + "den Vater, den Allmächtigen,<br>"
      + "den Schöpfer des Himmels und der Erde,<br>"
      + "und an Jesus Christus,<br>"
      + "seinen eingeborenen Sohn, unsern Herrn,<br>"
      + "Zu den folgenden Worten (bis zu „Jungfrau Maria“) verbeugen sich alle.<br>"
      ...
      + "hinab gestiegen in das Reich des Todes,<br>"
     ...
     + (((((
      ...
      + "Sie werden vom Priester eingeleitet und abgeschlossen. <br>"
      + "Die einzelnen Anliegen können vom Diakon, Lektor, Kantor oder von anderen vorgetragen werden.<br>"
    )
     + (
      "<br>"
      + "Eucharistiefeier<br>"
      + "GABENBEREITUNG<br>"
      + "Der Priester nimmt die Schale mit dem Brot, hält sie über den Altar und spricht leise:<br>"
      + "Gepriesen bist du, Herr, unser Gott,<br>"
      + "Schöpfer der Welt.<br>"
      + "Du schenkst uns das Brot,<br>"
      + "die Frucht der Erde und der menschlichen Arbeit.<br>"
      + "Wir bringen dieses Brot vor dein Angesicht,<br>"
      + "damit es uns das Brot des Lebens werde.<br>"
      + "(Gepriesen bist du in Ewigkeit, Herr, unser Gott.)<br>"
      + "Der Priester gießt Wein und ein wenig Wasser in den Kelch und spricht leise:<br>"
      + "Wie das Wasser sich mit dem Wein verbindet<br>"
      + "zum heiligen Zeichen,<br>"
      + "so lasse uns dieser Kelch teilhaben<br>"
      + "an der Gottheit Christi,<br>"
      + "der unsere Menschennatur angenommen hat.<br>"
    ))
     + ((
      "Der Priester nimmt den Kelch, hält ihn über den Altar und spricht leise:<br>"
      + "Gepriesen bist du Herr, unser Gott,<br>"
      + "Schöpfer der Welt.<br>"
      + "Du schenkst uns den Wein,<br>"
      + "die Frucht des Weinstocks und der menschlichen Arbeit.<br>"
      + "Wir bringen diesen Kelch vor dein Angesicht,<br>"
      + "damit er uns der Kelch des Heiles werde.<br>"
      + "(Gepriesen bist du in Ewigkeit, Herr, unser Gott.)<br>"
      + "Der Priester verneigt sich und spricht leise:<br>"
      + "Herr, wir kommen zu dir mit reumütigem Herzen<br>"
      + "und mit demütigem Sinn.<br>"
      + "Nimm uns an und gib, dass unser Opfer dir gefalle.<br>"
      + "Zur Händewaschung an der Seite des Altares spricht der Priester leise:<br>"
      + "Herr, wasch ab meine Schuld,<br>"
      + "von meinen Sünden mach mich rein.<br>"
      + "<br>"
    )
     + (
      "EINLADUNG ZUM GABENGEBET<br>"
      + "Form A<br>"
      + "P.: Lasset uns beten<br>"
      + "zu Gott, dem allmächtigen Vater,<br>"
      + "dass er die Gaben der Kirche annehme<br>"
      + "zu seinem Lob und zum Heil der ganzen Welt.<br>"
      + "Form B<br>"
      + "P.: Lasset uns beten.<br>"
      + "Oder eine andere geeignete Gebetseinladung. "
      + "Alle verharren eine kurze Zeit im stillen Gebet.<br>"
      + "Form C<br>"
      + "P.:<br>"
      + " Betet, Brüder und Schwestern,<br>"
      + "dass mein und euer Opfer<br>"
      + "Gott, dem allmächtigen Vater, gefalle.<br>"
      + "A.: Der Herr nehme das Opfer an<br>"
      + "aus deinen Händen<br>"
    )))
     + (((
      "zum Lob und Ruhm seines Namens,<br>"
      + "zum Segen für uns<br>"
      + "und seine ganze heilige Kirche.<br>"
      + "GABENGEBET<br>"
      + "Der Priester trägt das Gabengebet vor.<br>"
      + "A.: Amen.<br>"
      + "<br>"
      + "Das Eucharistische Hochgebet<br>"
      + "EINLADUNG ZUM HOCHGEBET<br>"
      + "P.: Der Herr sei mit euch.<br>"
      + "A.: Und mit deinem Geiste.<br>"
     ...
     + (
      ...
      + "<br>"
      + "Erstes Hochgebet<br>"
      + "Der Römische Messkanon<br>"
      + "Dich, gütiger Vater, bitten wir<br>"
      + "durch deinen Sohn,<br>"
      + "unseren Herrn Jesus Christus:<br>"
      + "Nimm diese heiligen,<br>"
      + "makellosen Opfergaben an<br>"
    ))
     + ((
      "und segne<br>"
      + " ✠ sie.<br>"
      + "Für die Kirche und ihre Hirten<br>"
      + "Wir bringen sie dar<br>"
      + "vor allem für deine heilige katholische Kirche<br>"
      + "in Gemeinschaft mit deinem Diener,<br>"
      + "unserem Papst <br>"
      + "N.,<br>"
      + "mit unserem Bischof N.<br>"
      + "und mit allen, die Sorge tragen<br>"
      + "für den rechten,<br>"
      + "katholischen und apostolischen Glauben.<br>"
      + "Schenke deiner Kirche Frieden und Einheit,<br>"
      + "behüte und leite sie auf der ganz Erde.<br>"
      + "Für anwesende und abwesende Gläubige<br>"
      + "(Konzelebrant)<br>"
      + "Gedenke deiner Diener<br>"
    )
     + (
      "und Dienerinnen N.N.<br>"
      + "(für die heute besonders beten)<br>"
      + "und aller, die hier versammelt sind.<br>"
      + "Stilles Gedenken<br>"
      + "<br>"
      + "Herr, du kennst ihren Glauben<br>"
      + "und ihre Hingabe;<br>"
      + "für sie bringen wir dieses Opfer des Lobes dar,<br>"
      + "und sie selber weihen es dir<br>"
      + "für sich und für alle, die ihnen verbunden sind,<br>"
      + "für ihre Erlösung<br>"
      + "und für ihre Hoffnung<br>"
      + "auf das unverlierbare Heil.<br>"
      + "Vor dich, den ewigen, lebendigen und wahren Gott,<br>"
      + "bringen sie ihre Gebete und Gaben.<br>"
      + "Gedächtnis der Heiligen<br>"
      + "(Konzelebrant)<br>"
    ))))
     + ((((
      "In Gemeinschaft mit der ganzen Kirche<br>"
      + "gedenken wir deiner Heiligen.<br>"
      + "Wir ehren vor allem Maria,<br>"
      + "die glorreiche, allzeit jungfräuliche Mutter<br>"
      + "unseres Herrn und Gottes Jesus Christus.<br>"
      + "Wir ehren ihren Bräutigam, den heiligen Josef,<br>"
      + "deine heiligen Apostel und Märtyrer:<br>"
      + "Petrus und Paulus, Andreas<br>"
      + "(Jakobus, Johannes, Thomas, Jakobus,<br>"
      + "Philippus, Bartholomäus, Matthäus,<br>"
      + "Simon und Thaddäus,<br>"
      + "Linus, Kletus, Klemens, Xystus, Kornelius,<br>"
      + "Cyprianus, Laurentius, Chrysogonus,<br>"
      + "Johannes und Paulus, Kosmas und Damianus<br>"
      + ")<br>"
      + "und alle deine Heiligen;<br>"
    )
     + (
      "blicke auf ihr heiliges Leben und Sterben<br>"
      + "und gewähre uns auf ihre Fürsprache<br>"
      + "in allem deine Hilfe und deinen Schutz.<br>"
      + "<br>"
      + "Für die Ortsgemeinde<br>"
      + "(Hauptzelebrant)<br>"
      + "Nimm gnädig an, o Gott,<br>"
      + "diese Gaben deiner Diener<br>"
      + "und deiner ganzen Gemeinde;<br>"
      + "ordne unsere Tage in deinem Frieden,<br>"
      + "rette uns vor dem ewigen Verderben<br>"
      + "und nimm uns auf in die Schar deiner Erwählten.<br>"
      + "Bitte um Heiligung der Gaben<br>"
      + "Schenke, o Gott, diesen Gaben Segen in Fülle<br>"
      + "und nimm sie zu eigen an.<br>"
      + "Mache sie uns zum wahren Opfer im Geiste,<br>"
      + "das dir wohl gefällt<br>"
    ))
     + ((
      "zum Leib und Blut deines Sohnes,<br>"
      + "unseres Herrn Jesus Christus.<br>"
      + "Am Abend vor seinem Leiden<br>"
      + "nahm er das Brot<br>"
      + "in seine heiligen und ehrwürdigen Hände,<br>"
      + "erhob die Augen zum Himmel,<br>"
      + "zu dir, seinem Vater, dem allmächtigen Gott,<br>"
      + "sagte dir Lob und Dank,<br>"
      + "brach das Brot,<br>"
      + "reichte es seinen Jüngern und sprach:<br>"
      + "NEHMET UND ESSET ALLE DAVON:<br>"
      + "DAS IST MEIN LEIB,<br>"
      + "DER FÜR EUCH HINGEGEBEN WIRD.<br>"
      + "<br>"
      + "Ebenso nahm er nach dem Mahl<br>"
      + "diesen erhabenen Kelch<br>"
    )
     + (
      "in seine heiligen und ehrwürdigen Hände,<br>"
      + "sagte dir Lob und Dank,<br>"
      + "reichte den Kelch seinen Jüngern und sprach:<br>"
      + "NEHMET UND TRINKET ALLE DARAUS:<br>"
      + "DAS IST DER KELCH<br>"
      + "DES NEUEN UND EWIGEN BUNDES,<br>"
      + "MEIN BLUT,<br>"
      + "DAS FÜR EUCH<br>"
      + "UND FÜR ALLE VERGOSSEN WIRD<br>"
      + "ZUR VERGEBUNG DER SÜNDEN.<br>"
      + "TUT DIES ZU MEINEM GEDÄCHTNIS.<br>"
      + "P. "
      + "(D.): Geheimnis des Glaubens.<br>"
     ...
     + (((
      "Darum, gütiger Vater,<br>"
      + "feiern wir, deine Diener<br>"
      + "und dein heiliges Volk,<br>"
      + "das Gedächtnis deines Sohnes,<br>"
      + "unseres Herrn Jesus Christus.<br>"
      + "Wir verkünden sein heilbringendes Leiden,<br>"
      + "seine Auferstehung von den Toten<br>"
      + "und seine glorreiche Himmelfahrt.<br>"
      + "So bringen wir aus den Gaben,<br>"
      + "die du uns geschenkt hast,<br>"
      + "dir, dem erhabenen Gott,<br>"
      + "die reine, heilige und makellose Opfergabe dar:<br>"
      + "das Brot des Lebens<br>"
      + "und den Kelch des ewigen Heiles.<br>"
      + "<br>"
      + "Blicke versöhnt und gütig darauf nieder<br>"
    )
     + (
      "und nimm sie an<br>"
      + "wie einst die Gaben<br>"
      + "deines gerechten Dieners Abel,<br>"
      + "wie das Opfer unseres Vaters Abraham,<br>"
      + "wie die heilige Gabe, das reine Opfer<br>"
      + "deines Hohenpriesters Melchisedek.<br>"
      + "Der Priester faltet die Hände, verneigt sich und spricht:<br>"
      + "Wir bitten dich,<br>"
      + "allmächtiger Gott:<br>"
      + "Dein heiliger Engel trage diese Opfergabe<br>"
      + "auf deinen himmlischen Altar<br>"
      + "vor deine göttliche Herrlichkeit;<br>"
      + "und wenn wir durch unsere Teilnahme am Altar<br>"
      + "den heiligen Leib und das Blut<br>"
      + "deines Sohnes empfangen,<br>"
      + "Der Priester richtet sich auf, macht das Kreuzzeichen und spricht:<br>"
      + "erfülle uns mit aller Gnade<br>"
    ))
     + ((
      "und allem Segen des Himmels.<br>"
      + "Gedächtnis der Verstorbenen<br>"
      + "(Konzelebrant)<br>"
      + "Gedenke auch deiner Diener<br>"
      + "und Dienerinnen (N. und N.),<br>"
      + "die uns vorangegangen sind,<br>"
      + "bezeichnet mit dem Siegel des Glaubens,<br>"
      + "und die nun ruhen in Frieden.<br>"
      + "Stilles Gedenken<br>"
      + "Wir bitten dich:<br>"
      + "Führe sie und alle,<br>"
      + "die in Christus entschlafen sind,<br>"
      + "in das Land der Verheißung,<br>"
      + "des Lichtes und des Friedens.<br>"
      + "<br>"
      + "Weitere Bitten<br>"
      + "(Konzelebrant)<br>"
    )
     + (
      "Der Priester schlagt an seine Brust und spricht:<br>"
      + "Auch uns, deinen sündigen Dienern,<br>"
      + "die auf deine reiche Barmherzigkeit hoffen,<br>"
      + "gib Anteil und Gemeinschaft<br>"
      + "mit deinen heiligen Aposteln und Märtyrern:<br>"
      + "Johannes, Stephanus, Matthias, Barnabas<br>"
      + "(Ignatius, Alexander, Marzellinus, Petrus,<br>"
      + "Felizitas, Perpetua, Agatha, Luzia,<br>"
      + "Agnes, Cäcilia, Anastasia<br>"
      + ")<br>"
      + "und mit allen deinen Heiligen;<br>"
      + "wäge nicht unser Verdienst,<br>"
      + "sondern schenke gnädig Verzeihung<br>"
      + "und gib uns mit ihnen das Erbe des Himmels.<br>"
      + "(Hauptzelebrant)<br>"
      + "Darum bitten wir dich<br>"
      + "durch unseren Herrn Jesus Christus.<br>"
    ))))))
     + ((((((
      "Denn durch ihn erschaffst du immerfort<br>"
      + "all diese gute Gaben,<br>"
      + "gibst ihnen Leben und Weihe<br>"
      + "und spendest sie uns.<br>"
      + "Abschließender Lobpreis<br>"
      + "(Hauptzelebrant und Konzelebranten)<br>"
      + "Durch ihn und mit ihm und in ihm ist dir,<br>"
      + "Gott, allmächtiger Vater,<br>"
      + "in der Einheit des Heiligen Geistes<br>"
      + "alle Herrlichkeit und Ehre<br>"
      + "jetzt und in Ewigkeit.<br>"
      + "A.: Amen.<br>"
      + "<br>"
      + "Zweites Hochgebet<br>"
      + "PRÄFATION<br>"
      + "<br>"
    )
     + (
      "Bitte um Heiligung der Gaben<br>"
      + "Ja, du bist heilig, großer Gott,<br>"
      + "du bist der Quell aller Heiligkeit.<br>"
      + "Darum bitten wir dich:<br>"
      + "Sende deinen Geist auf diese Gaben herab<br>"
      + "und heilige sie,<br>"
      + "damit sie uns werden Leib <br>"
      + "✠ und Blut<br>"
      + "deines Sohnes, unseres Herrn Jesus Christus.<br>"
      + "Denn am Abend,<br>"
      + "an dem er ausgeliefert wurde<br>"
      + "und sich aus freiem Willen<br>"
      + "dem Leiden unterwarf,<br>"
      + "nahm er das Brot und sagte Dank,<br>"
      + "brach es,<br>"
      + "reichte es seinen Jüngern und sprach:<br>"
      + "<br>"
    ))
     + ((
      ...
      + "dankte wiederum,<br>"
      + "reichte ihn seinen Jüngern und sprach:<br>"
      + "NEHMET UND TRINKET ALLE DARAUS:<br>"
      + "DAS IST DER KELCH<br>"
      + "DES NEUEN UND EWIGEN BUNDES,<br>"
      + "MEIN BLUT,<br>"
     ...
     + (
      ...
      + "und deine Auferstehung preisen wir,<br>"
      + "bis du kommst in Herrlichkeit.<br>"
      + "Gedächtnis – Darbringung – Dank und Bitte<br>"
      + "(Hauptzelebrant)<br>"
      + "Darum, gütiger Vater,<br>"
      + "feiern wir das Gedächtnis<br>"
      + "des Todes und der Auferstehung deines Sohnes<br>"
      + "und bringen dir so das Brot des Lebens<br>"
      + "und den Kelch des Heiles dar.<br>"
      + "Wir danken dir, dass du uns berufen hast,<br>"
      + "vor dir zu stehen und dir zu dienen.<br>"
      + "Wir bitten dich:<br>"
      + "Schenke uns Anteil an Christi Leib und Blut<br>"
      + "und lass uns eins werden<br>"
      + "durch den Heiligen Geist.<br>"
      + "<br>"
    )))
     + (((
      ...
      + "vereint mit unserem Papst <br>"
      + "N.,<br>"
      + "unserem Bischof N. und allen Bischöfen,<br>"
      + "unseren Priestern und Diakonen<br>"
      + "und mit allen,<br>"
      + "die zum Dienst in der Kirche bestellt sind.<br>"
      + "Für die Verstorbenen<br>"
      + "(Konzelebrant)<br>"
      + "Gedenke<br>"
      + "(aller) unserer Brüder und Schwestern,<br>"
      + "die entschlafen sind in der Hoffnung,<br>"
      + "dass sie auferstehen.<br>"
    )
     + (
      "Nimm sie<br>"
      + "und alle, die in deiner Gnade<br>"
      + "aus dieser Welt geschieden sind,<br>"
      + "in dein Reich auf,<br>"
      + "wo sie dich schauen<br>"
      + "von Angesicht zu Angesicht.<br>"
      + "Für alle<br>"
      + "(Konzelebrant)<br>"
      + "Vater, erbarme dich über uns alle,<br>"
      + "damit uns das ewige Leben zuteil wird<br>"
      + "in der Gemeinschaft mit der seligen<br>"
      + "Jungfrau und Gottesmutter Maria,<br>"
      + "mit deinen Aposteln<br>"
      + "und mit allen,<br>"
      + "die bei dir Gnade gefunden haben<br>"
      + "von Anbeginn der Welt,<br>"
      + "dass wir dich loben und preisen<br>"
    ))
     + ((
      "durch deinen Sohn Jesus Christus.<br>"
      + "<br>"
      + "Abschließender Lobpreis<br>"
      + "(Hauptzelebrant und Konzelebranten)<br>"
      + "Durch ihn und mit ihm und in ihm ist dir,<br>"
      ...
      + "A.: Amen.<br>"
      + "<br>"
      + "Drittes Hochgebet<br>"
      + "P.: Ja, du bist heilig, großer Gott,<br>"
      + "und alle deine Werke verkünden dein Lob.<br>"
      + "Denn durch deinen Sohn,<br>"
      + "unseren Herrn Jesus Christus,<br>"
      + "und in der Kraft des Heiligen Geistes<br>"
    )
     + (
      "erfüllst du die ganze Schöpfung<br>"
      + "mit Leben und Gnade.<br>"
      + "Bis ans Ende der Zeiten<br>"
      + "versammelst du dir ein Volk,<br>"
      + "damit deinem Namen<br>"
      + "das reine Opfer dargebracht werde<br>"
      + "vom Aufgang der Sonne bis zu Untergang.<br>"
      + "Bitte um Heiligung der Gaben<br>"
      + "Darum bitten wir dich,<br>"
      + "allmächtiger Gott:<br>"
      + "Heilige unsere Gaben durch deinen Geist,<br>"
      + "damit sie uns werden Leib <br>"
      + "✠ und Blut<br>"
      + "deines Sohnes, unseres Herrn Jesus Christus,<br>"
      + "der uns aufgetragen hat,<br>"
      + "dieses Geheimnis zu feiern.<br>"
      + "Denn in der Nacht, da er verraten wurde,<br>"
    ))))
     + ((((
      "nahm er das Brot und sagte Dank,<br>"
      + "brach es,<br>"
     ...
     + (
      ...
      + "und deine Auferstehung preisen wir,<br>"
      + "bis du kommst in Herrlichkeit.<br>"
      + "Gedächtnis – Darbringung – Bitte<br>"
      + "(Hauptzelebrant)<br>"
      + "Darum, gütiger Vater,<br>"
      + "feiern wir das Gedächtnis deines Sohnes.<br>"
      + "Wir verkünden sein heilbringendes Leiden,<br>"
      + "seine glorreiche Auferstehung<br>"
      + "und Himmelfahrt<br>"
      + "und erwarten seine Wiederkunft.<br>"
      + "So bringen wir dir mit Lob und Dank<br>"
      + "dieses heilige und lebendige Opfer dar.<br>"
    ))
     + ((
      "Schau gütig auf die Gabe deiner Kirche.<br>"
      + "Denn sie stellt dir<br>"
      + "das Lamm vor Augen,<br>"
      + "das geopfert wurde<br>"
      + "und uns nach deinem Willen<br>"
      + "mit dir versöhnt hat.<br>"
      + "Stärke uns durch den Leib und das Blut<br>"
      + "deines Sohnes<br>"
      + "und erfülle uns mit seinem Heiligen Geist,<br>"
      + "damit wir ein Leib und ein Geist werden<br>"
      + "in Christus.<br>"
      + "<br>"
      + "(Konzelebrant)<br>"
      + "Er mache uns auf immer<br>"
      + "zu einer Gabe, die dir wohl gefällt,<br>"
      + "damit wir das verheißene Erbe erlangen<br>"
    )
     + (
      "mit deinen Auserwählten,<br>"
      + "mit der seligen Jungfrau<br>"
      + "und Gottesmutter Maria,<br>"
      + "mit deinen Aposteln und Märtyrern<br>"
      + "(mit dem heiligen N.)<br>"
      + "(mit dem – den – seligen N.)<br>"
      + "und mit allen Heiligen (und Seligen),<br>"
      + "auf deren Fürsprache wir vertrauen.<br>"
      + "Für die Welt, die Kirche und ihre Hirten<br>"
      + "(Konzelebrant)<br>"
      + "Barmherziger Gott, wir bitten dich:<br>"
      + "Dieses Opfer unserer Versöhnung<br>"
      + "bringe der ganzen Welt Frieden und Heil.<br>"
      + "Beschütze deine Kirche<br>"
      + "auf ihrem Weg durch die Zeit <br>"
      + "und stärke sie im Glauben und in der Liebe:<br>"
      + "deinen Diener, unseren Papst <br>"
    )))
     + (((
      "N.,<br>"
      + "unseren Bischof N.<br>"
      + "und die Gemeinschaft der Bischöfe,<br>"
      + "unsere Priester und Diakone,<br>"
      + "alle, die zum Dienst in der Kirche bestellt sind,<br>"
      + "und das ganze Volk deiner Erlösten.<br>"
      + "Für die anwesende Gemeinde und für alle<br>"
      + "Erhöre, gütiger Vater,<br>"
      + "die Gebete der hier versammelten Gemeinde<br>"
      + "und führe zu dir<br>"
      + "auch alle deine Söhne und Töchter,<br>"
      + "die noch fern sind von dir.<br>"
      + "<br>"
      + "Für die Verstorbenen<br>"
      + "(Konzelebrant)<br>"
      + "Erbarme dich (aller) unserer<br>"
    )
     + (
      "verstorbenen Brüder und Schwestern<br>"
      + "und aller, die in deiner Gnade<br>"
      + "aus dieser Welt geschieden sind.<br>"
      + "Nimm sie auf in deine Herrlichkeit.<br>"
      + "Und mit ihnen lass auch uns,<br>"
      + "wie du verheißen hast,<br>"
      + "zu Tische sitzen in deinem Reich.<br>"
      + "(Hauptzelebrant)<br>"
      + "Darum bitten wir dich<br>"
      + "durch unseren Herrn Jesus Christus.<br>"
      + "Denn durch ihn<br>"
      + "schenkst du der Welt alle guten Gaben.<br>"
      + "Abschließender Lobpreis<br>"
      + "(Hauptzelebrant und Konzelebranten)<br>"
      + "Durch ihn und mit ihm und in ihm ist dir,<br>"
      + "Gott, allmächtiger Vater,<br>"
     ...
     + ((
      ...
      + "A.: Amen.<br>"
      + "<br>"
      + "Viertes Hochgebet<br>"
      + "PRÄFATION<br>"
      + "<br>"
      + "Dank für das Werk der Schöpfung und der Erlösung<br>"
      + "Wir preisen dich, heiliger Vater,<br>"
      + "denn groß bist du,<br>"
      + "und alle deine Werke<br>"
      + "künden deine Weisheit und Liebe.<br>"
      + "Den Menschen hast du<br>"
      + "nach deinem Bild geschaffen<br>"
      + "und ihm die Sorge für die ganze Welt anvertraut.<br>"
      + "Über alle Geschöpfe sollte er herrschen<br>"
      + "und allein dir, seinem Schöpfer, dienen.<br>"
    )
     + (
      "Als er im Ungehorsam deine Freundschaft verlor<br>"
      + "und der Macht des Todes verﬁ el,<br>"
      + "hast du ihn dennoch nicht verlassen,<br>"
      + "sondern voll Erbarmen allen geholfen,<br>"
      + "dich zu suchen und zu ﬁ nden.<br>"
      + "Immer wieder hast du den Menschen<br>"
      + "deinen Bund angeboten<br>"
      + "und sie durch die Propheten gelehrt,<br>"
      + "das Heil zu erwarten.<br>"
      + "So sehr hast du die Welt geliebt,<br>"
      + "heiliger Vater,<br>"
      + "dass du deinen eingeborenen Sohn<br>"
      + "als Retter gesandt hast,<br>"
      + "nachdem die Fülle der Zeiten gekommen war.<br>"
      + "Er ist Mensch geworden<br>"
      + "durch den Heiligen Geist,<br>"
      + "geboren von der Jungfrau Maria.<br>"
    )))))
     + (((((
      "Er hat wie wir als Mensch gelebt,<br>"
      + "in allem uns gleich außer der Sünde.<br>"
      + "Den Armen verkündete er<br>"
      + "die Botschaft vom Heil,<br>"
      + "den Gefangenen Freiheit,<br>"
      + "den Trauernden Freude.<br>"
      + "<br>"
      + "Um deinen Ratschluss zu erfüllen,<br>"
      + "hat er sich dem Tod überliefert,<br>"
      + "durch seine Auferstehung<br>"
      + "den Tod bezwungen<br>"
      + "und das Leben neu geschaffen.<br>"
      + "Damit wir nicht mehr uns selber leben,<br>"
      + "sondern ihm,<br>"
      + "der für uns gestorben und auferstanden ist,<br>"
      + "hat er von dir, Vater,<br>"
    )
     + (
      "als erste Gabe für alle, die glauben,<br>"
      + "den Heiligen Geist gesandt,<br>"
      + "der das Werk deines Sohnes<br>"
      + "auf Erden weiter führt<br>"
      + "und alle Heiligung vollendet.<br>"
      + "Bitte um Heiligung der Gaben<br>"
      + "So bitten wir dich, Vater:<br>"
      + "Der Geist heilige diese Gaben,<br>"
      + "damit sie uns werden Leib <br>"
      + "✠ und Blut<br>"
      + "unseres Herrn Jesus Christus,<br>"
      + "der uns die Feier dieses Geheimnisses<br>"
      + "aufgetragen hat<br>"
      + "als Zeichen des ewigen Bundes.<br>"
      + "Da er die Seinen liebte,<br>"
      + "die in der Welt waren,<br>"
      + "liebte er sie bis zur Vollendung.<br>"
    ))
     + ((
      "Und als die Stunde kam,<br>"
      + "da er von dir verherrlicht werden sollte,<br>"
      + "nahm er beim<br>"
      + "Mahl das Brot und sagte Dank,<br>"
      + "brach das Brot,<br>"
      + "reichte es seinen Jüngern und sprach:<br>"
      + "<br>"
      + "NEHMET UND ESSET ALLE DAVON:<br>"
      + "DAS IST MEIN LEIB,<br>"
      + "DER FÜR EUCH HINGEGEBEN WIRD.<br>"
      + "Ebenso nahm er den Kelch mit Wein,<br>"
      + "dankte wiederum,<br>"
      + "reichte den Kelch seinen Jüngern und sprach:<br>"
      + "NEHMET UND TRINKET ALLE DARAUS:<br>"
      + "DAS IST DER KELCH<br>"
     ...
     + (
      ...
      + "(Hauptzelebrant)<br>"
      + "Darum, gütiger Vater,<br>"
      + "feiern wir das Gedächtnis unserer Erlösung.<br>"
      + "Wir verkünden den Tod deines Sohnes<br>"
      + "und sein Herabsteigen zu den Vätern,<br>"
      + "bekennen seine Auferstehung<br>"
    )))
     + (((
      "und Himmelfahrt<br>"
      + "und erwarten sein Kommen in Herrlichkeit.<br>"
      + "So bringen wir dir seinen Leib und sein Blut dar,<br>"
      + "das Opfer, das dir wohl gefällt<br>"
      + "und der ganzen Welt Heil bringt.<br>"
      + "<br>"
      + "Sieh her auf die Opfergabe,<br>"
      + "die du selber deiner Kirche bereitet hast,<br>"
      + "und gib, dass alle, die Anteil erhalten<br>"
      + "an dem einen Brot und dem einen Kelch,<br>"
      + "ein Leib werden im Heiligen Geist,<br>"
      + "eine lebendige Opfergabe in Christus<br>"
      + "zum Lob deiner Herrlichkeit.<br>"
      + "Für die Kirche und ihre Hirten, für die anwesende Gemeinde und für alle<br>"
      + "(Konzelebrant)<br>"
      + "Herr, gedenke aller, für deren Heil<br>"
    )
     + (
      "wir das Opfer darbringen.<br>"
      + "Wir bitten dich für unseren Papst <br>"
      + "N.,<br>"
      + "unseren Bischof N.<br>"
      + "und die Gemeinschaft der Bischöfe,<br>"
      + "für unsere Priester und Diakone<br>"
      + "und für alle,<br>"
      + "die zum Dienst in der Kirche bestellt sind,<br>"
      + "für alle, die ihre Gaben spenden,<br>"
      + "für die hier versammelte Gemeinde,<br>"
      + "für dein ganzes Volk<br>"
      + "und für alle Menschen,<br>"
      + "die mit lauterem Herzen dich suchen.<br>"
      + "Für die Verstorbenen<br>"
      + "(Konzelebrant)<br>"
      + "Wir empfehlen dir auch jene,<br>"
      + "die im Frieden Christi heimgegangen sind,<br>"
    ))
     + ((
      "und alle Verstorbenen,<br>"
      + "um deren Glauben niemand weiß als du.<br>"
      + "Gütiger Vater,<br>"
      + "gedenke, dass wir deine Kinder sind,<br>"
      + "und schenke uns allen das Erbe des Himmels<br>"
      + "in Gemeinschaft mit der seligen Jungfrau<br>"
      + "und Gottesmutter Maria,<br>"
      + "mit deinen Aposteln und mit allen Heiligen.<br>"
      + "<br>"
      + "Und wenn die ganze Schöpfung<br>"
      + "von der Verderbnis der Sünde<br>"
      + "und des Todes befreit ist,<br>"
      + "lass uns zusammen mit ihr dich verherrlichen<br>"
      + "in deinem Reich<br>"
      + "durch unseren Herrn Jesus Christus.<br>"
      + "Denn durch ihn<br>"
      + "schenkst du der Welt alle guten Gaben.<br>"
     ...
     + (
      ...
      + "ist dir, Gott, allmächtiger Vater,<br>"
      + "in der Einheit des Heiligen Geistes<br>"
      + "alle Herrlichkeit und Ehre<br>"
      + "jetzt und in Ewigkeit.<br>"
      + "A.: Amen.<br>"
      ...
      + "Kommunion<br>"
      + "GEBET DES HERRN<br>"
      + "P.: Dem Wort unseres Herrn und Erlösers gehorsam<br>"
      + "und getreu seiner göttlichen Weisung,<br>"
      + "wagen wir zu sprechen:<br>"
      + "Oder:<br>"
      + "Lasset uns beten,<br>"
      + "wie der Herr uns zu beten gelehrt hat.<br>"
    ))))
     + ((((
      "Oder:<br>"
      + "Wir heißen Kinder Gottes und sind es.<br>"
      + "Darum beten wir voll Vertrauen:<br>"
      + "Oder:<br>"
      + "Wir haben den Geist empfangen,<br>"
      + "der uns zu Kindern Gottes macht.<br>"
      + "Darum wagen wir zu sprechen:<br>"
      + "Oder eine andere geeignete Einladung. <br>"
      + "Diese kann auch der Zeit des Kirchenjahres angepasst werden.<br>"
     ...
     + (
      ...
      + "P.: Erlöse uns,<br>"
      + "Herr, allmächtiger Vater,<br>"
      + "von allem Bösen<br>"
      + "und gib Frieden in unseren Tagen.<br>"
      + "<br>"
      + "Komm uns zu Hilfe mit deinem Erbarmen<br>"
      + "und bewahre uns vor Verwirrung und Sünde,<br>"
      + "damit wir voll Zuversicht<br>"
      + "das Kommen unseres Erlösers Jesus Christus erwarten.<br>"
      + "A.: Denn dein ist das Reich und die Kraft<br>"
      + "und die Herrlichkeit in Ewigkeit. "
      + "Amen.<br>"
      + "FRIEDENSGEBET<br>"
      + "P.: Der Herr hat zu seinen Aposteln gesagt:<br>"
    ))
     + ((
      "Frieden hinterlasse ich euch,<br>"
      + "meinen Frieden gebe ich euch.<br>"
      + "Deshalb bitten wir:<br>"
      + "Herr Jesus Christus, <br>"
      + "schau nicht auf unsere Sünden,<br>"
      + "sondern auf den Glauben deiner Kirche<br>"
      + "und schenke ihr nach deinem Willen<br>"
      + "Einheit und Frieden.<br>"
      + "Gebetseinladung und Christusanrede können der Zeit des Kirchenjahres oder dem Anlass <br>"
      + "angepasst werden. "
      + "Etwa:<br>"
      + "In der Weihnachtszeit<br>"
      + "Als Christus geboren wurde,<br>"
      + "verkündeten Engel den Frieden auf Erden.<br>"
      + "Deshalb bitten wir:<br>"
      + "Herr Jesus Christus, starker Gott, Friedensfürst, …<br>"
      + "In der Fastenzeit<br>"
    )
     + (
      "Christus ist unser Friede und unsere Versöhnung.<br>"
      + "Deshalb bitten wir:<br>"
      + "Herr Jesus Christus, …<br>"
      + "<br>"
      + "In der Osterzeit<br>"
      + "Am Ostertag trat Jesus in die Mitte seiner Jünger<br>"
      + "und sprach den Friedensgruß.<br>"
      + "Deshalb bitten wir:<br>"
      + "Herr Jesus Christus,<br>"
      + "du Sieger über Sünde und Tod, …<br>"
      + "P.: Der Friede des Herrn sei allezeit mit euch.<br>"
      + "A.: Und mit deinem Geiste.<br>"
      + "(D. oder P.: Gebt einander ein Zeichen<br>"
      + "des Friedens und der Versöhnung.)<br>"
      + "BRECHUNG DES BROTES UND AGNUS DEI<br>"
      + "Der Priester bricht die Hostie in mehrere Teile. <br>"
      + "Ein kleines Fragment der Hostie senkt er in den Kelch. "
    )))
     + (((
      "Dabei spricht er leise:<br>"
      + "Das Sakrament des Leibes und Blutes Christi<br>"
      + "schenke uns ewiges Leben.<br>"
      + "Inzwischen wird der Gesang zur Brotbrechung gesungen:<br>"
      + "Lamm Gottes,<br>"
      + "du nimmst hinweg die Sünde der Welt:<br>"
      + "erbarme dich unser.<br>"
      + "Lamm Gottes,<br>"
      ...
      + "<br>"
      + "STILLES GEBET VOR DER KOMMUNION<br>"
      + "P.: Herr Jesus Christus, Sohn des lebendigen Gottes,<br>"
    )
     + (
      "dem Willen des Vaters gehorsam,<br>"
      + "hast du im Heiligen Geist durch deinen Tod<br>"
      + "der Welt das Leben geschenkt.<br>"
      + "Erlöse mich durch deinen Leib und dein Blut<br>"
      + "von allen Sünden und allem Bösen.<br>"
      + "Hilf mir, dass ich deine Gebote treu erfülle,<br>"
      + "und lass nicht zu,<br>"
      + "dass ich jemals von dir getrennt werde.<br>"
      + "Oder:<br>"
      + "Herr Jesus Christus,<br>"
      + "der Empfang deines Leibes und Blutes<br>"
      + "bringe mir nicht Gericht und Verdammnis,<br>"
      + "sondern Segen und Heil.<br>"
      + "EINLADUNG ZUR KOMMUNION<br>"
      + "P.: Seht das Lamm Gottes,<br>"
      + "das hinweg nimmt die Sünde der Welt.<br>"
      + "A.: Herr, ich bin nicht würdig,<br>"
    ))
     + ((
      "dass du eingehst unter mein Dach,<br>"
      + "aber sprich nur ein Wort,<br>"
      + "so wird meine Seele gesund.<br>"
      + "P.: Selig, die zum Hochzeitsmahl des Lammes geladen sind.<br>"
      + "Oder:<br>"
      + "Kostet und seht, wie gut der Herr ist.<br>"
      + "Oder:<br>"
      + "Wer von diesem Brot isst, wird in Ewigkeit leben.<br>"
      + "Oder ein Kommunionvers aus dem Messbuch, vor allem der der Tagesmesse.<br>"
      + "<br>"
      + "KOMMUNIONSPENDUNG<br>"
      + "PURIFIKATION<br>"
      + "P. "
      + "(D. oder A.)<br>"
      + "Was wir mit dem Munde empfangen haben, Herr,<br>"
      + "dass lass uns mit reinem Herzen aufnehmen,<br>"
      + "und diese zeitliche Speise<br>"
    )
     + (
      "werde uns zur Arznei der Unsterblichkeit.<br>"
      + "SCHLUSSGEBET<br>"
      + "P.: Lasset uns beten.<br>"
      + "Der Priester singt oder spricht das Schlussgebet.<br>"
      + "A.: Amen.<br>"
      + "<br>"
      + "Entlassung<br>"
      + "SEGEN<br>"
  ...
  global.countryMassData.DE = Object.freeze({
    schemaVersion: 2,
    jurisdiction: 'DE',
    jurisdictions: Object.freeze(['DE']),
    jurisdictionName: 'Deutschland',
    conferenceCalendar: 'Deutsche Bischofskonferenz',
    ordinaryLanguage: 'DE',
    ordinary,
    ordinaryStructure: 'paragraph-rubric-choices-v1',
    officialOrderCorpus,
    ordinaryEdition: 'Messbuch für die Bistümer des deutschen Sprachgebietes',
    ordinarySource,
    beta: true,
    dailyReadings: Object.freeze({
      provider: 'SCHOTT / Erzabtei Beuron',
      calendar: 'Deutschland',
      translation: 'Revidierte Einheitsübersetzung',
      parser: 'strict-german-schott-daily-mass',
      url: dailyUrl
    }),
    dailyPropers: Object.freeze({
      ...
      parser: 'strict-german-schott-daily-mass',
      url: dailyUrl,
      weekdayFallback: 'previous-sunday-formulary'
    }),
    properSources: Object.freeze({
      germanMissal: ordinarySource,
      dailyMass: 'https://schott.erzabtei-beuron.de/'
    }),
