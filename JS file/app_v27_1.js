// Order of Mass V27.1 application runtime. Liturgical data is loaded from country-owned modules.
    ...
    const COUNTRY_LOCATION_CODES = Object.freeze([
        'KR', 'VN', 'US', 'IE', 'GB-NIR', 'GB-ENG', 'GB-WLS', 'GB-SCT', 'JP', 'VA',
    ...
    const APP_VERSION = 'V27.1-20260828-GREAT-BRITAIN-BETA';
    ...
    function updateSettings() {
        ...
        document.getElementById('manual-loc-row').style.display = 'flex';
        const selectedLocationCode = document.getElementById('set-loc').value || state.selectedLocationCode || 'KR';

        // Jurisdiction/language choice and GPS permission are independent.
        // A manual choice changes the displayed liturgy without disabling GPS.
        state.selectedLocationCode = selectedLocationCode;
    ...
    // Keep every reviewed jurisdiction discoverable without changing the GPS
    // checkbox. GPS is disabled only when the user explicitly unchecks it.
...
Lạy Chúa, chúng con vừa lãnh nhận hồng ân Chúa ban, xin cho chúng con mỗi khi cử hành bí tích này được hưởng dồi dào ơn cứu độ. Chúng con cầu xin…`
    ...
    const localizedCountryNames = Object.freeze({
        KR: { KR: '한국', VN: '베트남', US: '미국', IE: '아일랜드', 'GB-NIR': '북아일랜드', 'GB-ENG': '잉글랜드', 'GB-WLS': '웨일즈', 'GB-SCT': '스코틀랜드', TW: '대만', CN: '중국', PH: '필리핀', ID: '인도네시아', TH: '태국', KH: '캄보디아', SG: '싱가포르', MY: '말레이시아', BN: '브루나이', HK: '홍콩', MO: '마카오', JP: '일본', VA: '바티칸' },
        VN: { KR: 'Hàn Quốc', VN: 'Việt Nam', US: 'Hoa Kỳ', IE: 'Ireland', 'GB-NIR': 'Bắc Ireland', 'GB-ENG': 'Anh', 'GB-WLS': 'Wales', 'GB-SCT': 'Scotland', TW: 'Đài Loan', CN: 'Trung Quốc', PH: 'Philippines', ID: 'Indonesia', TH: 'Thái Lan', KH: 'Campuchia', SG: 'Singapore', MY: 'Malaysia', BN: 'Brunei', HK: 'Hồng Kông', MO: 'Ma Cao', JP: 'Nhật Bản', VA: 'Vatican' },
        EN: { KR: 'South Korea', VN: 'Vietnam', US: 'United States', IE: 'Ireland', 'GB-NIR': 'Northern Ireland', 'GB-ENG': 'England', 'GB-WLS': 'Wales', 'GB-SCT': 'Scotland', TW: 'Taiwan', CN: 'China', PH: 'Philippines', ID: 'Indonesia', TH: 'Thailand', KH: 'Cambodia', SG: 'Singapore', MY: 'Malaysia', BN: 'Brunei', HK: 'Hong Kong', MO: 'Macau', JP: 'Japan', VA: 'Vatican City' },
        JP: { KR: '韓国', VN: 'ベトナム', US: 'アメリカ', IE: 'アイルランド', 'GB-NIR': '北アイルランド', 'GB-ENG': 'イングランド', 'GB-WLS': 'ウェールズ', 'GB-SCT': 'スコットランド', TW: '台湾', CN: '中国', PH: 'フィリピン', ID: 'インドネシア', TH: 'タイ', KH: 'カンボジア', SG: 'シンガポール', MY: 'マレーシア', BN: 'ブルネイ', HK: '香港', MO: 'マカオ', JP: '日本', VA: 'バチカン' },
        LA: { KR: 'Corea Meridiana', VN: 'Vietnamia', US: 'Civitates Foederatae', IE: 'Hibernia', 'GB-NIR': 'Hibernia Septentrionalis', 'GB-ENG': 'Anglia', 'GB-WLS': 'Cambria', 'GB-SCT': 'Scotia', TW: 'Taiwan', CN: 'Sina', PH: 'Philippinae', ID: 'Indonesia', TH: 'Thailandia', KH: 'Cambodia', SG: 'Singapura', MY: 'Malaysia', BN: 'Bruneium', HK: 'Hongcongum', MO: 'Macaum', JP: 'Iaponia', VA: 'Civitas Vaticana' }
    });
    ...
    function applyInitialSettingsToControls() {
        ...
        if (manualLocationRow) manualLocationRow.style.display = 'flex';
